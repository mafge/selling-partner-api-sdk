...
public class SupplySourcesApiTest {
  ...
  private final SupplySourcesApi api =
      new SupplySourcesApi.Builder()
  ...
  public void updateSupplySourceStatusTest() throws Exception {
    ...
    ApiResponse<ErrorList> response =
        api.updateSupplySourceStatusWithHttpInfo(supplySourceId, null);
