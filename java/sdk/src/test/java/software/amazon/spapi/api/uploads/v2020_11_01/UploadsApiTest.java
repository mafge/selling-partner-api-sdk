...
public class UploadsApiTest {
  ...
  private final UploadsApi api =
      new UploadsApi.Builder().lwaAuthorizationCredentials(credentials).endpoint(endpoint).build();
  ...
  public void createUploadDestinationForResourceTest() throws Exception {
    ...
    ApiResponse<CreateUploadDestinationResponse> response =
        api.createUploadDestinationForResourceWithHttpInfo(
            marketplaceIds, contentMD5, resource, null);
