...
public class TokensApiTest {
  ...
  private final TokensApi api =
      new TokensApi.Builder().lwaAuthorizationCredentials(credentials).endpoint(endpoint).build();
  ...
  public void createRestrictedDataTokenTest() throws Exception {
    ...
    CreateRestrictedDataTokenRequest body =
        easyRandom.nextObject(CreateRestrictedDataTokenRequest.class);

    ApiResponse<CreateRestrictedDataTokenResponse> response =
        api.createRestrictedDataTokenWithHttpInfo(body);
