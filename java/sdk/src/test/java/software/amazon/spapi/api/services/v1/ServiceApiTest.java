...
public class ServiceApiTest {
  ...
  private final ServiceApi api =
      new ServiceApi.Builder().lwaAuthorizationCredentials(credentials).endpoint(endpoint).build();
  ...
  public void assignAppointmentResourcesTest() throws Exception {
    ...
    AssignAppointmentResourcesRequest body =
        easyRandom.nextObject(AssignAppointmentResourcesRequest.class);
    String serviceJobId = easyRandom.nextObject(String.class);
  ...
  public void createReservationTest() throws Exception {
    ...
    ApiResponse<CreateReservationResponse> response =
        api.createReservationWithHttpInfo(body, marketplaceIds);
  ...
  public void getServiceJobsTest() throws Exception {
    ...
    ApiResponse<GetServiceJobsResponse> response =
        api.getServiceJobsWithHttpInfo(
            marketplaceIds,
            null,
            null,
            null,
  ...
  public void rescheduleAppointmentForServiceJobByServiceJobIdTest() throws Exception {
    ...
    ApiResponse<SetAppointmentResponse> response =
        api.rescheduleAppointmentForServiceJobByServiceJobIdWithHttpInfo(
  ...
  public void setAppointmentFulfillmentDataTest() throws Exception {
    ...
    SetAppointmentFulfillmentDataRequest body =
        easyRandom.nextObject(SetAppointmentFulfillmentDataRequest.class);
    String serviceJobId = easyRandom.nextObject(String.class);
    String appointmentId = easyRandom.nextObject(String.class);

    ApiResponse<String> response =
        api.setAppointmentFulfillmentDataWithHttpInfo(body, serviceJobId, appointmentId);
  ...
  public void updateScheduleTest() throws Exception {
    ...
    ApiResponse<UpdateScheduleResponse> response =
        api.updateScheduleWithHttpInfo(body, resourceId, marketplaceIds);
