...
public class FeedsApiTest {
  ...
  private final FeedsApi api =
      new FeedsApi.Builder().lwaAuthorizationCredentials(credentials).endpoint(endpoint).build();
  ...
  public void createFeedDocumentTest() throws Exception {
    ...
    CreateFeedDocumentSpecification body =
        easyRandom.nextObject(CreateFeedDocumentSpecification.class);
  ...
  public void getFeedsTest() throws Exception {
    ...
    ApiResponse<GetFeedsResponse> response =
        api.getFeedsWithHttpInfo(null, null, null, null, null, null, null);
