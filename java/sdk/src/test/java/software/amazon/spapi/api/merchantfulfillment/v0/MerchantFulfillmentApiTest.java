...
public class MerchantFulfillmentApiTest {
  ...
  private final MerchantFulfillmentApi api =
      new MerchantFulfillmentApi.Builder()
  ...
  public void getAdditionalSellerInputsTest() throws Exception {
    ...
    GetAdditionalSellerInputsRequest body =
        easyRandom.nextObject(GetAdditionalSellerInputsRequest.class);

    ApiResponse<GetAdditionalSellerInputsResponse> response =
        api.getAdditionalSellerInputsWithHttpInfo(body);
  ...
  public void getEligibleShipmentServicesTest() throws Exception {
    ...
    GetEligibleShipmentServicesRequest body =
        easyRandom.nextObject(GetEligibleShipmentServicesRequest.class);

    ApiResponse<GetEligibleShipmentServicesResponse> response =
        api.getEligibleShipmentServicesWithHttpInfo(body);
