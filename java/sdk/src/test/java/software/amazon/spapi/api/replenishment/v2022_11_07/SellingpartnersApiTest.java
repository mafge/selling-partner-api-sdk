...
public class SellingpartnersApiTest {
  ...
  private final SellingpartnersApi api =
      new SellingpartnersApi.Builder()
  ...
  public void getSellingPartnerMetricsTest() throws Exception {
    ...
    ApiResponse<GetSellingPartnerMetricsResponse> response =
        api.getSellingPartnerMetricsWithHttpInfo(null);
