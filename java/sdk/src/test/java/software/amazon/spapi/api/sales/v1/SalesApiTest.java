...
public class SalesApiTest {
  ...
  private final SalesApi api =
      new SalesApi.Builder().lwaAuthorizationCredentials(credentials).endpoint(endpoint).build();
  ...
  public void getOrderMetricsTest() throws Exception {
    ...
    ApiResponse<GetOrderMetricsResponse> response =
        api.getOrderMetricsWithHttpInfo(
