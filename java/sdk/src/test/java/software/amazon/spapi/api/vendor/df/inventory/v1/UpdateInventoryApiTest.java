...
public class UpdateInventoryApiTest {
  ...
  private final UpdateInventoryApi api =
      new UpdateInventoryApi.Builder()
  ...
  public void submitInventoryUpdateTest() throws Exception {
    ...
    ApiResponse<SubmitInventoryUpdateResponse> response =
        api.submitInventoryUpdateWithHttpInfo(body, warehouseId);
