...
public class ProductPricingApiTest {
  ...
  private final ProductPricingApi api =
      new ProductPricingApi.Builder()
  ...
  public void getCompetitiveSummaryTest() throws Exception {
    ...
    CompetitiveSummaryBatchRequest body =
        easyRandom.nextObject(CompetitiveSummaryBatchRequest.class);

    ApiResponse<CompetitiveSummaryBatchResponse> response =
        api.getCompetitiveSummaryWithHttpInfo(body);
