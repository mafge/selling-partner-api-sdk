...
public class FbaOutboundApiTest {
  ...
  private final FbaOutboundApi api =
      new FbaOutboundApi.Builder()
  ...
  public void createFulfillmentOrderTest() throws Exception {
    ...
    ApiResponse<CreateFulfillmentOrderResponse> response =
        api.createFulfillmentOrderWithHttpInfo(body);
  ...
  public void createFulfillmentReturnTest() throws Exception {
    ...
    CreateFulfillmentReturnRequest body =
        easyRandom.nextObject(CreateFulfillmentReturnRequest.class);
    String sellerFulfillmentOrderId = easyRandom.nextObject(String.class);
  ...
  public void getFulfillmentPreviewTest() throws Exception {
    ...
    ApiResponse<GetFulfillmentPreviewResponse> response =
        api.getFulfillmentPreviewWithHttpInfo(body);
  ...
  public void listAllFulfillmentOrdersTest() throws Exception {
    ...
    ApiResponse<ListAllFulfillmentOrdersResponse> response =
        api.listAllFulfillmentOrdersWithHttpInfo(null, null);
