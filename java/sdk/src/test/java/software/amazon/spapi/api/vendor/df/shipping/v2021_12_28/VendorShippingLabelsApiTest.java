...
public class VendorShippingLabelsApiTest {
  ...
  private final VendorShippingLabelsApi api =
      new VendorShippingLabelsApi.Builder()
  ...
  public void createShippingLabelsTest() throws Exception {
    ...
    ApiResponse<ShippingLabel> response =
        api.createShippingLabelsWithHttpInfo(body, purchaseOrderNumber);
