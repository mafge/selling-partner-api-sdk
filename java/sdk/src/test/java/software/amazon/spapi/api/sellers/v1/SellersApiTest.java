...
public class SellersApiTest {
  ...
  private final SellersApi api =
      new SellersApi.Builder().lwaAuthorizationCredentials(credentials).endpoint(endpoint).build();
  ...
  public void getMarketplaceParticipationsTest() throws Exception {
    ...
    ApiResponse<GetMarketplaceParticipationsResponse> response =
        api.getMarketplaceParticipationsWithHttpInfo();
