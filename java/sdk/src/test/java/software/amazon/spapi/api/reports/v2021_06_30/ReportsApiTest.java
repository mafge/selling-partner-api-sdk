...
public class ReportsApiTest {
  ...
  private final ReportsApi api =
      new ReportsApi.Builder().lwaAuthorizationCredentials(credentials).endpoint(endpoint).build();
  ...
  public void createReportScheduleTest() throws Exception {
    ...
    CreateReportScheduleSpecification body =
        easyRandom.nextObject(CreateReportScheduleSpecification.class);
  ...
  public void getReportsTest() throws Exception {
    ...
    ApiResponse<GetReportsResponse> response =
        api.getReportsWithHttpInfo(null, null, null, null, null, null, null);
