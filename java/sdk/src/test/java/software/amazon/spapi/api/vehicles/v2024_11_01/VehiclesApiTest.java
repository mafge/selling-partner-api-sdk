...
public class VehiclesApiTest {
  ...
  private final VehiclesApi api =
      new VehiclesApi.Builder().lwaAuthorizationCredentials(credentials).endpoint(endpoint).build();
  ...
  public void getVehiclesTest() throws Exception {
    ...
    ApiResponse<VehiclesResponse> response =
        api.getVehiclesWithHttpInfo(marketplaceId, vehicleType, null, null);
