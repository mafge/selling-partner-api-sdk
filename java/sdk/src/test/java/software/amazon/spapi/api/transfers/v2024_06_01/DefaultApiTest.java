...
public class DefaultApiTest {
  ...
  private final DefaultApi api =
      new DefaultApi.Builder().lwaAuthorizationCredentials(credentials).endpoint(endpoint).build();
  ...
  public void getPaymentMethodsTest() throws Exception {
    ...
    ApiResponse<GetPaymentMethodsResponse> response =
        api.getPaymentMethodsWithHttpInfo(marketplaceId, null);
