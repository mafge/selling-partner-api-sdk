...
public class CatalogApiTest {
  ...
  private final CatalogApi api =
      new CatalogApi.Builder().lwaAuthorizationCredentials(credentials).endpoint(endpoint).build();
  ...
  public void searchCatalogItemsTest() throws Exception {
    ...
    ApiResponse<ItemSearchResults> response =
        api.searchCatalogItemsWithHttpInfo(
