...
public class FeesApiTest {
  ...
  private final FeesApi api =
      new FeesApi.Builder().lwaAuthorizationCredentials(credentials).endpoint(endpoint).build();
  ...
  public void getMyFeesEstimateForASINTest() throws Exception {
    ...
    ApiResponse<GetMyFeesEstimateResponse> response =
        api.getMyFeesEstimateForASINWithHttpInfo(body, asin);
  ...
  public void getMyFeesEstimateForSKUTest() throws Exception {
    ...
    ApiResponse<GetMyFeesEstimateResponse> response =
        api.getMyFeesEstimateForSKUWithHttpInfo(body, sellerSKU);
