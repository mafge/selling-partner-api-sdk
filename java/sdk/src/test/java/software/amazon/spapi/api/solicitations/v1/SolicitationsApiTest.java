...
public class SolicitationsApiTest {
  ...
  private final SolicitationsApi api =
      new SolicitationsApi.Builder()
  ...
  public void createProductReviewAndSellerFeedbackSolicitationTest() throws Exception {
    ...
    ApiResponse<CreateProductReviewAndSellerFeedbackSolicitationResponse> response =
        api.createProductReviewAndSellerFeedbackSolicitationWithHttpInfo(
            amazonOrderId, marketplaceIds);
