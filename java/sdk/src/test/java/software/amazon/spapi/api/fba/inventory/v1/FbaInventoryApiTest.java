...
public class FbaInventoryApiTest {
  ...
  private final FbaInventoryApi api =
      new FbaInventoryApi.Builder()
  ...
  public void addInventoryTest() throws Exception {
    ...
    ApiResponse<AddInventoryResponse> response =
        api.addInventoryWithHttpInfo(body, xAmznIdempotencyToken);
  ...
  public void getInventorySummariesTest() throws Exception {
    ...
    ApiResponse<GetInventorySummariesResponse> response =
        api.getInventorySummariesWithHttpInfo(
