...
/**
 * Describes a solicitation action that can be taken for an order. Provides a JSON Hypertext
 * Application Language (HAL) link to the JSON schema document that describes the expected input.
 */
@Schema(
    description =
        "Describes a solicitation action that can be taken for an order. Provides a JSON Hypertext"
            + " Application Language (HAL) link to the JSON schema document that describes the"
            + " expected input.")
