...
public class VendorTransactionApi {
   ...
   *
   * @param transactionId Previously returned in the response to the POST request of a specific
   ...
   */
  public okhttp3.Call getTransactionStatusCall(
  ...
  private okhttp3.Call getTransactionStatusValidateBeforeCall(
    ...
    if (transactionId == null) {
      throw new ApiException(
          "Missing the required parameter 'transactionId' when calling"
              + " getTransactionStatus(Async)");
    }

    okhttp3.Call call =
        getTransactionStatusCall(transactionId, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Returns the status of the transaction indicated by the specified transactionId. **Usage Plan:**
  ...
  /**
   * (asynchronously) Returns the status of the transaction indicated by the specified
   * transactionId. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 10 | 10
  ...
  public okhttp3.Call getTransactionStatusAsync(
      String transactionId, final ApiCallback<TransactionStatus> callback)
      throws ApiException, LWAException {
    ...
    okhttp3.Call call =
        getTransactionStatusValidateBeforeCall(
            transactionId, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<TransactionStatus>() {}.getType();
