...
public class Address {
   ...
   * @return addressLine1
   */
  @Schema(required = true, description = "First line of street address.")
   ...
   * @return county
   */
  @Schema(description = "The county where person, business or institution is located.")
   ...
   * @return district
   */
  @Schema(description = "The district where person, business or institution is located.")
   ...
   */
  @Schema(description = "The state or region where person, business or institution is located.")
  ...
  /**
   * The postal or zip code of that address. It contains a series of letters or digits or both,
  ...
  @Schema(
      description =
          "The postal or zip code of that address. It contains a series of letters or digits or"
