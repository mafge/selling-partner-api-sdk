...
/**
 * The response schema for the bulk scheduling API. It returns by the bulk scheduling API containing
 * an array of the scheduled packtages, an optional list of orders we couldn&#x27;t schedule with
 * the reason, and a pre-signed URL for a ZIP file containing the associated shipping labels plus
 * the documents enabled for your marketplace.
 */
@Schema(
    description =
        "The response schema for the bulk scheduling API. It returns by the bulk scheduling API"
            + " containing an array of the scheduled packtages, an optional list of orders we"
            + " couldn't schedule with the reason, and a pre-signed URL for a ZIP file containing"
            + " the associated shipping labels plus the documents enabled for your marketplace.")
public class CreateScheduledPackagesResponse {
  ...
  public CreateScheduledPackagesResponse addScheduledPackagesItem(
      ModelPackage scheduledPackagesItem) {
  ...
  /**
   * A list of orders we couldn&#x27;t scheduled on your behalf. Each element contains the reason
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreateScheduledPackagesResponse createScheduledPackagesResponse =
        (CreateScheduledPackagesResponse) o;
    return Objects.equals(this.scheduledPackages, createScheduledPackagesResponse.scheduledPackages)
        ...
        && Objects.equals(
            this.printableDocumentsUrl, createScheduledPackagesResponse.printableDocumentsUrl);
  }
