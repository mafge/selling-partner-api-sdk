...
public class Invoice {
  ...
  /**
   * The invoice identifier that is used by an external party. This is typically the government
  ...
  @Schema(
      description =
          "The invoice identifier that is used by an external party. This is typically the"
              + " government agency that authorized the invoice.")
  ...
  /**
   * The response message from the government authority when there is an error during invoice
   * issuance.
   *
   * @return govResponse
   */
  ...
  /**
   * Use this identifier in conjunction with &#x60;externalInvoiceId&#x60; to identify invoices from
   * the same seller.
   *
   * @return series
   */
  ...
  /**
   * The invoice status classification. Use the &#x60;getInvoicesAttributes&#x60; operation to check
  ...
  /**
   * Classification of the transaction that originated this invoice. Use the
