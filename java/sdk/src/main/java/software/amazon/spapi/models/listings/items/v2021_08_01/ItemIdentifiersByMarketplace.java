...
/**
 * Identity attributes associated with the item in the Amazon catalog for the indicated Amazon
 * marketplace.
 */
@Schema(
    description =
        "Identity attributes associated with the item in the Amazon catalog for the indicated"
            + " Amazon marketplace.")
