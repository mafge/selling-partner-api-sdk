...
/**
 * A constraint that applies to all owners. If no constraint is specified, defer to any individual
 * owner constraints.
 */
...
public enum AllOwnersConstraint {
  ...
  public static class Adapter extends TypeAdapter<AllOwnersConstraint> {
    @Override
    public void write(final JsonWriter jsonWriter, final AllOwnersConstraint enumeration)
        throws IOException {
