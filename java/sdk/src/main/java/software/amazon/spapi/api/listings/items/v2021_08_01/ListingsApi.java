...
public class ListingsApi {
   ...
   *     (required)
   * @param issueLocale A locale for localization of issues. When not provided, the default language
   *     code of the first marketplace is used. Examples: &#x60;en_US&#x60;, &#x60;fr_CA&#x60;,
   *     &#x60;fr_FR&#x60;. Localized messages default to &#x60;en_US&#x60; when a localization is
   *     not available in the specified locale. (optional)
  ...
  private okhttp3.Call deleteListingsItemValidateBeforeCall(
    ...
    if (sellerId == null) {
      throw new ApiException(
          "Missing the required parameter 'sellerId' when calling deleteListingsItem(Async)");
    }
    // verify the required parameter 'sku' is set
    if (sku == null) {
      throw new ApiException(
          "Missing the required parameter 'sku' when calling deleteListingsItem(Async)");
    }
    ...
    okhttp3.Call call =
        deleteListingsItemCall(
            sellerId, sku, marketplaceIds, issueLocale, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Delete a listings item for a selling partner. **Note:** The parameters associated with this
   * operation may contain special characters that must be encoded to successfully call the API. To
   ...
   * (requests per second) | Burst | | ---- | ---- | | 5 | 10 | The
  ...
  public ApiResponse<ListingsItemSubmissionResponse> deleteListingsItemWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        deleteListingsItemValidateBeforeCall(
            sellerId, sku, marketplaceIds, issueLocale, null, null);
    Type localVarReturnType = new TypeToken<ListingsItemSubmissionResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Delete a listings item for a selling partner. **Note:** The parameters
   * associated with this operation may contain special characters that must be encoded to
  ...
  public okhttp3.Call getListingsItemCall(
    ...
    if (includedData != null)
      localVarCollectionQueryParams.addAll(
          apiClient.parameterToPairs("csv", "includedData", includedData));
  ...
  private okhttp3.Call getListingsItemValidateBeforeCall(
    ...
    if (sellerId == null) {
      throw new ApiException(
          "Missing the required parameter 'sellerId' when calling getListingsItem(Async)");
    }
    // verify the required parameter 'sku' is set
    if (sku == null) {
      throw new ApiException(
          "Missing the required parameter 'sku' when calling getListingsItem(Async)");
    }
    // verify the required parameter 'marketplaceIds' is set
    if (marketplaceIds == null) {
      throw new ApiException(
  ...
  /**
   * Returns details about a listings item for a selling partner. **Note:** The parameters
   * associated with this operation may contain special characters that must be encoded to
   * successfully call the API. To avoid errors with SKUs when encoding URLs, refer to [URL
   * Encoding](https://developer-docs.amazon.com/sp-api/docs/url-encoding). **Usage Plan:** | Rate
   * (requests per second) | Burst | | ---- | ---- | | 5 | 10 | The
  ...
  public Item getListingsItem(
    ...
    ApiResponse<Item> resp =
        getListingsItemWithHttpInfo(sellerId, sku, marketplaceIds, issueLocale, includedData);
    return resp.getData();
  }
  ...
  public ApiResponse<Item> getListingsItemWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        getListingsItemValidateBeforeCall(
            sellerId, sku, marketplaceIds, issueLocale, includedData, null, null);
    Type localVarReturnType = new TypeToken<Item>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Returns details about a listings item for a selling partner. **Note:** The
   * parameters associated with this operation may contain special characters that must be encoded
   * to successfully call the API. To avoid errors with SKUs when encoding URLs, refer to [URL
   * Encoding](https://developer-docs.amazon.com/sp-api/docs/url-encoding). **Usage Plan:** | Rate
   * (requests per second) | Burst | | ---- | ---- | | 5 | 10 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The table above indicates the default rate
  ...
  private okhttp3.Call patchListingsItemValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling patchListingsItem(Async)");
    }
    // verify the required parameter 'sellerId' is set
    if (sellerId == null) {
      throw new ApiException(
          "Missing the required parameter 'sellerId' when calling patchListingsItem(Async)");
    }
    // verify the required parameter 'sku' is set
    if (sku == null) {
      throw new ApiException(
          "Missing the required parameter 'sku' when calling patchListingsItem(Async)");
    }
    // verify the required parameter 'marketplaceIds' is set
    if (marketplaceIds == null) {
      throw new ApiException(
   ...
   * attributes can be patched. Patching nested attributes is not supported. **Usage Plan:** | Rate
   * (requests per second) | Burst | | ---- | ---- | | 5 | 5 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   ...
   * higher throughput can receive higher rate and burst values then those shown here. For more
  ...
  public ListingsItemSubmissionResponse patchListingsItem(
    ...
    ApiResponse<ListingsItemSubmissionResponse> resp =
        patchListingsItemWithHttpInfo(
            body, sellerId, sku, marketplaceIds, includedData, mode, issueLocale);
    return resp.getData();
  }
  ...
  public ApiResponse<ListingsItemSubmissionResponse> patchListingsItemWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        patchListingsItemValidateBeforeCall(
  ...
  /**
   * (asynchronously) Partially update (patch) a listings item for a selling partner. Only top-level
   * listings item attributes can be patched. Patching nested attributes is not supported. **Usage
   * Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 5 | 5 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The preceding table indicates the default
   * rate and burst values for this operation. Selling partners whose business demands require
   * higher throughput can receive higher rate and burst values then those shown here. For more
  ...
  private okhttp3.Call putListingsItemValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling putListingsItem(Async)");
    }
    // verify the required parameter 'sellerId' is set
    if (sellerId == null) {
      throw new ApiException(
          "Missing the required parameter 'sellerId' when calling putListingsItem(Async)");
    }
    // verify the required parameter 'sku' is set
    if (sku == null) {
      throw new ApiException(
          "Missing the required parameter 'sku' when calling putListingsItem(Async)");
    }
    // verify the required parameter 'marketplaceIds' is set
    if (marketplaceIds == null) {
      throw new ApiException(
  ...
  /**
   * Creates or fully updates an existing listings item for a selling partner. **Note:** This
   * operation has a throttling rate of one request per second when &#x60;mode&#x60; is
   * &#x60;VALIDATION_PREVIEW&#x60;. **Note:** The parameters associated with this operation may
   * contain special characters that must be encoded to successfully call the API. To avoid errors
  ...
  public ApiResponse<ListingsItemSubmissionResponse> putListingsItemWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        putListingsItemValidateBeforeCall(
            body, sellerId, sku, marketplaceIds, includedData, mode, issueLocale, null, null);
    Type localVarReturnType = new TypeToken<ListingsItemSubmissionResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }
  ...
  /**
   * (asynchronously) Creates or fully updates an existing listings item for a selling partner.
   * **Note:** This operation has a throttling rate of one request per second when &#x60;mode&#x60;
   * is &#x60;VALIDATION_PREVIEW&#x60;. **Note:** The parameters associated with this operation may
   * contain special characters that must be encoded to successfully call the API. To avoid errors
   * with SKUs when encoding URLs, refer to [URL
   * Encoding](https://developer-docs.amazon.com/sp-api/docs/url-encoding). **Usage Plan:** | Rate
   * (requests per second) | Burst | | ---- | ---- | | 5 | 10 | The
   ...
   * @param marketplaceIds A comma-delimited list of Amazon marketplace identifiers for the request.
   *     (required)
   * @param issueLocale A locale that is used to localize issues. When not provided, the default
   *     language code of the first marketplace is used. Examples: \&quot;en_US\&quot;,
   *     \&quot;fr_CA\&quot;, \&quot;fr_FR\&quot;. When a localization is not available in the
   *     specified locale, localized messages default to \&quot;en_US\&quot;. (optional)
   * @param includedData A comma-delimited list of datasets that you want to include in the
   *     response. Default: &#x60;summaries&#x60;. (optional)
   * @param identifiers A comma-delimited list of product identifiers that you can use to search for
   *     listings items. **Note**: 1. This is required when you specify &#x60;identifiersType&#x60;.
   *     2. You cannot use &#x27;identifiers&#x27; if you specify &#x60;variationParentSku&#x60; or
   *     &#x60;packageHierarchySku&#x60;. (optional)
   * @param identifiersType A type of product identifiers that you can use to search for listings
   *     items. **Note**: This is required when &#x60;identifiers&#x60; is provided. (optional)
   * @param variationParentSku Filters results to include listing items that are variation children
   *     of the specified SKU. **Note**: You cannot use &#x60;variationParentSku&#x60; if you
   *     include &#x60;identifiers&#x60; or &#x60;packageHierarchySku&#x60; in your request.
   *     (optional)
   * @param packageHierarchySku Filter results to include listing items that contain or are
   *     contained by the specified SKU. **Note**: You cannot use &#x60;packageHierarchySku&#x60; if
   *     you include &#x60;identifiers&#x60; or &#x60;variationParentSku&#x60; in your request.
   *     (optional)
   * @param createdAfter A date-time that is used to filter listing items. The response includes
   *     listings items that were created at or after this time. Values are in [ISO
   *     8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format. (optional)
   * @param createdBefore A date-time that is used to filter listing items. The response includes
   *     listings items that were created at or before this time. Values are in [ISO
   *     8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format. (optional)
   * @param lastUpdatedAfter A date-time that is used to filter listing items. The response includes
   *     listings items that were last updated at or after this time. Values are in [ISO
   *     8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format. (optional)
   * @param lastUpdatedBefore A date-time that is used to filter listing items. The response
   *     includes listings items that were last updated at or before this time. Values are in [ISO
   *     8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format. (optional)
   * @param withIssueSeverity Filter results to include only listing items that have issues that
   *     match one or more of the specified severity levels. (optional)
   * @param withStatus Filter results to include only listing items that have the specified status.
   *     (optional)
   * @param withoutStatus Filter results to include only listing items that don&#x27;t contain the
   *     specified statuses. (optional)
   * @param sortBy An attribute by which to sort the returned listing items. (optional, default to
   *     lastUpdatedDate)
   * @param sortOrder The order in which to sort the result items. (optional, default to DESC)
   * @param pageSize The number of results that you want to include on each page. (optional, default
   *     to 10)
   * @param pageToken A token that you can use to fetch a specific page when there are multiple
   *     pages of results. (optional)
   * @param progressListener Progress listener
   * @param progressRequestListener Progress request listener
   * @return Call to execute
   * @throws ApiException If fail to serialize the request body object
  ...
  public okhttp3.Call searchListingsItemsCall(
    ...
    if (identifiers != null)
      localVarCollectionQueryParams.addAll(
          apiClient.parameterToPairs("csv", "identifiers", identifiers));
    ...
    if (variationParentSku != null)
      localVarQueryParams.addAll(
          apiClient.parameterToPair("variationParentSku", variationParentSku));
    if (packageHierarchySku != null)
      localVarQueryParams.addAll(
          apiClient.parameterToPair("packageHierarchySku", packageHierarchySku));
    ...
    if (withStatus != null)
      localVarCollectionQueryParams.addAll(
          apiClient.parameterToPairs("csv", "withStatus", withStatus));
    if (withoutStatus != null)
      localVarCollectionQueryParams.addAll(
          apiClient.parameterToPairs("csv", "withoutStatus", withoutStatus));
  ...
  private okhttp3.Call searchListingsItemsValidateBeforeCall(
    ...
    if (sellerId == null) {
      throw new ApiException(
          "Missing the required parameter 'sellerId' when calling searchListingsItems(Async)");
    }
    // verify the required parameter 'marketplaceIds' is set
    if (marketplaceIds == null) {
      throw new ApiException(
  ...
  public ItemSearchResults searchListingsItems(
      ...
      String pageToken)
      throws ApiException, LWAException {
    ApiResponse<ItemSearchResults> resp =
        searchListingsItemsWithHttpInfo(
            sellerId,
            marketplaceIds,
            issueLocale,
            includedData,
  ...
  public ApiResponse<ItemSearchResults> searchListingsItemsWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        searchListingsItemsValidateBeforeCall(
            sellerId,
            marketplaceIds,
            issueLocale,
            includedData,
  ...
  /**
   * (asynchronously) Search for and return a list of selling partner listings items and their
   * respective details. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 5
   * | 5 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits
   * that are applied to the requested operation, when available. The preceding table contains the
