...
public class InventorySummary {
  ...
  /**
   * The expiration details of the inventory. This object will only appear if the
   * &#x60;details&#x60; parameter in the request is set to &#x60;SHOW&#x60;.
   *
   * @return expirationDetails
   */
  @Schema(
      description =
          "The expiration details of the inventory. This object will only appear if the `details`"
              + " parameter in the request is set to `SHOW`.")
  ...
  /**
   * Total quantity that is in-transit from the seller and has not yet been received at an AWD
   * Distribution Center
   *
  ...
  @Schema(
      description =
          "Total quantity that is in-transit from the seller and has not yet been received at an"
              + " AWD Distribution Center")
  ...
  public int hashCode() {
    return Objects.hash(
        expirationDetails, inventoryDetails, sku, totalInboundQuantity, totalOnhandQuantity);
  }
