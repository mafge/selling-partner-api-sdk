...
public class FbaInboundApi {
   ...
   *
   * @param shipmentId A shipment identifier originally returned by the createInboundShipmentPlan
   *     operation. (required)
  ...
  private okhttp3.Call getBillOfLadingValidateBeforeCall(
    ...
    if (shipmentId == null) {
      throw new ApiException(
          "Missing the required parameter 'shipmentId' when calling getBillOfLading(Async)");
    }
   ...
   * getBillOfLading operation returns PDF document data for printing a bill of lading for an
   * Amazon-partnered Less Than Truckload/Full Truckload (LTL/FTL) inbound shipment. **Usage Plan:**
  ...
  /**
   * (asynchronously) Returns a bill of lading for a Less Than Truckload/Full Truckload (LTL/FTL)
   * shipment. The getBillOfLading operation returns PDF document data for printing a bill of lading
   * for an Amazon-partnered Less Than Truckload/Full Truckload (LTL/FTL) inbound shipment. **Usage
  ...
  public okhttp3.Call getBillOfLadingAsync(
      String shipmentId, final ApiCallback<GetBillOfLadingResponse> callback)
      throws ApiException, LWAException {
    ...
    okhttp3.Call call =
        getBillOfLadingValidateBeforeCall(shipmentId, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetBillOfLadingResponse>() {}.getType();
   ...
   * @param shipmentId A shipment identifier originally returned by the createInboundShipmentPlan
   *     operation. (required)
   * @param pageType The page type to use to print the labels. Submitting a PageType value that is
   *     not supported in your marketplace returns an error. (required)
   ...
   * @param packageLabelsToPrint A list of identifiers that specify packages for which you want
   *     package labels printed. If you provide box content information with the [FBA Inbound
   *     Shipment Carton Information
   ...
   *     then &#x60;PackageLabelsToPrint&#x60; must match the &#x60;CartonId&#x60; values you
   *     provide through that feed. If you provide box content information with the Fulfillment
   *     Inbound API v2024-03-20, then &#x60;PackageLabelsToPrint&#x60; must match the
   ...
   * @param numberOfPallets The number of pallets in the shipment. This returns four identical
   *     labels for each pallet. (optional)
   * @param pageSize The page size for paginating through the total packages&#x27; labels. This is a
   *     required parameter for Non-Partnered LTL Shipments. Max value:1000. (optional)
   * @param pageStartIndex The page start index for paginating through the total packages&#x27;
   *     labels. This is a required parameter for Non-Partnered LTL Shipments. (optional)
   * @param progressListener Progress listener
   * @param progressRequestListener Progress request listener
   * @return Call to execute
   * @throws ApiException If fail to serialize the request body object
  ...
  private okhttp3.Call getLabelsValidateBeforeCall(
    ...
    if (shipmentId == null) {
      throw new ApiException(
          "Missing the required parameter 'shipmentId' when calling getLabels(Async)");
    }
    // verify the required parameter 'pageType' is set
    if (pageType == null) {
      throw new ApiException(
          "Missing the required parameter 'pageType' when calling getLabels(Async)");
    }
    // verify the required parameter 'labelType' is set
    if (labelType == null) {
      throw new ApiException(
          "Missing the required parameter 'labelType' when calling getLabels(Async)");
    }
   ...
   * fulfillment center. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 2
  ...
  public GetLabelsResponse getLabels(
      ...
      Integer pageStartIndex)
      throws ApiException, LWAException {
    ApiResponse<GetLabelsResponse> resp =
   ...
   * at the Amazon fulfillment center. **Usage Plan:** | Rate (requests per second) | Burst | | ----
   ...
   *
   * @param shipToCountryCode The country code of the country to which the items will be shipped.
   *     Note that labeling requirements and item preparation instructions can vary by country.
   *     (required)
   * @param sellerSKUList A list of SellerSKU values. Used to identify items for which you want
   *     labeling requirements and item preparation instructions for shipment to Amazon&#x27;s
   *     fulfillment network. The SellerSKU is qualified by the Seller ID, which is included with
   *     every call to the Seller Partner API. Note: Include seller SKUs that you have used to list
   *     items on Amazon&#x27;s retail website. If you include a seller SKU that you have never used
   *     to list an item on Amazon&#x27;s retail website, the seller SKU is returned in the
   *     InvalidSKUList property in the response. (optional)
   * @param asINList A list of ASIN values. Used to identify items for which you want item
   *     preparation instructions to help with item sourcing decisions. Note: ASINs must be included
   *     in the product catalog for at least one of the marketplaces that the seller participates
   *     in. Any ASIN that is not included in the product catalog for at least one of the
   *     marketplaces that the seller participates in is returned in the InvalidASINList property in
  ...
  public okhttp3.Call getPrepInstructionsCall(
    ...
    if (sellerSKUList != null)
      localVarCollectionQueryParams.addAll(
          apiClient.parameterToPairs("csv", "SellerSKUList", sellerSKUList));
    if (asINList != null)
  ...
  private okhttp3.Call getPrepInstructionsValidateBeforeCall(
    ...
    if (shipToCountryCode == null) {
      throw new ApiException(
          "Missing the required parameter 'shipToCountryCode' when calling"
              + " getPrepInstructions(Async)");
    }

    okhttp3.Call call =
        getPrepInstructionsCall(
            shipToCountryCode, sellerSKUList, asINList, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Returns labeling requirements and item preparation instructions to help prepare items for
   * shipment to Amazon&#x27;s fulfillment network. **Usage Plan:** | Rate (requests per second) |
  ...
  public ApiResponse<GetPrepInstructionsResponse> getPrepInstructionsWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        getPrepInstructionsValidateBeforeCall(
            shipToCountryCode, sellerSKUList, asINList, null, null);
    Type localVarReturnType = new TypeToken<GetPrepInstructionsResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Returns labeling requirements and item preparation instructions to help
   * prepare items for shipment to Amazon&#x27;s fulfillment network. **Usage Plan:** | Rate
   ...
   *
   * @param queryType Indicates whether items are returned using a date range (by providing the
   *     LastUpdatedAfter and LastUpdatedBefore parameters), or using NextToken, which continues
   *     returning items specified in a previous request. (required)
   * @param marketplaceId A marketplace identifier. Specifies the marketplace where the product
   *     would be stored. (required)
   * @param lastUpdatedAfter A date used for selecting inbound shipment items that were last updated
   *     after (or at) a specified time. The selection includes updates made by Amazon and by the
   *     seller. (optional)
   * @param lastUpdatedBefore A date used for selecting inbound shipment items that were last
   *     updated before (or at) a specified time. The selection includes updates made by Amazon and
   *     by the seller. (optional)
  ...
  private okhttp3.Call getShipmentItemsValidateBeforeCall(
    ...
    if (queryType == null) {
      throw new ApiException(
          "Missing the required parameter 'queryType' when calling getShipmentItems(Async)");
    }
  ...
  /**
   * Returns a list of items in a specified inbound shipment, or a list of items that were updated
   * within a specified time frame. **Usage Plan:** | Rate (requests per second) | Burst | | ---- |
  ...
  public GetShipmentItemsResponse getShipmentItems(
    ...
    ApiResponse<GetShipmentItemsResponse> resp =
        getShipmentItemsWithHttpInfo(
            queryType, marketplaceId, lastUpdatedAfter, lastUpdatedBefore, nextToken);
    return resp.getData();
  }
  ...
  public ApiResponse<GetShipmentItemsResponse> getShipmentItemsWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        getShipmentItemsValidateBeforeCall(
  ...
  /**
   * (asynchronously) Returns a list of items in a specified inbound shipment, or a list of items
   * that were updated within a specified time frame. **Usage Plan:** | Rate (requests per second) |
   * Burst | | ---- | ---- | | 2 | 30 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header
   * returns the usage plan rate limits that were applied to the requested operation, when
   * available. The table above indicates the default rate and burst values for this operation.
   * Selling partners whose business demands require higher throughput may see higher rate and burst
   ...
   *
   * @param shipmentId A shipment identifier used for selecting items in a specific inbound
   *     shipment. (required)
    ...
    if (shipmentId == null) {
      throw new ApiException(
          "Missing the required parameter 'shipmentId' when calling"
              + " getShipmentItemsByShipmentId(Async)");
    }

    okhttp3.Call call =
        getShipmentItemsByShipmentIdCall(
            shipmentId, marketplaceId, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Returns a list of items in a specified inbound shipment. **Usage Plan:** | Rate (requests per
  ...
  public ApiResponse<GetShipmentItemsResponse> getShipmentItemsByShipmentIdWithHttpInfo(
      String shipmentId, String marketplaceId) throws ApiException, LWAException {
    okhttp3.Call call =
        getShipmentItemsByShipmentIdValidateBeforeCall(shipmentId, marketplaceId, null, null);
    Type localVarReturnType = new TypeToken<GetShipmentItemsResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Returns a list of items in a specified inbound shipment. **Usage Plan:** |
   * Rate (requests per second) | Burst | | ---- | ---- | | 2 | 30 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The table above indicates the default rate
   * and burst values for this operation. Selling partners whose business demands require higher
  ...
  public okhttp3.Call getShipmentItemsByShipmentIdAsync(
    ...
    okhttp3.Call call =
        getShipmentItemsByShipmentIdValidateBeforeCall(
            shipmentId, marketplaceId, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetShipmentItemsResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
   ...
   *
   * @param queryType Indicates whether shipments are returned using shipment information (by
   *     providing the ShipmentStatusList or ShipmentIdList parameters), using a date range (by
   *     providing the LastUpdatedAfter and LastUpdatedBefore parameters), or by using NextToken to
   *     continue returning items specified in a previous request. (required)
   * @param marketplaceId A marketplace identifier. Specifies the marketplace where the product
   *     would be stored. (required)
   * @param shipmentStatusList A list of ShipmentStatus values. Used to select shipments with a
   *     current status that matches the status values that you specify. (optional)
   * @param shipmentIdList A list of shipment IDs used to select the shipments that you want. If
   *     both ShipmentStatusList and ShipmentIdList are specified, only shipments that match both
   *     parameters are returned. (optional)
   * @param lastUpdatedAfter A date used for selecting inbound shipments that were last updated
   *     after (or at) a specified time. The selection includes updates made by Amazon and by the
   *     seller. (optional)
   * @param lastUpdatedBefore A date used for selecting inbound shipments that were last updated
   *     before (or at) a specified time. The selection includes updates made by Amazon and by the
   *     seller. (optional)
   * @param nextToken A string token returned in the response to your previous request. (optional)
   * @param progressListener Progress listener
   * @param progressRequestListener Progress request listener
  ...
  public okhttp3.Call getShipmentsCall(
    ...
    if (shipmentIdList != null)
      localVarCollectionQueryParams.addAll(
          apiClient.parameterToPairs("csv", "ShipmentIdList", shipmentIdList));
    if (lastUpdatedAfter != null)
      localVarQueryParams.addAll(apiClient.parameterToPair("LastUpdatedAfter", lastUpdatedAfter));
    if (lastUpdatedBefore != null)
      localVarQueryParams.addAll(apiClient.parameterToPair("LastUpdatedBefore", lastUpdatedBefore));
  ...
  private okhttp3.Call getShipmentsValidateBeforeCall(
    ...
    if (queryType == null) {
      throw new ApiException(
          "Missing the required parameter 'queryType' when calling getShipments(Async)");
    }
    // verify the required parameter 'marketplaceId' is set
    if (marketplaceId == null) {
      throw new ApiException(
          "Missing the required parameter 'marketplaceId' when calling getShipments(Async)");
    }
  ...
  /**
   * Returns a list of inbound shipments based on criteria that you specify. **Usage Plan:** | Rate
   * (requests per second) | Burst | | ---- | ---- | | 2 | 30 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The table above indicates the default rate
   * and burst values for this operation. Selling partners whose business demands require higher
  ...
  public GetShipmentsResponse getShipments(
      ...
      String nextToken)
      throws ApiException, LWAException {
    ApiResponse<GetShipmentsResponse> resp =
  ...
  public ApiResponse<GetShipmentsResponse> getShipmentsWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        getShipmentsValidateBeforeCall(
            queryType,
            marketplaceId,
            shipmentStatusList,
            shipmentIdList,
  ...
  /**
   * (asynchronously) Returns a list of inbound shipments based on criteria that you specify.
