...
/**
 * A financial adjustment event for FBA liquidated inventory. A positive value indicates money owed
 * to Amazon by the buyer (for example, when the charge was incorrectly calculated as less than it
 * should be). A negative value indicates a full or partial refund owed to the buyer (for example,
 * when the buyer receives damaged items or fewer items than ordered).
 */
@Schema(
    description =
        "A financial adjustment event for FBA liquidated inventory. A positive value indicates"
            + " money owed to Amazon by the buyer (for example, when the charge was incorrectly"
            + " calculated as less than it should be). A negative value indicates a full or partial"
            + " refund owed to the buyer (for example, when the buyer receives damaged items or"
...
public class RemovalShipmentAdjustmentEvent {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RemovalShipmentAdjustmentEvent removalShipmentAdjustmentEvent =
        (RemovalShipmentAdjustmentEvent) o;
