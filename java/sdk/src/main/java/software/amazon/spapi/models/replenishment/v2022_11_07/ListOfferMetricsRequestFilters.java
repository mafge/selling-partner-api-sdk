...
/**
 * Use these parameters to filter results. Any result must match all provided parameters. For any
 * parameter that is an array, the result must match at least one element in the provided array.
 */
@Schema(
    description =
        "Use these parameters to filter results. Any result must match all provided parameters. For"
            + " any parameter that is an array, the result must match at least one element in the"
            + " provided array.")
public class ListOfferMetricsRequestFilters {
  ...
  public ListOfferMetricsRequestFilters aggregationFrequency(
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ListOfferMetricsRequestFilters listOfferMetricsRequestFilters =
        (ListOfferMetricsRequestFilters) o;
    return Objects.equals(
            this.aggregationFrequency, listOfferMetricsRequestFilters.aggregationFrequency)
  ...
  public int hashCode() {
    return Objects.hash(
        aggregationFrequency, timeInterval, timePeriodType, marketplaceId, programTypes, asins);
  }
