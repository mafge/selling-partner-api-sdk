...
public class DefaultApi {
   ...
   *
   * @param marketplaceId The identifier of the marketplace from which you want to retrieve payment
   ...
   * @param paymentMethodTypes A comma-separated list of the payment method types you want to
   *     include in the response. (optional)
   ...
   */
  public okhttp3.Call getPaymentMethodsCall(
  ...
  public GetPaymentMethodsResponse getPaymentMethods(
    ...
    ApiResponse<GetPaymentMethodsResponse> resp =
        getPaymentMethodsWithHttpInfo(marketplaceId, paymentMethodTypes);
    return resp.getData();
  }
  ...
  public ApiResponse<GetPaymentMethodsResponse> getPaymentMethodsWithHttpInfo(
      String marketplaceId, List<String> paymentMethodTypes) throws ApiException, LWAException {
    okhttp3.Call call =
        getPaymentMethodsValidateBeforeCall(marketplaceId, paymentMethodTypes, null, null);
    Type localVarReturnType = new TypeToken<GetPaymentMethodsResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Returns the list of payment methods for the seller, which can be filtered by
   * method type. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | .5 | 30 |
  ...
  public okhttp3.Call getPaymentMethodsAsync(
    ...
    okhttp3.Call call =
        getPaymentMethodsValidateBeforeCall(
            marketplaceId, paymentMethodTypes, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetPaymentMethodsResponse>() {}.getType();
   ...
   * @throws LWAException If calls to fetch LWA access token fails
   */
  public okhttp3.Call initiatePayoutCall(
  ...
  private okhttp3.Call initiatePayoutValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling initiatePayout(Async)");
    }
  ...
  /**
   * Initiates an on-demand payout to the seller&#x27;s default deposit method in Seller Central for
   * the given &#x60;marketplaceId&#x60; and &#x60;accountType&#x60;, if eligible. You can only
   * initiate one on-demand payout for each marketplace and account type within a 24-hour period.
   * **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 0.017 | 2 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header contains the usage plan rate limits for the
   * operation, when available. The preceding table contains the default rate and burst values for
   * this operation. Selling partners whose business demands require higher throughput might have
   * higher rate and burst values than those shown here. For more information, refer to [Usage Plans
  ...
  /**
   * (asynchronously) Initiates an on-demand payout to the seller&#x27;s default deposit method in
   * Seller Central for the given &#x60;marketplaceId&#x60; and &#x60;accountType&#x60;, if
   * eligible. You can only initiate one on-demand payout for each marketplace and account type
   * within a 24-hour period. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- |
   * | 0.017 | 2 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header contains the usage plan
   * rate limits for the operation, when available. The preceding table contains the default rate
  ...
  public okhttp3.Call initiatePayoutAsync(
    ...
    okhttp3.Call call =
        initiatePayoutValidateBeforeCall(body, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<InitiatePayoutResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
