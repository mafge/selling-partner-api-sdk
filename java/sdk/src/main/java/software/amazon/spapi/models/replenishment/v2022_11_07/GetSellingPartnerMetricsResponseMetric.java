...
public class GetSellingPartnerMetricsResponseMetric {
  ...
  /**
   * The percentage of items that were not shipped out of the total shipped units over a period of
   * time due to being out of stock. Applicable to PERFORMANCE timePeriodType. minimum: 0 maximum:
   * 100
   *
  ...
  @Schema(
      description =
          "The percentage of items that were not shipped out of the total shipped units over a"
              + " period of time due to being out of stock. Applicable to PERFORMANCE"
              + " timePeriodType.")
  ...
  public GetSellingPartnerMetricsResponseMetric totalSubscriptionsRevenue(
  ...
  public GetSellingPartnerMetricsResponseMetric shippedSubscriptionUnits(
      BigDecimal shippedSubscriptionUnits) {
  ...
  @Schema(
      description =
          "The number of units shipped to the subscribers over a period of time. Applicable for"
              + " both the PERFORMANCE and FORECAST timePeriodType.")
  ...
  public GetSellingPartnerMetricsResponseMetric activeSubscriptions(
      BigDecimal activeSubscriptions) {
  ...
  public GetSellingPartnerMetricsResponseMetric subscriberAverageRevenue(
      Double subscriberAverageRevenue) {
    this.subscriberAverageRevenue = subscriberAverageRevenue;
    return this;
  }

  /**
   * The average revenue per subscriber of the program over a period of past 12 months for sellers
   * and 6 months for vendors. Applicable to PERFORMANCE timePeriodType. minimum: 0
   *
   * @return subscriberAverageRevenue
   */
  @Schema(
      description =
          "The average revenue per subscriber of the program over a period of past 12 months for"
  ...
  public GetSellingPartnerMetricsResponseMetric nonSubscriberAverageRevenue(
      Double nonSubscriberAverageRevenue) {
    this.nonSubscriberAverageRevenue = nonSubscriberAverageRevenue;
    return this;
  }

  /**
   * The average revenue per non-subscriber of the program over a period of past 12 months for
   * sellers and 6 months for vendors. Applicable to PERFORMANCE timePeriodType. minimum: 0
   *
   * @return nonSubscriberAverageRevenue
   */
  @Schema(
      description =
          "The average revenue per non-subscriber of the program over a period of past 12 months"
              + " for sellers and 6 months for vendors. Applicable to PERFORMANCE timePeriodType.")
  ...
  public GetSellingPartnerMetricsResponseMetric subscriberAverageReorders(
      Double subscriberAverageReorders) {
  ...
  @Schema(
      description =
          "The average reorders per subscriber of the program over a period of 12 months."
  ...
  public GetSellingPartnerMetricsResponseMetric nonSubscriberAverageReorders(
      Double nonSubscriberAverageReorders) {
    this.nonSubscriberAverageReorders = nonSubscriberAverageReorders;
    return this;
  }

  /**
   * The average reorders per non-subscriber of the program over a period of past 12 months.
  ...
  public GetSellingPartnerMetricsResponseMetric couponsRevenuePenetration(
      Double couponsRevenuePenetration) {
    this.couponsRevenuePenetration = couponsRevenuePenetration;
    return this;
  }

  /**
   * The percentage of revenue from ASINs with coupons out of total revenue from all ASINs.
   * Applicable to PERFORMANCE timePeriodType. minimum: 0 maximum: 100
   *
  ...
  /**
   * The subscription revenue generated from subscriptions with over two deliveries over the past 12
  ...
  @Schema(
      description =
          "The subscription revenue generated from subscriptions with over two deliveries over the"
              + " past 12 months. Applicable to PERFORMANCE timePeriodType.")
  ...
  /**
   * The subscription revenue generated from active subscriptions with one delivery over the past 12
   * months. Applicable to PERFORMANCE timePeriodType. minimum: 0
   *
  ...
  @Schema(
      description =
          "The subscription revenue generated from active subscriptions with one delivery over the"
              + " past 12 months. Applicable to PERFORMANCE timePeriodType.")
  ...
  /**
   * The subscription revenue generated from subscriptions which are cancelled after one delivery
   * over the past 12 months. Applicable to PERFORMANCE timePeriodType. minimum: 0
   *
   * @return revenueFromCancelledSubscriptionsAfterSingleDelivery
   */
  @Schema(
      description =
          "The subscription revenue generated from subscriptions which are cancelled after one"
              + " delivery over the past 12 months. Applicable to PERFORMANCE timePeriodType.")
  ...
  public GetSellingPartnerMetricsResponseMetric subscriberRetentionFor30Days(
      Double subscriberRetentionFor30Days) {
  ...
  @Schema(
      description =
          "The percentage of subscriptions retained after 30 days of subscription creation."
              + " Applicable to PERFORMANCE timePeriodType.")
  ...
  public GetSellingPartnerMetricsResponseMetric subscriberRetentionFor90Days(
      Double subscriberRetentionFor90Days) {
  ...
  @Schema(
      description =
          "The percentage of subscriptions retained after 90 days of subscription creation."
              + " Applicable to PERFORMANCE timePeriodType.")
  ...
  /**
   * The percentage of subscription revenue generated by offers with 0% seller-funded discount over
   * the last 12 months. Applicable to PERFORMANCE timePeriodType. minimum: 0 maximum: 100
   *
   * @return revenuePenetrationFor0PercentSellerFunding
   */
  @Schema(
      description =
          "The percentage of subscription revenue generated by offers with 0% seller-funded"
  ...
  public void setRevenuePenetrationFor0PercentSellerFunding(
      Double revenuePenetrationFor0PercentSellerFunding) {
    this.revenuePenetrationFor0PercentSellerFunding = revenuePenetrationFor0PercentSellerFunding;
  }
  ...
  /**
   * [Applicable only for Sellers] The percentage of subscription revenue generated by offers with
  ...
  @Schema(
      description =
          "[Applicable only for Sellers] The percentage of subscription revenue generated by offers"
              + " with 5% seller-funded discount over the last 12 months. Applicable to PERFORMANCE"
              + " timePeriodType.")
  public Double getRevenuePenetrationFor5PercentSellerFunding() {
    return revenuePenetrationFor5PercentSellerFunding;
  }

  public void setRevenuePenetrationFor5PercentSellerFunding(
      Double revenuePenetrationFor5PercentSellerFunding) {
    this.revenuePenetrationFor5PercentSellerFunding = revenuePenetrationFor5PercentSellerFunding;
  }
  ...
  @Schema(
      description =
          "[Applicable only for Sellers] The percentage of subscription revenue generated by offers"
              + " with 10% seller-funded discount over the last 12 months. Applicable to"
              + " PERFORMANCE timePeriodType.")
  public Double getRevenuePenetrationFor10PercentSellerFunding() {
    return revenuePenetrationFor10PercentSellerFunding;
  }

  public void setRevenuePenetrationFor10PercentSellerFunding(
      Double revenuePenetrationFor10PercentSellerFunding) {
    this.revenuePenetrationFor10PercentSellerFunding = revenuePenetrationFor10PercentSellerFunding;
  }
  ...
  /**
   * [Applicable only for vendors] The percentage of subscription revenue generated by offers with
   * 5% or above seller-funded discount over the last 12 months. Applicable to PERFORMANCE
  ...
  @Schema(
      description =
          "[Applicable only for vendors] The percentage of subscription revenue generated by offers"
              + " with 5% or above seller-funded discount over the last 12 months. Applicable to"
              + " PERFORMANCE timePeriodType.")
  ...
  public GetSellingPartnerMetricsResponseMetric shareOfCouponSubscriptions(
      Double shareOfCouponSubscriptions) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(
            this.notDeliveredDueToOOS, getSellingPartnerMetricsResponseMetric.notDeliveredDueToOOS)
        && Objects.equals(
            this.totalSubscriptionsRevenue,
            getSellingPartnerMetricsResponseMetric.totalSubscriptionsRevenue)
        && Objects.equals(
            this.shippedSubscriptionUnits,
            getSellingPartnerMetricsResponseMetric.shippedSubscriptionUnits)
        && Objects.equals(
            this.activeSubscriptions, getSellingPartnerMetricsResponseMetric.activeSubscriptions)
        && Objects.equals(
            this.subscriberAverageRevenue,
            getSellingPartnerMetricsResponseMetric.subscriberAverageRevenue)
        && Objects.equals(
            this.nonSubscriberAverageRevenue,
            getSellingPartnerMetricsResponseMetric.nonSubscriberAverageRevenue)
        && Objects.equals(
            this.lostRevenueDueToOOS, getSellingPartnerMetricsResponseMetric.lostRevenueDueToOOS)
        && Objects.equals(
