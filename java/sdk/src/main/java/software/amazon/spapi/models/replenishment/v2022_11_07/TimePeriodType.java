...
/**
 * The time period type that determines whether the metrics requested are backward-looking
 * (performance) or forward-looking (forecast).
 */
...
public enum TimePeriodType {
  ...
  public static class Adapter extends TypeAdapter<TimePeriodType> {
    @Override
    public void write(final JsonWriter jsonWriter, final TimePeriodType enumeration)
        throws IOException {
