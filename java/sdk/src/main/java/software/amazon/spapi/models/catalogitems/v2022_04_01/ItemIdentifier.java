...
/**
 * The identifier that is associated with the item in the Amazon catalog, such as a UPC or EAN
 * identifier.
 */
@Schema(
    description =
        "The identifier that is associated with the item in the Amazon catalog, such as a UPC or"
            + " EAN identifier.")
