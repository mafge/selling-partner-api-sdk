...
public class OfferIdentifier {
  ...
  /**
   * The seller SKU of the item. This will only be present for the target offer, which belongs to
  ...
  @Schema(
      description =
          "The seller SKU of the item. This will only be present for the target offer, which"
              + " belongs to the requesting seller.")
