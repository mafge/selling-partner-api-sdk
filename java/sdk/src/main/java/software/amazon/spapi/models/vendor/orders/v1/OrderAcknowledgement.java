...
/**
 * Represents an acknowledgement for an order, including the purchase order number, selling party
 * details, acknowledgement date, and a list of acknowledged items.
 */
@Schema(
    description =
        "Represents an acknowledgement for an order, including the purchase order number, selling"
            + " party details, acknowledgement date, and a list of acknowledged items.")
