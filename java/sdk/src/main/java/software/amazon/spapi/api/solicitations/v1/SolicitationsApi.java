...
public class SolicitationsApi {
   ...
   *
   * @param amazonOrderId An Amazon order identifier. This specifies the order for which a
   *     solicitation is sent. (required)
   * @param marketplaceIds A marketplace identifier. This specifies the marketplace in which the
   *     order was placed. Only one marketplace can be specified. (required)
    ...
    if (amazonOrderId == null) {
      throw new ApiException(
          "Missing the required parameter 'amazonOrderId' when calling"
              + " createProductReviewAndSellerFeedbackSolicitation(Async)");
    }
  ...
  /**
   * Sends a solicitation to a buyer asking for seller feedback and a product review for the
   * specified order. Send only one productReviewAndSellerFeedback or free form proactive message
   * per order. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 1 | 5 | The
   ...
   * @throws LWAException If calls to fetch LWA access token fails
   */
  public CreateProductReviewAndSellerFeedbackSolicitationResponse
  ...
  public ApiResponse<CreateProductReviewAndSellerFeedbackSolicitationResponse>
      createProductReviewAndSellerFeedbackSolicitationWithHttpInfo(
          String amazonOrderId, List<String> marketplaceIds) throws ApiException, LWAException {
    okhttp3.Call call =
        createProductReviewAndSellerFeedbackSolicitationValidateBeforeCall(
  ...
  /**
   * (asynchronously) Sends a solicitation to a buyer asking for seller feedback and a product
   * review for the specified order. Send only one productReviewAndSellerFeedback or free form
   * proactive message per order. **Usage Plan:** | Rate (requests per second) | Burst | | ---- |
   * ---- | | 1 | 5 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan
   ...
   *     list of available solicitation types. (required)
   * @param marketplaceIds A marketplace identifier. This specifies the marketplace in which the
   *     order was placed. Only one marketplace can be specified. (required)
   * @param progressListener Progress listener
   * @param progressRequestListener Progress request listener
  ...
  private okhttp3.Call getSolicitationActionsForOrderValidateBeforeCall(
    ...
    if (amazonOrderId == null) {
      throw new ApiException(
          "Missing the required parameter 'amazonOrderId' when calling"
              + " getSolicitationActionsForOrder(Async)");
    }
    // verify the required parameter 'marketplaceIds' is set
    if (marketplaceIds == null) {
      throw new ApiException(
   ...
   * solicitation type is represented by an actions object, which contains a path and query
   * parameter(s). You can use the path and parameter(s) to call an operation that sends a
   * solicitation. Currently only the productReviewAndSellerFeedbackSolicitation solicitation type
   * is available. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 1 | 5 |
   ...
   * @throws LWAException If calls to fetch LWA access token fails
   */
  public ApiResponse<GetSolicitationActionsForOrderResponse>
      getSolicitationActionsForOrderWithHttpInfo(String amazonOrderId, List<String> marketplaceIds)
          throws ApiException, LWAException {
    okhttp3.Call call =
        getSolicitationActionsForOrderValidateBeforeCall(amazonOrderId, marketplaceIds, null, null);
    Type localVarReturnType = new TypeToken<GetSolicitationActionsForOrderResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Returns a list of solicitation types that are available for an order that you
   * specify. A solicitation type is represented by an actions object, which contains a path and
   * query parameter(s). You can use the path and parameter(s) to call an operation that sends a
   * solicitation. Currently only the productReviewAndSellerFeedbackSolicitation solicitation type
   * is available. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 1 | 5 |
   * The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that
   * were applied to the requested operation, when available. The table above indicates the default
  ...
  public okhttp3.Call getSolicitationActionsForOrderAsync(
    ...
    okhttp3.Call call =
        getSolicitationActionsForOrderValidateBeforeCall(
            amazonOrderId, marketplaceIds, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetSolicitationActionsForOrderResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
