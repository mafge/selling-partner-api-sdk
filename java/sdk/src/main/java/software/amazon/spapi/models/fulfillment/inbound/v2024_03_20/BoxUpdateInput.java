...
public class BoxUpdateInput {
  ...
  public BoxUpdateInput contentInformationSource(
      BoxContentInformationSource contentInformationSource) {
  ...
  /**
   * Primary key to uniquely identify a Box Package. PackageId must be provided if the intent is to
   * update an existing box. Adding a new box will not require providing this value. Any existing
   * PackageIds not provided will be treated as to-be-removed
   *
   * @return packageId
   */
  @Schema(
      description =
          "Primary key to uniquely identify a Box Package. PackageId must be provided if the intent"
              + " is to update an existing box. Adding a new box will not require providing this"
              + " value. Any existing PackageIds not provided will be treated as to-be-removed")
  ...
  @Schema(
      required = true,
      description =
          "The number of containers where all other properties like weight or dimensions are"
              + " identical.")
