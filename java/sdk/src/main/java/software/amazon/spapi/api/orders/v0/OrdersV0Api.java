...
public class OrdersV0Api {
  ...
  private okhttp3.Call confirmShipmentValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling confirmShipment(Async)");
    }
    // verify the required parameter 'orderId' is set
    if (orderId == null) {
      throw new ApiException(
          "Missing the required parameter 'orderId' when calling confirmShipment(Async)");
    }

    okhttp3.Call call =
        confirmShipmentCall(body, orderId, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Updates the shipment confirmation status for a specified order. **Usage Plan:** | Rate
   * (requests per second) | Burst | | ---- | ---- | | 2 | 10 | The
   ...
   * @throws LWAException If calls to fetch LWA access token fails
   */
  public void confirmShipment(ConfirmShipmentRequest body, String orderId)
      throws ApiException, LWAException {
  ...
  /**
   * (asynchronously) Updates the shipment confirmation status for a specified order. **Usage
   * Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 2 | 10 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The preceding table contains the default
   * rate and burst values for this operation. Selling partners whose business demands require
   * higher throughput may receive higher rate and burst values then those shown here. For more
  ...
  public okhttp3.Call confirmShipmentAsync(
    ...
    okhttp3.Call call =
        confirmShipmentValidateBeforeCall(body, orderId, progressListener, progressRequestListener);
   ...
   * ---- | ---- | | 0.5 | 30 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the
   ...
   * whose business demands require higher throughput may receive higher rate and burst values then
  ...
  /**
   * (asynchronously) Returns the order that you specify. **Usage Plan:** | Rate (requests per
   * second) | Burst | | ---- | ---- | | 0.5 | 30 | The &#x60;x-amzn-RateLimit-Limit&#x60; response
  ...
  public okhttp3.Call getOrderAsync(String orderId, final ApiCallback<GetOrderResponse> callback)
    ...
    okhttp3.Call call =
        getOrderValidateBeforeCall(orderId, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetOrderResponse>() {}.getType();
  ...
  private okhttp3.Call getOrderAddressValidateBeforeCall(
    ...
    if (orderId == null) {
      throw new ApiException(
          "Missing the required parameter 'orderId' when calling getOrderAddress(Async)");
    }
  ...
  /**
   * Returns the shipping address for the order that you specify. **Usage Plan:** | Rate (requests
   * per second) | Burst | | ---- | ---- | | 0.5 | 30 | The &#x60;x-amzn-RateLimit-Limit&#x60;
   ...
   * this operation. Selling partners whose business demands require higher throughput may receive
   * higher rate and burst values then those shown here. For more information, refer to [Usage Plans
   * and Rate
   * Limits](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api).
   *
   * @param orderId An &#x60;orderId&#x60; is an Amazon-defined order identifier, in 3-7-7 format.
  ...
  /**
   * (asynchronously) Returns the shipping address for the order that you specify. **Usage Plan:** |
   * Rate (requests per second) | Burst | | ---- | ---- | | 0.5 | 30 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The preceding table contains the default
   * rate and burst values for this operation. Selling partners whose business demands require
   * higher throughput may receive higher rate and burst values then those shown here. For more
  ...
  public okhttp3.Call getOrderAddressAsync(
      String orderId, final ApiCallback<GetOrderAddressResponse> callback)
      throws ApiException, LWAException {
    ...
    okhttp3.Call call =
        getOrderAddressValidateBeforeCall(orderId, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetOrderAddressResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
  ...
  private okhttp3.Call getOrderBuyerInfoValidateBeforeCall(
    ...
    if (orderId == null) {
      throw new ApiException(
          "Missing the required parameter 'orderId' when calling getOrderBuyerInfo(Async)");
    }
  ...
  /**
   * Returns buyer information for the order that you specify. **Usage Plan:** | Rate (requests per
   * second) | Burst | | ---- | ---- | | 0.5 | 30 | The &#x60;x-amzn-RateLimit-Limit&#x60; response
   * header returns the usage plan rate limits that were applied to the requested operation, when
   * available. The preceding table contains the default rate and burst values for this operation.
   * Selling partners whose business demands require higher throughput may receive higher rate and
  ...
  /**
   * (asynchronously) Returns buyer information for the order that you specify. **Usage Plan:** |
   * Rate (requests per second) | Burst | | ---- | ---- | | 0.5 | 30 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The preceding table contains the default
   * rate and burst values for this operation. Selling partners whose business demands require
  ...
  public okhttp3.Call getOrderBuyerInfoAsync(
      String orderId, final ApiCallback<GetOrderBuyerInfoResponse> callback)
      throws ApiException, LWAException {
    ...
    okhttp3.Call call =
        getOrderBuyerInfoValidateBeforeCall(orderId, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetOrderBuyerInfoResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
  ...
  private okhttp3.Call getOrderItemsValidateBeforeCall(
    ...
    if (orderId == null) {
      throw new ApiException(
          "Missing the required parameter 'orderId' when calling getOrderItems(Async)");
    }

    okhttp3.Call call =
        getOrderItemsCall(orderId, nextToken, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Returns detailed order item information for the order that you specify. If
   * &#x60;NextToken&#x60; is provided, it&#x27;s used to retrieve the next page of order items.
   * __Note__: When an order is in the Pending state (the order has been placed but payment has not
   * been authorized), the getOrderItems operation does not return information about pricing, taxes,
   * shipping charges, gift status or promotions for the order items in the order. After an order
   * leaves the Pending state (this occurs when payment has been authorized) and enters the
   * Unshipped, Partially Shipped, or Shipped state, the getOrderItems operation returns information
   * about pricing, taxes, shipping charges, gift status and promotions for the order items in the
   * order. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 0.5 | 30 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The preceding table contains the default
   * rate and burst values for this operation. Selling partners whose business demands require
   * higher throughput may receive higher rate and burst values then those shown here. For more
   ...
   * @throws LWAException If calls to fetch LWA access token fails
   */
  public GetOrderItemsResponse getOrderItems(String orderId, String nextToken)
      throws ApiException, LWAException {
  ...
  /**
   * (asynchronously) Returns detailed order item information for the order that you specify. If
   * &#x60;NextToken&#x60; is provided, it&#x27;s used to retrieve the next page of order items.
   * __Note__: When an order is in the Pending state (the order has been placed but payment has not
   * been authorized), the getOrderItems operation does not return information about pricing, taxes,
   * shipping charges, gift status or promotions for the order items in the order. After an order
  ...
  public okhttp3.Call getOrderItemsAsync(
    ...
    okhttp3.Call call =
        getOrderItemsValidateBeforeCall(
            orderId, nextToken, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetOrderItemsResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
  ...
  private okhttp3.Call getOrderItemsBuyerInfoValidateBeforeCall(
    ...
    okhttp3.Call call =
        getOrderItemsBuyerInfoCall(orderId, nextToken, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Returns buyer information for the order items in the order that you specify. **Usage Plan:** |
   * Rate (requests per second) | Burst | | ---- | ---- | | 0.5 | 30 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The preceding table contains the default
   * rate and burst values for this operation. Selling partners whose business demands require
  ...
  public GetOrderItemsBuyerInfoResponse getOrderItemsBuyerInfo(String orderId, String nextToken)
    ...
    ApiResponse<GetOrderItemsBuyerInfoResponse> resp =
        getOrderItemsBuyerInfoWithHttpInfo(orderId, nextToken);
    return resp.getData();
  }
  ...
  /**
   * (asynchronously) Returns buyer information for the order items in the order that you specify.
  ...
  public okhttp3.Call getOrderItemsBuyerInfoAsync(
    ...
    okhttp3.Call call =
        getOrderItemsBuyerInfoValidateBeforeCall(
            orderId, nextToken, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetOrderItemsBuyerInfoResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  ...
  private okhttp3.Call getOrderRegulatedInfoValidateBeforeCall(
    ...
    okhttp3.Call call =
        getOrderRegulatedInfoCall(orderId, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Returns regulated information for the order that you specify. **Usage Plan:** | Rate (requests
   * per second) | Burst | | ---- | ---- | | 0.5 | 30 | The &#x60;x-amzn-RateLimit-Limit&#x60;
   * response header returns the usage plan rate limits that were applied to the requested
   * operation, when available. The preceding table contains the default rate and burst values for
   * this operation. Selling partners whose business demands require higher throughput may receive
  ...
  /**
   * (asynchronously) Returns regulated information for the order that you specify. **Usage Plan:**
   * | Rate (requests per second) | Burst | | ---- | ---- | | 0.5 | 30 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The preceding table contains the default
   * rate and burst values for this operation. Selling partners whose business demands require
  ...
  public okhttp3.Call getOrderRegulatedInfoAsync(
    ...
    okhttp3.Call call =
        getOrderRegulatedInfoValidateBeforeCall(orderId, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetOrderRegulatedInfoResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
   ...
   *
   * @param marketplaceIds A list of &#x60;MarketplaceId&#x60; values. Used to select orders that
   *     were placed in the specified marketplaces. Refer to [Marketplace
   *     IDs](https://developer-docs.amazon.com/sp-api/docs/marketplace-ids) for a complete list of
   *     &#x60;marketplaceId&#x60; values. (required)
   * @param createdAfter Use this date to select orders created after (or at) a specified time. Only
   ...
   *     &#x60;CreatedAfter&#x60; parameter or the &#x60;LastUpdatedAfter&#x60; parameter is
   *     required. Both cannot be empty. &#x60;LastUpdatedAfter&#x60; and
   *     &#x60;LastUpdatedBefore&#x60; cannot be set when &#x60;CreatedAfter&#x60; is set.
   *     (optional)
   * @param createdBefore Use this date to select orders created before (or at) a specified time.
   *     Only orders placed before the specified time are returned. The date must be in [ISO
   *     8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) format. **Note**:
   *     &#x60;CreatedBefore&#x60; is optional when &#x60;CreatedAfter&#x60; is set. If specified,
   *     &#x60;CreatedBefore&#x60; must be equal to or after the &#x60;CreatedAfter&#x60; date and
   *     at least two minutes before current time. (optional)
   * @param lastUpdatedAfter Use this date to select orders that were last updated after (or at) a
   *     specified time. An update is defined as any change in order status, including the creation
   *     of a new order. Includes updates made by Amazon and by the seller. The date must be in [ISO
   *     8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) format. **Note**: Either the
   *     &#x60;CreatedAfter&#x60; parameter or the &#x60;LastUpdatedAfter&#x60; parameter is
   *     required. Both cannot be empty. &#x60;CreatedAfter&#x60; or &#x60;CreatedBefore&#x60;
   *     cannot be set when &#x60;LastUpdatedAfter&#x60; is set. (optional)
   * @param lastUpdatedBefore Use this date to select orders that were last updated before (or at) a
   *     specified time. An update is defined as any change in order status, including the creation
   *     of a new order. Includes updates made by Amazon and by the seller. The date must be in [ISO
   *     8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) format. **Note**:
   *     &#x60;LastUpdatedBefore&#x60; is optional when &#x60;LastUpdatedAfter&#x60; is set. But if
   *     specified, &#x60;LastUpdatedBefore&#x60; must be equal to or after the
   *     &#x60;LastUpdatedAfter&#x60; date and at least two minutes before current time. (optional)
   * @param orderStatuses A list of &#x60;OrderStatus&#x60; values used to filter the results.
   *     **Possible values:** - &#x60;PendingAvailability&#x60; (This status is available for
   *     pre-orders only. The order has been placed, payment has not been authorized, and the
   *     release date of the item is in the future.) - &#x60;Pending&#x60; (The order has been
   *     placed but payment has not been authorized.) - &#x60;Unshipped&#x60; (Payment has been
   *     authorized and the order is ready for shipment, but no items in the order have been
   *     shipped.) - &#x60;PartiallyShipped&#x60; (One or more, but not all, items in the order have
   *     been shipped.) - &#x60;Shipped&#x60; (All items in the order have been shipped.) -
   *     &#x60;InvoiceUnconfirmed&#x60; (All items in the order have been shipped. The seller has
   *     not yet given confirmation to Amazon that the invoice has been shipped to the buyer.) -
   *     &#x60;Canceled&#x60; (The order has been canceled.) - &#x60;Unfulfillable&#x60; (The order
   *     cannot be fulfilled. This state applies only to Multi-Channel Fulfillment orders.)
   *     (optional)
   * @param fulfillmentChannels A list that indicates how an order was fulfilled. Filters the
   *     results by fulfillment channel. **Possible values**: &#x60;AFN&#x60; (fulfilled by Amazon),
   *     &#x60;MFN&#x60; (fulfilled by seller). (optional)
   * @param paymentMethods A list of payment method values. Use this field to select orders that
   *     were paid with the specified payment methods. **Possible values**: &#x60;COD&#x60; (cash on
   *     delivery), &#x60;CVS&#x60; (convenience store), &#x60;Other&#x60; (Any payment method other
   *     than COD or CVS). (optional)
   * @param buyerEmail The email address of a buyer. Used to select orders that contain the
   *     specified email address. (optional)
   * @param sellerOrderId An order identifier that is specified by the seller. Used to select only
   *     the orders that match the order identifier. If &#x60;SellerOrderId&#x60; is specified, then
   *     &#x60;FulfillmentChannels&#x60;, &#x60;OrderStatuses&#x60;, &#x60;PaymentMethod&#x60;,
   *     &#x60;LastUpdatedAfter&#x60;, LastUpdatedBefore, and &#x60;BuyerEmail&#x60; cannot be
   *     specified. (optional)
   * @param maxResultsPerPage A number that indicates the maximum number of orders that can be
   *     returned per page. Value must be 1 - 100. Default 100. (optional)
   * @param easyShipShipmentStatuses A list of &#x60;EasyShipShipmentStatus&#x60; values. Used to
   *     select Easy Ship orders with statuses that match the specified values. If
   *     &#x60;EasyShipShipmentStatus&#x60; is specified, only Amazon Easy Ship orders are returned.
   *     **Possible values:** - &#x60;PendingSchedule&#x60; (The package is awaiting the schedule
   *     for pick-up.) - &#x60;PendingPickUp&#x60; (Amazon has not yet picked up the package from
   *     the seller.) - &#x60;PendingDropOff&#x60; (The seller will deliver the package to the
   *     carrier.) - &#x60;LabelCanceled&#x60; (The seller canceled the pickup.) -
   ...
   *     &#x60;Delivered&#x60; (The package has been delivered.) - &#x60;RejectedByBuyer&#x60; (The
   *     package has been rejected by the buyer.) - &#x60;Undeliverable&#x60; (The package cannot be
   *     delivered.) - &#x60;ReturningToSeller&#x60; (The package was not delivered and is being
   *     returned to the seller.) - &#x60;ReturnedToSeller&#x60; (The package was not delivered and
   *     was returned to the seller.) - &#x60;Lost&#x60; (The package is lost.) -
   *     &#x60;OutForDelivery&#x60; (The package is out for delivery.) - &#x60;Damaged&#x60; (The
   *     package was damaged by the carrier.) (optional)
   * @param electronicInvoiceStatuses A list of &#x60;ElectronicInvoiceStatus&#x60; values. Used to
   *     select orders with electronic invoice statuses that match the specified values. **Possible
   *     values:** - &#x60;NotRequired&#x60; (Electronic invoice submission is not required for this
   *     order.) - &#x60;NotFound&#x60; (The electronic invoice was not submitted for this order.) -
   ...
   *     (optional)
   * @param nextToken A string token returned in the response of your previous request. (optional)
   * @param amazonOrderIds A list of &#x60;AmazonOrderId&#x60; values. An &#x60;AmazonOrderId&#x60;
   *     is an Amazon-defined order identifier, in 3-7-7 format. (optional)
   * @param actualFulfillmentSupplySourceId The &#x60;sourceId&#x60; of the location from where you
   *     want the order fulfilled. (optional)
   * @param isISPU When true, this order is marked to be picked up from a store rather than
   *     delivered. (optional)
   * @param storeChainStoreId The store chain store identifier. Linked to a specific store in a
   *     store chain. (optional)
   * @param earliestDeliveryDateBefore Use this date to select orders with a earliest delivery date
   ...
   * @param earliestDeliveryDateAfter Use this date to select orders with a earliest delivery date
   *     after (or at) a specified time. The date must be in [ISO
   *     8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) format. (optional)
   * @param latestDeliveryDateBefore Use this date to select orders with a latest delivery date
   *     before (or at) a specified time. The date must be in [ISO
   *     8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) format. (optional)
   * @param latestDeliveryDateAfter Use this date to select orders with a latest delivery date after
  ...
  public okhttp3.Call getOrdersCall(
    ...
    if (orderStatuses != null)
      localVarCollectionQueryParams.addAll(
          apiClient.parameterToPairs("csv", "OrderStatuses", orderStatuses));
    if (marketplaceIds != null)
      localVarCollectionQueryParams.addAll(
          apiClient.parameterToPairs("csv", "MarketplaceIds", marketplaceIds));
    if (fulfillmentChannels != null)
      localVarCollectionQueryParams.addAll(
          apiClient.parameterToPairs("csv", "FulfillmentChannels", fulfillmentChannels));
    if (paymentMethods != null)
      localVarCollectionQueryParams.addAll(
          apiClient.parameterToPairs("csv", "PaymentMethods", paymentMethods));
    if (buyerEmail != null)
    ...
    if (electronicInvoiceStatuses != null)
      localVarCollectionQueryParams.addAll(
          apiClient.parameterToPairs(
              "csv", "ElectronicInvoiceStatuses", electronicInvoiceStatuses));
    if (nextToken != null)
      localVarQueryParams.addAll(apiClient.parameterToPair("NextToken", nextToken));
    if (amazonOrderIds != null)
      localVarCollectionQueryParams.addAll(
          apiClient.parameterToPairs("csv", "AmazonOrderIds", amazonOrderIds));
    ...
    if (latestDeliveryDateBefore != null)
      localVarQueryParams.addAll(
          apiClient.parameterToPair("LatestDeliveryDateBefore", latestDeliveryDateBefore));
    if (latestDeliveryDateAfter != null)
      localVarQueryParams.addAll(
          apiClient.parameterToPair("LatestDeliveryDateAfter", latestDeliveryDateAfter));
  ...
  private okhttp3.Call getOrdersValidateBeforeCall(
    ...
    if (marketplaceIds == null) {
      throw new ApiException(
          "Missing the required parameter 'marketplaceIds' when calling getOrders(Async)");
    }
  ...
  /**
   * Returns orders that are created or updated during the specified time period. If you want to
   * return specific types of orders, you can apply filters to your request. &#x60;NextToken&#x60;
   * doesn&#x27;t affect any filters that you include in your request; it only impacts the
   * pagination for the filtered orders response. **Usage Plan:** | Rate (requests per second) |
   * Burst | | ---- | ---- | | 0.0167 | 20 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header
   * returns the usage plan rate limits that are applied to the requested operation, when available.
   * The preceding table contains the default rate and burst values for this operation. Selling
   * partners whose business demands require higher throughput may receive higher rate and burst
  ...
  public GetOrdersResponse getOrders(
      ...
      String latestDeliveryDateAfter)
      throws ApiException, LWAException {
    ApiResponse<GetOrdersResponse> resp =
  ...
  /**
   * (asynchronously) Returns orders that are created or updated during the specified time period.
   * If you want to return specific types of orders, you can apply filters to your request.
   * &#x60;NextToken&#x60; doesn&#x27;t affect any filters that you include in your request; it only
   * impacts the pagination for the filtered orders response. **Usage Plan:** | Rate (requests per
   * second) | Burst | | ---- | ---- | | 0.0167 | 20 | The &#x60;x-amzn-RateLimit-Limit&#x60;
   * response header returns the usage plan rate limits that are applied to the requested operation,
   * when available. The preceding table contains the default rate and burst values for this
   * operation. Selling partners whose business demands require higher throughput may receive higher
   * rate and burst values then those shown here. For more information, refer to [Usage Plans and
   * Rate
   * Limits](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api)
   * in the Selling Partner API documentation.
   *
  ...
  private okhttp3.Call updateVerificationStatusValidateBeforeCall(
    ...
    okhttp3.Call call =
        updateVerificationStatusCall(body, orderId, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Updates (approves or rejects) the verification status of an order containing regulated
   * products. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 0.5 | 30 |
   ...
   * require higher throughput may receive higher rate and burst values then those shown here. For
  ...
  public ApiResponse<Void> updateVerificationStatusWithHttpInfo(
      UpdateVerificationStatusRequest body, String orderId) throws ApiException, LWAException {
    okhttp3.Call call = updateVerificationStatusValidateBeforeCall(body, orderId, null, null);
    return apiClient.execute(call);
  }

  /**
   * (asynchronously) Updates (approves or rejects) the verification status of an order containing
   * regulated products. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | |
   ...
   * demands require higher throughput may receive higher rate and burst values then those shown
   * here. For more information, refer to [Usage Plans and Rate
   * Limits](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api).
   *
   * @param body The request body for the &#x60;updateVerificationStatus&#x60; operation. (required)
   * @param orderId An Amazon-defined order identifier, in 3-7-7 format. (required)
  ...
  public okhttp3.Call updateVerificationStatusAsync(
    ...
    okhttp3.Call call =
        updateVerificationStatusValidateBeforeCall(
