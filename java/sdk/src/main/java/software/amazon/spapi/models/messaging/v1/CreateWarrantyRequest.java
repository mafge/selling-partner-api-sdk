...
public class CreateWarrantyRequest {
  ...
  /**
   * Attachments to include in the message to the buyer. If any text is included in the attachment,
   * the text must be written in the buyer&#x27;s language of preference, which can be retrieved
  ...
  @Schema(
      description =
          "Attachments to include in the message to the buyer. If any text is included in the"
              + " attachment, the text must be written in the buyer's language of preference, which"
