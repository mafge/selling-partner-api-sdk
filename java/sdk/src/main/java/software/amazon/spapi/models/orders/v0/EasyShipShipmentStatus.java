...
/**
 * The status of the Amazon Easy Ship order. This property is only included for Amazon Easy Ship
 * orders.
 */
...
public enum EasyShipShipmentStatus {
  ...
  public static class Adapter extends TypeAdapter<EasyShipShipmentStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final EasyShipShipmentStatus enumeration)
        throws IOException {
