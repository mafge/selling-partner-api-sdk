...
public class TextItem {
  ...
  /**
   * The rank or index of this text item within the collection. Different items cannot occupy the
   * same position within a single collection. minimum: 1 maximum: 100
   *
   * @return position
   */
  @Schema(
      required = true,
      description =
          "The rank or index of this text item within the collection. Different items cannot occupy"
              + " the same position within a single collection.")
