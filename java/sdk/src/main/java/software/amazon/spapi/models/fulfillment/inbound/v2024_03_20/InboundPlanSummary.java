...
public class InboundPlanSummary {
  ...
  @Schema(
      required = true,
      description =
          "The current status of the inbound plan. Possible values: `ACTIVE`, `VOIDED`, `SHIPPED`,"
              + " `ERRORED`.")
  ...
  public int hashCode() {
    return Objects.hash(
        createdAt, inboundPlanId, lastUpdatedAt, marketplaceIds, name, sourceAddress, status);
  }
