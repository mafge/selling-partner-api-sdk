...
public class CreateDigitalAccessKeyRequest {
  ...
  /**
   * The text that is sent to the buyer. Only links that are related to the digital access key are
   * allowed. Do not include HTML or email addresses. The text must be written in the buyer&#x27;s
   * preferred language, which you can retrieve from the &#x60;GetAttributes&#x60; operation.
   *
   * @return text
   */
  @Schema(
      description =
          "The text that is sent to the buyer. Only links that are related to the digital access"
              + " key are allowed. Do not include HTML or email addresses. The text must be written"
              + " in the buyer's preferred language, which you can retrieve from the"
