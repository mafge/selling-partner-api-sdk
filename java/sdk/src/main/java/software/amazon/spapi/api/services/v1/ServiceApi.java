...
public class ServiceApi {
    ...
    private final Bucket addAppointmentForServiceJobByServiceJobIdBucket = Bucket.builder()
            .addLimit(config.getLimit("ServiceApi-addAppointmentForServiceJobByServiceJobId"))
            .build();

    private final Bucket assignAppointmentResourcesBucket = Bucket.builder()
            .addLimit(config.getLimit("ServiceApi-assignAppointmentResources"))
            .build();

    private final Bucket cancelReservationBucket = Bucket.builder()
            .addLimit(config.getLimit("ServiceApi-cancelReservation"))
            .build();

    private final Bucket cancelServiceJobByServiceJobIdBucket = Bucket.builder()
            .addLimit(config.getLimit("ServiceApi-cancelServiceJobByServiceJobId"))
            .build();

    private final Bucket completeServiceJobByServiceJobIdBucket = Bucket.builder()
            .addLimit(config.getLimit("ServiceApi-completeServiceJobByServiceJobId"))
            .build();

    private final Bucket createReservationBucket = Bucket.builder()
            .addLimit(config.getLimit("ServiceApi-createReservation"))
            .build();

    private final Bucket createServiceDocumentUploadDestinationBucket = Bucket.builder()
            .addLimit(config.getLimit("ServiceApi-createServiceDocumentUploadDestination"))
            .build();

    private final Bucket getAppointmentSlotsBucket = Bucket.builder()
            .addLimit(config.getLimit("ServiceApi-getAppointmentSlots"))
            .build();

    private final Bucket getAppointmmentSlotsByJobIdBucket = Bucket.builder()
            .addLimit(config.getLimit("ServiceApi-getAppointmmentSlotsByJobId"))
            .build();

    private final Bucket getFixedSlotCapacityBucket = Bucket.builder()
            .addLimit(config.getLimit("ServiceApi-getFixedSlotCapacity"))
            .build();

    private final Bucket getRangeSlotCapacityBucket = Bucket.builder()
            .addLimit(config.getLimit("ServiceApi-getRangeSlotCapacity"))
            .build();

    private final Bucket getServiceJobByServiceJobIdBucket = Bucket.builder()
            .addLimit(config.getLimit("ServiceApi-getServiceJobByServiceJobId"))
            .build();

    private final Bucket getServiceJobsBucket = Bucket.builder()
            .addLimit(config.getLimit("ServiceApi-getServiceJobs"))
            .build();

    private final Bucket rescheduleAppointmentForServiceJobByServiceJobIdBucket = Bucket.builder()
            .addLimit(config.getLimit("ServiceApi-rescheduleAppointmentForServiceJobByServiceJobId"))
            .build();

    private final Bucket setAppointmentFulfillmentDataBucket = Bucket.builder()
            .addLimit(config.getLimit("ServiceApi-setAppointmentFulfillmentData"))
            .build();

    private final Bucket updateReservationBucket = Bucket.builder()
            .addLimit(config.getLimit("ServiceApi-updateReservation"))
            .build();

    private final Bucket updateScheduleBucket = Bucket.builder()
    ...
    public ApiResponse<SetAppointmentResponse> addAppointmentForServiceJobByServiceJobIdWithHttpInfo(
        ...
        if (addAppointmentForServiceJobByServiceJobIdBucket.tryConsume(1)) {
    ...
    public ApiResponse<AssignAppointmentResourcesResponse> assignAppointmentResourcesWithHttpInfo(
        ...
        if (assignAppointmentResourcesBucket.tryConsume(1)) {
    ...
    public ApiResponse<CancelReservationResponse> cancelReservationWithHttpInfo(
        ...
        if (cancelReservationBucket.tryConsume(1)) {
    ...
    public ApiResponse<CancelServiceJobByServiceJobIdResponse> cancelServiceJobByServiceJobIdWithHttpInfo(
        ...
        if (cancelServiceJobByServiceJobIdBucket.tryConsume(1)) {
    ...
    public ApiResponse<CompleteServiceJobByServiceJobIdResponse> completeServiceJobByServiceJobIdWithHttpInfo(
        ...
        if (completeServiceJobByServiceJobIdBucket.tryConsume(1)) {
    ...
    public ApiResponse<CreateReservationResponse> createReservationWithHttpInfo(
        ...
        if (createReservationBucket.tryConsume(1)) {
    ...
    public ApiResponse<CreateServiceDocumentUploadDestination> createServiceDocumentUploadDestinationWithHttpInfo(
        ...
        if (createServiceDocumentUploadDestinationBucket.tryConsume(1)) {
    ...
    public ApiResponse<GetAppointmentSlotsResponse> getAppointmentSlotsWithHttpInfo(
        ...
        if (getAppointmentSlotsBucket.tryConsume(1)) {
    ...
    public ApiResponse<GetAppointmentSlotsResponse> getAppointmmentSlotsByJobIdWithHttpInfo(
        ...
        if (getAppointmmentSlotsByJobIdBucket.tryConsume(1)) {
            Type localVarReturnType = new TypeToken<GetAppointmentSlotsResponse>() {}.getType();
            return apiClient.execute(call, localVarReturnType);
    ...
    public ApiResponse<FixedSlotCapacity> getFixedSlotCapacityWithHttpInfo(
        ...
        if (getFixedSlotCapacityBucket.tryConsume(1)) {
    ...
    public ApiResponse<RangeSlotCapacity> getRangeSlotCapacityWithHttpInfo(
        ...
        if (getRangeSlotCapacityBucket.tryConsume(1)) {
    ...
    public ApiResponse<GetServiceJobByServiceJobIdResponse> getServiceJobByServiceJobIdWithHttpInfo(String serviceJobId)
        ...
        if (getServiceJobByServiceJobIdBucket.tryConsume(1)) {
    ...
    public ApiResponse<GetServiceJobsResponse> getServiceJobsWithHttpInfo(
        ...
        okhttp3.Call call = getServiceJobsValidateBeforeCall(
                ...
                null,
                null);
        if (getServiceJobsBucket.tryConsume(1)) {
    ...
    public ApiResponse<SetAppointmentResponse> rescheduleAppointmentForServiceJobByServiceJobIdWithHttpInfo(
        ...
        if (rescheduleAppointmentForServiceJobByServiceJobIdBucket.tryConsume(1)) {
            Type localVarReturnType = new TypeToken<SetAppointmentResponse>() {}.getType();
            return apiClient.execute(call, localVarReturnType);
        } else
            throw new ApiException.RateLimitExceeded(
    ...
    public ApiResponse<String> setAppointmentFulfillmentDataWithHttpInfo(
        ...
        if (setAppointmentFulfillmentDataBucket.tryConsume(1)) {
    ...
    public ApiResponse<UpdateReservationResponse> updateReservationWithHttpInfo(
        ...
        if (updateReservationBucket.tryConsume(1)) {
    ...
    public ApiResponse<UpdateScheduleResponse> updateScheduleWithHttpInfo(
        ...
        if (updateScheduleBucket.tryConsume(1)) {
