...
public class RegulatedOrderVerificationStatus {
  ...
  @Schema(
      required = true,
      description =
          "When true, the regulated information provided in the order requires a review by the"
              + " merchant.")
  ...
  public RegulatedOrderVerificationStatus validRejectionReasons(
      List<RejectionReason> validRejectionReasons) {
    this.validRejectionReasons = validRejectionReasons;
    return this;
  }

  public RegulatedOrderVerificationStatus addValidRejectionReasonsItem(
      RejectionReason validRejectionReasonsItem) {
    this.validRejectionReasons.add(validRejectionReasonsItem);
    return this;
  }

  /**
   * A list of valid rejection reasons that may be used to reject the order&#x27;s regulated
   * information.
   *
  ...
  /**
   * The date the order was reviewed. In [ISO
  ...
  /**
   * A list of valid verification details that may be provided and the criteria required for when
   * the verification detail can be provided.
   *
   * @return validVerificationDetails
   */
  @Schema(
      description =
          "A list of valid verification details that may be provided and the criteria required for"
              + " when the verification detail can be provided.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RegulatedOrderVerificationStatus regulatedOrderVerificationStatus =
        (RegulatedOrderVerificationStatus) o;
    return Objects.equals(this.status, regulatedOrderVerificationStatus.status)
        && Objects.equals(
            this.requiresMerchantAction, regulatedOrderVerificationStatus.requiresMerchantAction)
        && Objects.equals(
            this.validRejectionReasons, regulatedOrderVerificationStatus.validRejectionReasons)
        ...
        && Objects.equals(
            this.externalReviewerId, regulatedOrderVerificationStatus.externalReviewerId)
        && Objects.equals(
            this.validVerificationDetails,
            regulatedOrderVerificationStatus.validVerificationDetails);
  }
