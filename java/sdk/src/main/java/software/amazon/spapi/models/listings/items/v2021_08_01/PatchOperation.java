...
public class PatchOperation {
  /**
   * Type of JSON Patch operation. Supported JSON Patch operations include add, replace, and delete.
   * Refer to [JavaScript Object Notation (JSON) Patch](https://tools.ietf.org/html/rfc6902) for
   * more information.
   */
  ...
  @Schema(
      required = true,
      description =
          "Type of JSON Patch operation. Supported JSON Patch operations include add, replace, and"
              + " delete. Refer to [JavaScript Object Notation (JSON)"
