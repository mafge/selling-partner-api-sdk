...
@Schema(
    description =
        "A list of the items in this transportation and their associated inner container details."
            + " If any of the item detail fields are common at a carton or a pallet level, provide"
            + " them at the corresponding carton or pallet level.")
public class Containers {
  ...
  private List<ContainerIdentification> containerIdentifiers =
      new ArrayList<ContainerIdentification>();
  ...
  /**
   * An integer that must be submitted for multi-box shipments only, where one item may come in
   * separate packages.
   *
  ...
  @Schema(
      description =
          "An integer that must be submitted for multi-box shipments only, where one item may come"
