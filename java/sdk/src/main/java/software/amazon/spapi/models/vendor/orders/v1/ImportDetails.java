...
public class ImportDetails {
  /**
   * If the recipient requests, contains the shipment method of payment. This is for import
   * PO&#x27;s only.
   */
  ...
  public enum MethodOfPaymentEnum {
    ...
    public static class Adapter extends TypeAdapter<MethodOfPaymentEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final MethodOfPaymentEnum enumeration)
          throws IOException {
  ...
  /**
   * Incoterms (International Commercial Terms) are used to divide transaction costs and
   * responsibilities between buyer and seller and reflect state-of-the-art transportation
   * practices. This is for import purchase orders only.
   */
  ...
  public enum InternationalCommercialTermsEnum {
    ...
    public static class Adapter extends TypeAdapter<InternationalCommercialTermsEnum> {
      @Override
      public void write(
          final JsonWriter jsonWriter, final InternationalCommercialTermsEnum enumeration)
          throws IOException {
        jsonWriter.value(String.valueOf(enumeration.getValue()));
      }
  ...
  public ImportDetails internationalCommercialTerms(
      InternationalCommercialTermsEnum internationalCommercialTerms) {
  ...
  public void setInternationalCommercialTerms(
      InternationalCommercialTermsEnum internationalCommercialTerms) {
    this.internationalCommercialTerms = internationalCommercialTerms;
  }
  ...
  /**
   * The port where goods on an import purchase order must be delivered by the vendor. This should
  ...
  @Schema(
      description =
          "The port where goods on an import purchase order must be delivered by the vendor. This"
              + " should only be specified when the internationalCommercialTerms is FOB.")
  ...
  /**
   * Types and numbers of container(s) for import purchase orders. Can be a comma-separated list if
   * the shipment has multiple containers. HC signifies a high-capacity container. Free-text field,
   * limited to 64 characters. The format will be a comma-delimited list containing values of the
   * type: $NUMBER_OF_CONTAINERS_OF_THIS_TYPE-$CONTAINER_TYPE. The list of values for the container
   * type is: 40&#x27;(40-foot container), 40&#x27;HC (40-foot high-capacity container), 45&#x27;,
   * 45&#x27;HC, 30&#x27;, 30&#x27;HC, 20&#x27;, 20&#x27;HC.
   *
   * @return importContainers
   */
  @Schema(
      description =
          "Types and numbers of container(s) for import purchase orders. Can be a comma-separated"
              + " list if the shipment has multiple containers. HC signifies a high-capacity"
              + " container. Free-text field, limited to 64 characters. The format will be a"
              + " comma-delimited list containing values of the type:"
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.methodOfPayment, importDetails.methodOfPayment)
        && Objects.equals(
            this.internationalCommercialTerms, importDetails.internationalCommercialTerms)
