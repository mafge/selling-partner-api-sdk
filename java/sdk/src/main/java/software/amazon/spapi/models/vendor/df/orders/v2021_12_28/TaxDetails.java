...
/**
 * The tax details for the order. _Note:_ Amazon calculates tax on the list price (Amazon retail
 * price).
 */
@Schema(
    description =
        "The tax details for the order. _Note:_ Amazon calculates tax on the list price (Amazon"
            + " retail price).")
