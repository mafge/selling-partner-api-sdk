...
/**
 * The number of Amazon Points that are offered with the purchase of an item and the monetary value
 * of these points.
 */
@Schema(
    description =
        "The number of Amazon Points that are offered with the purchase of an item and the monetary"
