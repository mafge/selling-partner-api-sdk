...
public class ServiceJob {
  ...
  public enum ServiceJobStatusEnum {
    ...
    public static class Adapter extends TypeAdapter<ServiceJobStatusEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ServiceJobStatusEnum enumeration)
          throws IOException {
  ...
  public ServiceJob addPreferredAppointmentTimesItem(
      AppointmentTime preferredAppointmentTimesItem) {
  ...
  /**
   * A list of appointment windows preferred by the buyer. Included only if the buyer selected
   * appointment windows when creating the order.
   *
