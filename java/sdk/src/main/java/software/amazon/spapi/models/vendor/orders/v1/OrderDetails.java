...
public class OrderDetails {
  ...
  public enum PurchaseOrderTypeEnum {
    ...
    public static class Adapter extends TypeAdapter<PurchaseOrderTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final PurchaseOrderTypeEnum enumeration)
          throws IOException {
  ...
  /**
   * The date when purchase order was last changed by Amazon after the order was placed. This date
   * will be greater than &#x27;purchaseOrderDate&#x27;. This means the PO data was changed on that
   * date and vendors are required to fulfill the updated PO. The PO changes can be related to Item
   * Quantity, Ship to Location, Ship Window etc. This field will not be present in orders that have
   * not changed after creation. Must be in ISO-8601 date/time format.
   *
   * @return purchaseOrderChangedDate
   */
  @Schema(
      description =
          "The date when purchase order was last changed by Amazon after the order was placed. This"
              + " date will be greater than 'purchaseOrderDate'. This means the PO data was changed"
              + " on that date and vendors are required to fulfill the  updated PO. The PO changes"
              + " can be related to Item Quantity, Ship to Location, Ship Window etc. This field"
              + " will not be present in orders that have not changed after creation. Must be in"
  ...
  /**
   * The date when current purchase order state was changed. Current purchase order state is
  ...
  @Schema(
      ...
      description =
          "The date when current purchase order state was changed. Current purchase order state is"
              + " available in the field 'purchaseOrderState'. Must be in ISO-8601 date/time"
              + " format.")
  ...
  /**
   * If requested by the recipient, this field will contain a promotional/deal number. The discount
   * code line is optional. It is used to obtain a price discount on items on the order.
   *
   * @return dealCode
   */
  @Schema(
      description =
          "If requested by the recipient, this field will contain a promotional/deal number. The"
              + " discount code line is optional. It is used to obtain a price discount on items on"
              + " the order.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.purchaseOrderDate, orderDetails.purchaseOrderDate)
        ...
        && Objects.equals(
            this.purchaseOrderStateChangedDate, orderDetails.purchaseOrderStateChangedDate)
