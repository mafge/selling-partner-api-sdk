...
public class Reservation {
  ...
  /**
   * Unique identifier for a reservation. If present, it is treated as an update reservation request
   * and will update the corresponding reservation. Otherwise, it is treated as a new create
   * reservation request.
   *
  ...
  @Schema(
      description =
          "Unique identifier for a reservation. If present, it is treated as an update reservation"
              + " request and will update the corresponding reservation. Otherwise, it is treated"
              + " as a new create reservation request.")
