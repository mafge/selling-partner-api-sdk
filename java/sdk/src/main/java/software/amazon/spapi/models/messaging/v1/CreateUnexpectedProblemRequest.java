...
public class CreateUnexpectedProblemRequest {
  ...
  /**
   * The text to be sent to the buyer. Only links related to unexpected problem calls are allowed.
   * Do not include HTML or email addresses. The text must be written in the buyer&#x27;s language
   * of preference, which can be retrieved from the GetAttributes operation.
   *
   * @return text
   */
  @Schema(
      description =
          "The text to be sent to the buyer. Only links related to unexpected problem calls are"
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreateUnexpectedProblemRequest createUnexpectedProblemRequest =
        (CreateUnexpectedProblemRequest) o;
