...
public class ItemSummaryByMarketplace {
  ...
  /**
   * When &#x60;true&#x60;, the Amazon catalog item is intended for an adult audience or is sexual
   * in nature.
   *
   * @return adultProduct
   */
  @Schema(
      description =
          "When `true`, the Amazon catalog item is intended for an adult audience or is sexual in"
              + " nature.")
  ...
  public ItemSummaryByMarketplace browseClassification(
  ...
  @Schema(
      description =
          "The identifier of the website display group that is associated with the Amazon catalog"
              + " item.")
  ...
  @Schema(
      description =
          "The display name of the website display group that is associated with the Amazon catalog"
              + " item.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.marketplaceId, itemSummaryByMarketplace.marketplaceId)
        ...
        && Objects.equals(
            this.websiteDisplayGroupName, itemSummaryByMarketplace.websiteDisplayGroupName);
  }
