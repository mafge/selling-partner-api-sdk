...
public class DefaultApi {
   ...
   *
   * @param maxResultsPerPage The maximum number of results to return per page. If the response
   *     exceeds the maximum number of transactions or 10 MB, the API responds with
   *     &#x27;InvalidInput&#x27;. (optional, default to 10)
   * @param financialEventGroupStartedBefore A date used for selecting financial event groups that
   ...
   *     later than FinancialEventGroupStartedAfter and no later than two minutes before the request
   *     was submitted. If FinancialEventGroupStartedAfter and FinancialEventGroupStartedBefore are
   *     more than 180 days apart, no financial event groups are returned. (optional)
   * @param financialEventGroupStartedAfter A date used for selecting financial event groups that
   *     opened after (or at) a specified date and time, in [ISO
   *     8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) format. The date-time must be
   *     no later than two minutes before the request was submitted. (optional)
  ...
  /**
   * Returns financial event groups for a given date range. It may take up to 48 hours for orders to
   * appear in your financial events. **Usage Plan:** | Rate (requests per second) | Burst | | ----
   * | ---- | | 0.5 | 30 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage
  ...
  public ListFinancialEventGroupsResponse listFinancialEventGroups(
      ...
      String nextToken)
      throws ApiException, LWAException {
    ApiResponse<ListFinancialEventGroupsResponse> resp =
  ...
  public ApiResponse<ListFinancialEventGroupsResponse> listFinancialEventGroupsWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        listFinancialEventGroupsValidateBeforeCall(
            maxResultsPerPage,
            financialEventGroupStartedBefore,
            financialEventGroupStartedAfter,
            nextToken,
  ...
  /**
   * (asynchronously) Returns financial event groups for a given date range. It may take up to 48
   * hours for orders to appear in your financial events. **Usage Plan:** | Rate (requests per
   ...
   * @param maxResultsPerPage The maximum number of results to return per page. If the response
   *     exceeds the maximum number of transactions or 10 MB, the API responds with
   *     &#x27;InvalidInput&#x27;. (optional, default to 100)
   * @param postedAfter A date used for selecting financial events posted after (or at) a specified
   *     time. The date-time must be no later than two minutes before the request was submitted, in
   *     [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date time format.
   *     (optional)
   * @param postedBefore A date used for selecting financial events posted before (but not at) a
   *     specified time. The date-time must be later than PostedAfter and no later than two minutes
   *     before the request was submitted, in [ISO
   *     8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date time format. If
  ...
  /**
   * Returns financial events for the specified data range. It may take up to 48 hours for orders to
   * appear in your financial events. **Note:** in &#x60;ListFinancialEvents&#x60;, deferred events
   * don&#x27;t show up in responses until in they are released. **Usage Plan:** | Rate (requests
  ...
  public ApiResponse<ListFinancialEventsResponse> listFinancialEventsWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        listFinancialEventsValidateBeforeCall(
  ...
  /**
   * (asynchronously) Returns financial events for the specified data range. It may take up to 48
   * hours for orders to appear in your financial events. **Note:** in
   * &#x60;ListFinancialEvents&#x60;, deferred events don&#x27;t show up in responses until in they
   * are released. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 0.5 | 30
   ...
   *     &#x27;InvalidInput&#x27;. (optional, default to 100)
   * @param postedAfter A date used for selecting financial events posted after (or at) a specified
   *     time. The date-time **must** be more than two minutes before the time of the request, in
   *     [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date time format.
   *     (optional)
   * @param postedBefore A date used for selecting financial events posted before (but not at) a
   *     specified time. The date-time must be later than &#x60;PostedAfter&#x60; and no later than
   *     two minutes before the request was submitted, in [ISO
   *     8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date time format. If
   *     &#x60;PostedAfter&#x60; and &#x60;PostedBefore&#x60; are more than 180 days apart, no
   *     financial events are returned. You must specify the &#x60;PostedAfter&#x60; parameter if
   *     you specify the &#x60;PostedBefore&#x60; parameter. Default: Now minus two minutes.
   *     (optional)
   * @param nextToken A string token returned in the response of your previous request. (optional)
   * @param progressListener Progress listener
   * @param progressRequestListener Progress request listener
  ...
  public okhttp3.Call listFinancialEventsByGroupIdCall(
    ...
    String localVarPath =
        "/finances/v0/financialEventGroups/{eventGroupId}/financialEvents"
            .replaceAll(
                "\\{" + "eventGroupId" + "\\}", apiClient.escapeString(eventGroupId.toString()));
  ...
  private okhttp3.Call listFinancialEventsByGroupIdValidateBeforeCall(
    ...
    if (eventGroupId == null) {
      throw new ApiException(
          "Missing the required parameter 'eventGroupId' when calling"
              + " listFinancialEventsByGroupId(Async)");
    }
  ...
  /**
   * Returns all financial events for the specified financial event group. It may take up to 48
   * hours for orders to appear in your financial events. **Note:** This operation will only
   * retrieve group&#x27;s data for the past two years. If a request is submitted for data spanning
   * more than two years, an empty response is returned. **Usage Plan:** | Rate (requests per
   * second) | Burst | | ---- | ---- | | 0.5 | 30 | The &#x60;x-amzn-RateLimit-Limit&#x60; response
   * header returns the usage plan rate limits that were applied to the requested operation, when
   * available. The table above indicates the default rate and burst values for this operation.
   * Selling partners whose business demands require higher throughput may see higher rate and burst
  ...
  public ApiResponse<ListFinancialEventsResponse> listFinancialEventsByGroupIdWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        listFinancialEventsByGroupIdValidateBeforeCall(
  ...
  /**
   * (asynchronously) Returns all financial events for the specified financial event group. It may
   * take up to 48 hours for orders to appear in your financial events. **Note:** This operation
   * will only retrieve group&#x27;s data for the past two years. If a request is submitted for data
   * spanning more than two years, an empty response is returned. **Usage Plan:** | Rate (requests
   * per second) | Burst | | ---- | ---- | | 0.5 | 30 | The &#x60;x-amzn-RateLimit-Limit&#x60;
   * response header returns the usage plan rate limits that were applied to the requested
   * operation, when available. The table above indicates the default rate and burst values for this
   * operation. Selling partners whose business demands require higher throughput may see higher
    ...
    if (orderId == null) {
      throw new ApiException(
          "Missing the required parameter 'orderId' when calling"
              + " listFinancialEventsByOrderId(Async)");
    }
  ...
  /**
   * Returns all financial events for the specified order. It may take up to 48 hours for orders to
   * appear in your financial events. **Usage Plan:** | Rate (requests per second) | Burst | | ----
   * | ---- | | 0.5 | 30 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage
   * plan rate limits that were applied to the requested operation, when available. The table above
   * indicates the default rate and burst values for this operation. Selling partners whose business
  ...
  public ListFinancialEventsResponse listFinancialEventsByOrderId(
      String orderId, Integer maxResultsPerPage, String nextToken)
      throws ApiException, LWAException {
    ApiResponse<ListFinancialEventsResponse> resp =
  ...
  public ApiResponse<ListFinancialEventsResponse> listFinancialEventsByOrderIdWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        listFinancialEventsByOrderIdValidateBeforeCall(
            orderId, maxResultsPerPage, nextToken, null, null);
    Type localVarReturnType = new TypeToken<ListFinancialEventsResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Returns all financial events for the specified order. It may take up to 48
   * hours for orders to appear in your financial events. **Usage Plan:** | Rate (requests per
   * second) | Burst | | ---- | ---- | | 0.5 | 30 | The &#x60;x-amzn-RateLimit-Limit&#x60; response
   * header returns the usage plan rate limits that were applied to the requested operation, when
   * available. The table above indicates the default rate and burst values for this operation.
