...
public class Decorator {
  ...
  /**
   * The starting value of this decorator within the content string. Use zero (&#x60;0&#x60;) for
   * the first value. minimum: 0 maximum: 10000
   *
   * @return offset
   */
  @Schema(
      description =
          "The starting value of this decorator within the content string. Use zero (`0`) for the"
              + " first value.")
  ...
  /**
   * The number of content characters to alter with this decorator. Decorators, such as line breaks,
   * can have zero length and fit between characters. minimum: 0 maximum: 10000
   *
   * @return length
   */
  @Schema(
      description =
          "The number of content characters to alter with this decorator. Decorators, such as line"
  ...
  /**
   * The relative intensity or variation of this decorator. Decorators, such as bullet-points, can
   * have multiple indentation depths. minimum: 0 maximum: 100
   *
   * @return depth
   */
  @Schema(
      description =
          "The relative intensity or variation of this decorator. Decorators, such as"
              + " bullet-points, can have multiple indentation depths.")
