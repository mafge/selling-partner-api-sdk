...
public class ExportInfo {
   ...
   * item.\\n\\n**Possible values**: &#x60;AMAZON_FACILITATED&#x60;: Import/export charge is
   * withheld by Amazon and remitted to the customs authority by the carrier on behalf of the
   * buyer/seller.
   *
  ...
  @Schema(
      description =
          "Holds the `ExportCharge` collection model that is associated with the specified order"
              + " item.\\n"
              + "\\n"
              + "**Possible values**: `AMAZON_FACILITATED`: Import/export charge is withheld by"
              + " Amazon and remitted to the customs authority by the carrier on behalf of the"
              + " buyer/seller.")
