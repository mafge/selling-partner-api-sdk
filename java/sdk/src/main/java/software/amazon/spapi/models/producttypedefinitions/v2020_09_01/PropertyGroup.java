...
/**
 * A property group represents a logical grouping of schema properties that can be used for display
 * or informational purposes.
 */
@Schema(
    description =
        "A property group represents a logical grouping of schema properties that can be used for"
            + " display or informational purposes.")
