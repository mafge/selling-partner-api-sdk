...
public class ShippingServiceOptions {
  ...
  /**
   * When true, the carrier will pick up the package. Note: Scheduled carrier pickup is available
   * only using Dynamex (US), DPD (UK), and Royal Mail (UK).
   *
  ...
  public ShippingServiceOptions carrierWillPickUpOption(
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.deliveryExperience, shippingServiceOptions.deliveryExperience)
        ...
        && Objects.equals(
            this.carrierWillPickUpOption, shippingServiceOptions.carrierWillPickUpOption)
  ...
  public int hashCode() {
    return Objects.hash(
        deliveryExperience, declaredValue, carrierWillPickUp, carrierWillPickUpOption, labelFormat);
  }
