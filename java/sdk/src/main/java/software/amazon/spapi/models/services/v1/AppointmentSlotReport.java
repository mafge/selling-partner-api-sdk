...
public class AppointmentSlotReport {
  ...
  public enum SchedulingTypeEnum {
    ...
    public static class Adapter extends TypeAdapter<SchedulingTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final SchedulingTypeEnum enumeration)
          throws IOException {
  ...
  @Schema(
      description =
          "A list of time windows along with associated capacity in which the service can be"
              + " performed.")
