...
public class AcknowledgementStatusDetails {
  ...
  @Schema(
      description =
          "The date when the line item was confirmed by vendor. Must be in ISO-8601 date/time"
              + " format.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(
            this.acknowledgementDate, acknowledgementStatusDetails.acknowledgementDate)
