...
/**
 * Information about the seller&#x27;s inbound shipments. Returned by the listInboundShipments
 * operation.
 */
@Schema(
    description =
...
public class InboundShipmentInfo {
  ...
  /**
   * Indicates whether or not an inbound shipment contains case-packed boxes. When AreCasesRequired
   * &#x3D; true for an inbound shipment, all items in the inbound shipment must be case packed.
   *
  ...
  public InboundShipmentInfo estimatedBoxContentsFee(
