...
/**
 * The A+ Content ASIN with additional metadata for content management. If you don&#x27;t include
 * the &#x60;includedDataSet&#x60; parameter in a call to the
 * &#x60;listContentDocumentAsinRelations&#x60; operation, the related ASINs are returned without
 * metadata.
 */
@Schema(
    description =
        "The A+ Content ASIN with additional metadata for content management. If you don't include"
            + " the `includedDataSet` parameter in a call to the `listContentDocumentAsinRelations`"
            + " operation, the related ASINs are returned without metadata.")
