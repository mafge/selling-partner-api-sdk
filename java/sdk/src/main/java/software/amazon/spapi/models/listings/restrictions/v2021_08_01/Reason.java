...
/**
 * A reason for the restriction, including path forward links that may allow Selling Partners to
 * remove the restriction, if available.
 */
@Schema(
    description =
        "A reason for the restriction, including path forward links that may allow Selling Partners"
            + " to remove the restriction, if available.")
public class Reason {
  ...
  public enum ReasonCodeEnum {
    ...
    public static class Adapter extends TypeAdapter<ReasonCodeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ReasonCodeEnum enumeration)
          throws IOException {
