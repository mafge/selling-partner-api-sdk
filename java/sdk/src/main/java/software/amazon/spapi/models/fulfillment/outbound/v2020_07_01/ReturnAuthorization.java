...
public class ReturnAuthorization {
  ...
  /**
   * An identifier for the return authorization. This identifier associates return items with the
  ...
  @Schema(
      required = true,
      description =
          "An identifier for the return authorization. This identifier associates return items with"
              + " the return authorization used to return them.")
   ...
   * does not include pre-paid shipping.
   *
   * @return rmaPageURL
   */
  @Schema(
      required = true,
      description =
          "A URL for a web page that contains the return authorization barcode and the mailing"
              + " label. This does not include pre-paid shipping.")
  ...
  public int hashCode() {
    return Objects.hash(
        returnAuthorizationId, fulfillmentCenterId, returnToAddress, amazonRmaId, rmaPageURL);
  }
