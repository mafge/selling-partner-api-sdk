...
@Schema(
    description =
        "Document that captured during service appointment fulfillment that portrays proof of"
            + " completion")
public class FulfillmentDocument {
  ...
  /**
   * Sha256 hash of the file content. This value is used to determine if the file has been corrupted
  ...
  @Schema(
      description =
          "Sha256 hash of the file content. This value is used to determine if the file has been"
