...
public class PurchaseOrders {
  ...
  /**
   * Purchase order numbers involved in this shipment, list all the PO that are involved as part of
   * this shipment.
   *
  ...
  @Schema(
      description =
          "Purchase order numbers involved in this shipment, list all the PO that are involved as"
  ...
  /**
   * A list of the items that are associated to the PO in this transport and their associated
   * details.
   *
   * @return items
   */
