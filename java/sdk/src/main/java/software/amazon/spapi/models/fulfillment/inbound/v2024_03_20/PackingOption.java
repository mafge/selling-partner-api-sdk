...
/**
 * A packing option contains a set of pack groups plus additional information about the packing
 * option, such as any discounts or fees if it&#x27;s selected.
 */
@Schema(
    description =
        "A packing option contains a set of pack groups plus additional information about the"
            + " packing option, such as any discounts or fees if it's selected.")
public class PackingOption {
  ...
  private List<PackingConfiguration> supportedConfigurations =
      new ArrayList<PackingConfiguration>();

  @SerializedName("supportedShippingConfigurations")
  private List<ShippingConfiguration> supportedShippingConfigurations =
      new ArrayList<ShippingConfiguration>();
  ...
  public PackingOption addSupportedConfigurationsItem(
      PackingConfiguration supportedConfigurationsItem) {
  ...
  public PackingOption supportedShippingConfigurations(
      List<ShippingConfiguration> supportedShippingConfigurations) {
  ...
  public void setSupportedShippingConfigurations(
      List<ShippingConfiguration> supportedShippingConfigurations) {
    this.supportedShippingConfigurations = supportedShippingConfigurations;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.discounts, packingOption.discounts)
        ...
        && Objects.equals(
            this.supportedShippingConfigurations, packingOption.supportedShippingConfigurations);
  }
