...
public class VendorPaymentsApi {
   ...
   */
  public okhttp3.Call submitInvoicesCall(
      SubmitInvoicesRequest body,
  ...
  private okhttp3.Call submitInvoicesValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling submitInvoices(Async)");
    }

    okhttp3.Call call = submitInvoicesCall(body, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Submit new invoices to Amazon. **Usage Plan:** | Rate (requests per second) | Burst | | ---- |
   * ---- | | 10 | 10 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage
  ...
  public ApiResponse<SubmitInvoicesResponse> submitInvoicesWithHttpInfo(SubmitInvoicesRequest body)
      throws ApiException, LWAException {
    okhttp3.Call call = submitInvoicesValidateBeforeCall(body, null, null);
    Type localVarReturnType = new TypeToken<SubmitInvoicesResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Submit new invoices to Amazon. **Usage Plan:** | Rate (requests per second) |
  ...
  public okhttp3.Call submitInvoicesAsync(
    ...
    okhttp3.Call call =
        submitInvoicesValidateBeforeCall(body, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<SubmitInvoicesResponse>() {}.getType();
