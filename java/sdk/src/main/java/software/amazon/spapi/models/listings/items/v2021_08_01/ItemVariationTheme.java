...
/**
 * A variation theme that indicates the combination of listing item attributes that define the
 * variation family.
 */
@Schema(
    description =
        "A variation theme that indicates the combination of listing item attributes that define"
...
public class ItemVariationTheme {
  ...
  /**
   * The variation theme that indicates the combination of listing item attributes that define the
   * variation family.
   *
   * @return theme
   */
  @Schema(
      ...
      required = true,
      description =
          "The variation theme that indicates the combination of listing item attributes that"
