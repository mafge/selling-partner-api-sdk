...
/**
 * Expiry refers to the collection of dates required for certain items. These could be either
 * expiryDate or mfgDate and expiryAfterDuration. These are mandatory for perishable items.
 */
@Schema(
    description =
        "Expiry refers to the collection of dates required  for certain items. These could be"
            + " either expiryDate or mfgDate and expiryAfterDuration. These are mandatory for"
            + " perishable items.")
public class Expiry {
  ...
  /**
   * Production, packaging or assembly date determined by the manufacturer. Its meaning is
  ...
  /**
   * The date that determines the limit of consumption or use of a product. Its meaning is
   * determined based on the trade item context.
   *
   * @return expiryDate
   */
