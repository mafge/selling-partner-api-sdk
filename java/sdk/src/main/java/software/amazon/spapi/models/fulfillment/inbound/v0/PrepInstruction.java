...
/**
 * Preparation instructions for shipping an item to Amazon&#x27;s fulfillment network. For more
 * information about preparing items for shipment to Amazon&#x27;s fulfillment network, see the
...
public enum PrepInstruction {
  ...
  public static class Adapter extends TypeAdapter<PrepInstruction> {
    @Override
    public void write(final JsonWriter jsonWriter, final PrepInstruction enumeration)
        throws IOException {
