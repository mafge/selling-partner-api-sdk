...
public class SubmitInvoiceRequest {
  ...
  /**
   * MD5 sum for validating the invoice data. For more information about calculating this value, see
   * [Working with Content-MD5
  ...
  @Schema(
      required = true,
      description =
          "MD5 sum for validating the invoice data. For more information about calculating this"
