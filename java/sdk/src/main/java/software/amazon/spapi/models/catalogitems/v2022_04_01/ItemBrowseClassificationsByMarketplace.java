...
/**
 * Classifications (browse nodes) that are associated with the item in the Amazon catalog for the
 * indicated &#x60;marketplaceId&#x60;.
 */
@Schema(
    description =
        "Classifications (browse nodes) that are associated with the item in the Amazon catalog for"
            + " the indicated `marketplaceId`.")
public class ItemBrowseClassificationsByMarketplace {
  ...
  public ItemBrowseClassificationsByMarketplace classifications(
      List<ItemBrowseClassification> classifications) {
    this.classifications = classifications;
    return this;
  }

  public ItemBrowseClassificationsByMarketplace addClassificationsItem(
      ItemBrowseClassification classificationsItem) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.marketplaceId, itemBrowseClassificationsByMarketplace.marketplaceId)
        && Objects.equals(
            this.classifications, itemBrowseClassificationsByMarketplace.classifications);
  }
