...
/**
 * &#x60;UpdateScheduleRecord&#x60; entity contains the &#x60;AvailabilityRecord&#x60; if there is
 * an error/warning while performing the requested operation on it.
 */
@Schema(
    description =
        "`UpdateScheduleRecord` entity contains the `AvailabilityRecord` if there is an"
            + " error/warning while performing the requested operation on it.")
