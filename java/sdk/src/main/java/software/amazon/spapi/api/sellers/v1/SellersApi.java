...
public class SellersApi {
  ...
  /**
   * Returns information about a seller account and its marketplaces. **Usage Plan:** | Rate
   * (requests per second) | Burst | | ---- | ---- | | 0.016 | 15 | The
  ...
  /**
   * (asynchronously) Returns information about a seller account and its marketplaces. **Usage
   * Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 0.016 | 15 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The preceding table indicates the default
   * rate and burst values for this operation. Selling partners whose business demands require
   * higher throughput may have higher rate and burst values than those shown here. For more
  ...
  /**
   * Returns a list of marketplaces where the seller can list items and information about the
   * seller&#x27;s participation in those marketplaces. **Usage Plan:** | Rate (requests per second)
   * | Burst | | ---- | ---- | | 0.016 | 15 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header
   ...
   * @throws LWAException If calls to fetch LWA access token fails
   */
  public ApiResponse<GetMarketplaceParticipationsResponse>
      getMarketplaceParticipationsWithHttpInfo() throws ApiException, LWAException {
  ...
  /**
   * (asynchronously) Returns a list of marketplaces where the seller can list items and information
   * about the seller&#x27;s participation in those marketplaces. **Usage Plan:** | Rate (requests
   * per second) | Burst | | ---- | ---- | | 0.016 | 15 | The &#x60;x-amzn-RateLimit-Limit&#x60;
  ...
  public okhttp3.Call getMarketplaceParticipationsAsync(
      final ApiCallback<GetMarketplaceParticipationsResponse> callback)
      throws ApiException, LWAException {
    ...
    okhttp3.Call call =
        getMarketplaceParticipationsValidateBeforeCall(progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetMarketplaceParticipationsResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
