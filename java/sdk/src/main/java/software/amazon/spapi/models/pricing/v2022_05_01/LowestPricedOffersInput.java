...
public class LowestPricedOffersInput {
   ...
   * This applies to &#x60;Consumer&#x60; and &#x60;Business&#x60; offers. &#x60;Consumer&#x60; is
  ...
  public enum OfferTypeEnum {
    ...
    public static class Adapter extends TypeAdapter<OfferTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final OfferTypeEnum enumeration)
          throws IOException {
  ...
  @Schema(
      ...
      description =
          "The input parameter specifies the type of offers requested for `LowestPricedOffers`."
              + " This applies to `Consumer` and `Business` offers. `Consumer` is the default"
              + " `offerType`.")
