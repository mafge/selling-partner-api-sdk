...
public class ShipmentInvoiceApi {
  ...
  private okhttp3.Call getInvoiceStatusValidateBeforeCall(
    ...
    if (shipmentId == null) {
      throw new ApiException(
          "Missing the required parameter 'shipmentId' when calling getInvoiceStatus(Async)");
    }
  ...
  /**
   * Returns the invoice status for the shipment you specify. **Usage Plan:** | Rate (requests per
   * second) | Burst | | ---- | ---- | | 1.133 | 25 | The &#x60;x-amzn-RateLimit-Limit&#x60;
  ...
  /**
   * (asynchronously) Returns the invoice status for the shipment you specify. **Usage Plan:** |
   * Rate (requests per second) | Burst | | ---- | ---- | | 1.133 | 25 | The
  ...
  public okhttp3.Call getInvoiceStatusAsync(
      String shipmentId, final ApiCallback<GetInvoiceStatusResponse> callback)
      throws ApiException, LWAException {
    ...
    okhttp3.Call call =
        getInvoiceStatusValidateBeforeCall(shipmentId, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetInvoiceStatusResponse>() {}.getType();
   ...
   *     FBAOutboundShipmentStatus notification. For information about subscribing to notifications,
   *     see the [Notifications API Use Case Guide](doc:notifications-api-v1-use-case-guide).
   *     (required)
   * @param progressListener Progress listener
   * @param progressRequestListener Progress request listener
   * @return Call to execute
  ...
  private okhttp3.Call getShipmentDetailsValidateBeforeCall(
    ...
    okhttp3.Call call =
        getShipmentDetailsCall(shipmentId, progressListener, progressRequestListener);
    return call;
  }
  ...
  /**
   * (asynchronously) Returns the shipment details required to issue an invoice for the specified
   * shipment. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 1.133 | 25 |
  ...
  public okhttp3.Call getShipmentDetailsAsync(
    ...
    okhttp3.Call call =
        getShipmentDetailsValidateBeforeCall(shipmentId, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetShipmentDetailsResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
  ...
  private okhttp3.Call submitInvoiceValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling submitInvoice(Async)");
    }
    // verify the required parameter 'shipmentId' is set
    if (shipmentId == null) {
      throw new ApiException(
          "Missing the required parameter 'shipmentId' when calling submitInvoice(Async)");
    }

    okhttp3.Call call =
        submitInvoiceCall(body, shipmentId, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Submits a shipment invoice document for a given shipment. **Usage Plan:** | Rate (requests per
   * second) | Burst | | ---- | ---- | | 1.133 | 25 | The &#x60;x-amzn-RateLimit-Limit&#x60;
   * response header returns the usage plan rate limits that were applied to the requested
   * operation, when available. The table above indicates the default rate and burst values for this
   * operation. Selling partners whose business demands require higher throughput may see higher
  ...
  public ApiResponse<SubmitInvoiceResponse> submitInvoiceWithHttpInfo(
      SubmitInvoiceRequest body, String shipmentId) throws ApiException, LWAException {
  ...
  /**
   * (asynchronously) Submits a shipment invoice document for a given shipment. **Usage Plan:** |
   * Rate (requests per second) | Burst | | ---- | ---- | | 1.133 | 25 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The table above indicates the default rate
   * and burst values for this operation. Selling partners whose business demands require higher
  ...
  public okhttp3.Call submitInvoiceAsync(
    ...
    okhttp3.Call call =
        submitInvoiceValidateBeforeCall(
