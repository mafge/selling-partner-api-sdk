...
public class StandardTechSpecsModule {
  ...
  public StandardTechSpecsModule addSpecificationListItem(
      StandardTextPairBlock specificationListItem) {
  ...
  /**
   * The number of tables you want present. Features are evenly divided between the tables. minimum:
   * 1 maximum: 2
   *
   * @return tableCount
   */
