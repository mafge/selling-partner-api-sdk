...
public class PackedItems {
  ...
  /**
   * Item sequence number for the item. The first item will be 001, the second 002, and so on. This
   * number is used as a reference to refer to this item from the carton or pallet level.
   *
   * @return itemSequenceNumber
   */
  @Schema(
      description =
          "Item sequence number for the item. The first item will be 001, the second 002, and so"
              + " on. This number is used as a reference to refer to this item from the carton or"
              + " pallet level.")
