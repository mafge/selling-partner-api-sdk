...
public class PaymentExecutionDetailItem {
  ...
  /**
   * A sub-payment method for a COD order. **Possible values**: * &#x60;COD&#x60;: Cash on delivery
   * * &#x60;GC&#x60;: Gift card * &#x60;PointsAccount&#x60;: Amazon Points * &#x60;Invoice&#x60;:
   * Invoice
   *
  ...
  @Schema(
      ...
      description =
          "A sub-payment method for a COD order.  **Possible values**: * `COD`: Cash on delivery  *"
              + " `GC`: Gift card  * `PointsAccount`: Amazon Points * `Invoice`: Invoice")
