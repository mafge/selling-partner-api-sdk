...
/**
 * The response object which contains the ASIN, marketplaceId if required, eligibility program, the
 * eligibility status (boolean), and a list of ineligibility reason codes.
 */
@Schema(
    description =
        "The response object which contains the ASIN, marketplaceId if required, eligibility"
            + " program, the eligibility status (boolean), and a list of ineligibility reason"
            + " codes.")
public class ItemEligibilityPreview {
  ...
  public enum ProgramEnum {
    ...
    public static class Adapter extends TypeAdapter<ProgramEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ProgramEnum enumeration)
          throws IOException {
  ...
  public ItemEligibilityPreview ineligibilityReasonList(
      List<IneligibilityReasonListEnum> ineligibilityReasonList) {
  ...
  public void setIneligibilityReasonList(
      List<IneligibilityReasonListEnum> ineligibilityReasonList) {
    this.ineligibilityReasonList = ineligibilityReasonList;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.asin, itemEligibilityPreview.asin)
        ...
        && Objects.equals(
            this.ineligibilityReasonList, itemEligibilityPreview.ineligibilityReasonList);
  }
