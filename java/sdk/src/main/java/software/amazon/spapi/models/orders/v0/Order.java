...
public class Order {
  ...
  public enum OrderStatusEnum {
    ...
    public static class Adapter extends TypeAdapter<OrderStatusEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final OrderStatusEnum enumeration)
          throws IOException {
  ...
  public enum FulfillmentChannelEnum {
    ...
    public static class Adapter extends TypeAdapter<FulfillmentChannelEnum> {
      ...
      public FulfillmentChannelEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return FulfillmentChannelEnum.fromValue((String) (value));
      }
    }
  }
  ...
  /**
   * The payment method for the order. This property is limited to COD and CVS payment methods.
  ...
  public enum OrderTypeEnum {
    ...
    @SerializedName("LongLeadTimeOrder")
    LONGLEADTIMEORDER("LongLeadTimeOrder"),
    @SerializedName("Preorder")
    PREORDER("Preorder"),
    @SerializedName("BackOrder")
    BACKORDER("BackOrder"),
    @SerializedName("SourcingOnDemandOrder")
    ...
    public static class Adapter extends TypeAdapter<OrderTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final OrderTypeEnum enumeration)
          throws IOException {
        jsonWriter.value(String.valueOf(enumeration.getValue()));
      }
  ...
  /**
   * The buyer&#x27;s invoicing preference. Sellers can use this data to issue electronic invoices
   * for orders in Turkey. **Note**: This attribute is only available in the Turkey marketplace.
   */
  ...
  public enum BuyerInvoicePreferenceEnum {
    ...
    public static class Adapter extends TypeAdapter<BuyerInvoicePreferenceEnum> {
      ...
      public BuyerInvoicePreferenceEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return BuyerInvoicePreferenceEnum.fromValue((String) (value));
      }
    }
  }
  ...
  /**
   * The date when the order was last updated. __Note__: &#x60;LastUpdateDate&#x60; is returned with
   * an incorrect date for orders that were last updated before 2009-04-01.
   *
  ...
  @Schema(
      description =
          "The payment method for the order. This property is limited to COD and CVS payment"
              + " methods. Unless you need the specific COD payment information provided by the"
              + " `PaymentExecutionDetailItem` object, we recommend using the"
              + " `PaymentMethodDetails` property to get payment method information.")
   ...
   * &#x60;FreeEconomy&#x60;, &#x60;NextDay&#x60;, &#x60;Priority&#x60;, &#x60;SameDay&#x60;,
   * &#x60;SecondDay&#x60;, &#x60;Scheduled&#x60;, and &#x60;Standard&#x60;.
   *
  ...
  @Schema(
      description =
          "The shipment service level category for the order.  **Possible values**: `Expedited`,"
              + " `FreeEconomy`, `NextDay`, `Priority`, `SameDay`, `SecondDay`, `Scheduled`, and"
              + " `Standard`.")
   ...
   * 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date time format. Only returned
   * for seller-fulfilled orders. __Note__: &#x60;EarliestShipDate&#x60; might not be returned for
  ...
  @Schema(
      description =
          "The start of the time period within which you have committed to ship the order. In [ISO"
              ...
              + " Only returned for seller-fulfilled orders.  __Note__: `EarliestShipDate` might"
              + " not be returned for orders placed before February 1, 2013.")
   ...
   * 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date time format. Only returned
   * for seller-fulfilled orders. __Note__: &#x60;LatestShipDate&#x60; might not be returned for
   * orders placed before February 1, 2013.
   *
  ...
  @Schema(
      description =
          "The end of the time period within which you have committed to ship the order. In [ISO"
              + " 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date time format."
              + " Only returned for seller-fulfilled orders.  __Note__: `LatestShipDate` might not"
              + " be returned for orders placed before February 1, 2013.")
  ...
  @Schema(
      description =
          "The start of the time period within which you have committed to fulfill the order. In"
              + " [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date time"
              + " format. Only returned for seller-fulfilled orders.")
   ...
   * 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date time format. Only returned
   * for seller-fulfilled orders that do not have a &#x60;PendingAvailability&#x60;,
  ...
  @Schema(
      description =
          "The end of the time period within which you have committed to fulfill the order. In [ISO"
              + " 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date time format."
              + " Only returned for seller-fulfilled orders that do not have a"
  ...
  /**
   * When true, the order is an Amazon Business order. An Amazon Business order is an order where
   * the buyer is a Verified Business Buyer.
   *
  ...
  /**
   * When true, the order has a Premium Shipping Service Level Agreement. For more information about
   * Premium Shipping orders, refer to \&quot;Premium Shipping Options\&quot; in the Seller Central
  ...
  @Schema(
      description =
          "When true, the order has a Premium Shipping Service Level Agreement. For more"
              + " information about Premium Shipping orders, refer to \"Premium Shipping Options\""
              + " in the Seller Central Help for your marketplace.")
  ...
  /**
   * The order ID value for the order that is being replaced. Returned only if IsReplacementOrder
   * &#x3D; true.
   *
  ...
  @Schema(
      description =
          "Indicates the date by which the seller must respond to the buyer with an estimated ship"
              + " date. Only returned for Sourcing on Demand orders.")
  ...
  @Schema(
      description =
          "When true, the estimated ship date is set for the order. Only returned for Sourcing on"
              + " Demand orders.")
   ...
   * By buying and instantly re-selling your items, ABEU becomes the seller of record, making your
   * inventory available for sale to customers who would not otherwise purchase from a third-party
   * seller.
   *
   * @return isSoldByAB
   */
  @Schema(
      description =
          "When true, the item within this order was bought and re-sold by Amazon Business EU SARL"
              + " (ABEU). By buying and instantly re-selling your items, ABEU becomes the seller of"
              + " record, making your inventory available for sale to customers who would not"
  ...
  @Schema(
      description =
          "The buyer's invoicing preference. Sellers can use this data to issue electronic invoices"
              + " for orders in Turkey.  **Note**: This attribute is only available in the Turkey"
              + " marketplace.")
   ...
   * chosen by the customer. Access Points include Amazon Hub Lockers, Amazon Hub Counters, and
   * pickup points operated by carriers.
   *
   * @return isAccessPointOrder
   */
  @Schema(
      description =
          "When true, this order is marked to be delivered to an Access Point. The access location"
              + " is chosen by the customer. Access Points include Amazon Hub Lockers, Amazon Hub"
              + " Counters, and pickup points operated by carriers.")
  ...
  /**
   * The seller’s friendly name registered in the marketplace where the sale took place. Sellers can
   * use this data to issue electronic invoices for orders in Brazil. **Note**: This attribute is
   * only available in the Brazil marketplace for the orders with &#x60;Pending&#x60; or
   * &#x60;Unshipped&#x60; status.
   *
  ...
  @Schema(
      description =
          "The seller’s friendly name registered in the marketplace where the sale took place."
              + " Sellers can use this data to issue electronic invoices for orders in Brazil. "
              + " **Note**: This attribute is only available in the Brazil marketplace for the"
              + " orders with `Pending` or `Unshipped` status.")
  ...
  /**
   * Whether the order contains regulated items which may require additional approval steps before
   * being fulfilled.
   *
