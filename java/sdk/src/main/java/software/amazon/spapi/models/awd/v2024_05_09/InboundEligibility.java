...
public class InboundEligibility {
  ...
  public InboundEligibility ineligibilityReasons(
      List<OrderIneligibilityReason> ineligibilityReasons) {
    this.ineligibilityReasons = ineligibilityReasons;
    return this;
  }

  public InboundEligibility addIneligibilityReasonsItem(
      OrderIneligibilityReason ineligibilityReasonsItem) {
  ...
  /**
   * If there are order level eligibility issues, then this list will contain those error codes and
   * descriptions.
   *
  ...
  @Schema(
      description =
          "If there are order level eligibility issues, then this list will contain those error"
