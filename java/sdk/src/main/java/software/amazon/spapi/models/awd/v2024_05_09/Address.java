...
public class Address {
  ...
  /**
   * State or region where this address is located. Note that this is contextual to the specified
   * country code.
   *
  ...
  @Schema(
      required = true,
      description =
          "State or region where this address is located. Note that this is contextual to the"
