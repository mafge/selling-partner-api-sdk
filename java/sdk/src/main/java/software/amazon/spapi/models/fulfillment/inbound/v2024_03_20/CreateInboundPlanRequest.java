...
public class CreateInboundPlanRequest {
  ...
  public CreateInboundPlanRequest addDestinationMarketplacesItem(
      String destinationMarketplacesItem) {
    this.destinationMarketplaces.add(destinationMarketplacesItem);
    return this;
  }

  /**
   * Marketplaces where the items need to be shipped to. Currently only one marketplace can be
  ...
  @Schema(
      required = true,
      description =
          "Marketplaces where the items need to be shipped to. Currently only one marketplace can"
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(
            this.destinationMarketplaces, createInboundPlanRequest.destinationMarketplaces)
