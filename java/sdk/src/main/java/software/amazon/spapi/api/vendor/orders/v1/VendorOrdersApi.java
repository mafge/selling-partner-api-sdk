...
public class VendorOrdersApi {
    ...
    private final Bucket getPurchaseOrderBucket = Bucket.builder()
            .addLimit(config.getLimit("VendorOrdersApi-getPurchaseOrder"))
            .build();

    private final Bucket getPurchaseOrdersBucket = Bucket.builder()
            .addLimit(config.getLimit("VendorOrdersApi-getPurchaseOrders"))
            .build();

    private final Bucket getPurchaseOrdersStatusBucket = Bucket.builder()
    ...
    public ApiResponse<GetPurchaseOrderResponse> getPurchaseOrderWithHttpInfo(String purchaseOrderNumber)
        ...
        if (getPurchaseOrderBucket.tryConsume(1)) {
    ...
    public ApiResponse<GetPurchaseOrdersResponse> getPurchaseOrdersWithHttpInfo(
        ...
        okhttp3.Call call = getPurchaseOrdersValidateBeforeCall(
                ...
                null,
                null);
        if (getPurchaseOrdersBucket.tryConsume(1)) {
    ...
    public ApiResponse<GetPurchaseOrdersStatusResponse> getPurchaseOrdersStatusWithHttpInfo(
        ...
        okhttp3.Call call = getPurchaseOrdersStatusValidateBeforeCall(
                ...
                null,
                null);
        if (getPurchaseOrdersStatusBucket.tryConsume(1)) {
