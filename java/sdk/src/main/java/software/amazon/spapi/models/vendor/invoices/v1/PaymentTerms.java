...
public class PaymentTerms {
  ...
  /**
   * The number of calendar days from the Base date (Invoice date) until the discount is no longer
   * valid.
   *
  ...
  @Schema(
      description =
          "The number of calendar days from the Base date (Invoice date) until the discount is no"
              + " longer valid.")
  ...
  /**
   * The number of calendar days from the base date (invoice date) until the total amount on the
   * invoice is due.
   *
   * @return netDueDays
   */
  @Schema(
      description =
          "The number of calendar days from the base date (invoice date) until the total amount on"
              + " the invoice is due.")
