...
public class ReportsApi {
   ...
   *
   * @param reportId The identifier for the report. This identifier is unique only in combination
  ...
  private okhttp3.Call cancelReportValidateBeforeCall(
    ...
    if (reportId == null) {
      throw new ApiException(
          "Missing the required parameter 'reportId' when calling cancelReport(Async)");
    }
   ...
   * &#x60;processingStatus&#x3D;IN_QUEUE&#x60; can be cancelled. Cancelled reports are returned in
   * subsequent calls to the &#x60;getReport&#x60; and &#x60;getReports&#x60; operations. **Usage
   * Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 0.0222 | 10 | The
   ...
   * @throws LWAException If calls to fetch LWA access token fails
   */
  public ApiResponse<Void> cancelReportWithHttpInfo(String reportId)
      throws ApiException, LWAException {
  ...
  public okhttp3.Call cancelReportAsync(String reportId, final ApiCallback<Void> callback)
    ...
    okhttp3.Call call =
        cancelReportValidateBeforeCall(reportId, progressListener, progressRequestListener);
   ...
   *
   * @param reportScheduleId The identifier for the report schedule. This identifier is unique only
   *     in combination with a seller ID. (required)
   * @param progressListener Progress listener
   * @param progressRequestListener Progress request listener
   * @return Call to execute
   * @throws ApiException If fail to serialize the request body object
  ...
  public okhttp3.Call cancelReportScheduleCall(
    ...
    String localVarPath =
        "/reports/2021-06-30/schedules/{reportScheduleId}"
            .replaceAll(
                "\\{" + "reportScheduleId" + "\\}",
                apiClient.escapeString(reportScheduleId.toString()));
  ...
  private okhttp3.Call cancelReportScheduleValidateBeforeCall(
    ...
    if (reportScheduleId == null) {
      throw new ApiException(
          "Missing the required parameter 'reportScheduleId' when calling"
              + " cancelReportSchedule(Async)");
    }

    okhttp3.Call call =
        cancelReportScheduleCall(reportScheduleId, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Cancels the report schedule that you specify. **Usage Plan:** | Rate (requests per second) |
   * Burst | | ---- | ---- | | 0.0222 | 10 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header
  ...
  /**
   * (asynchronously) Cancels the report schedule that you specify. **Usage Plan:** | Rate (requests
   * per second) | Burst | | ---- | ---- | | 0.0222 | 10 | The &#x60;x-amzn-RateLimit-Limit&#x60;
  ...
  public okhttp3.Call cancelReportScheduleAsync(
      String reportScheduleId, final ApiCallback<Void> callback) throws ApiException, LWAException {
    ...
    okhttp3.Call call =
        cancelReportScheduleValidateBeforeCall(
            reportScheduleId, progressListener, progressRequestListener);
    apiClient.executeAsync(call, callback);
    return call;
  }
  ...
  private okhttp3.Call createReportValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling createReport(Async)");
    }
  ...
  /**
   * Creates a report. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | |
   * 0.0167 | 15 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan
   ...
   * ---- | ---- | | 0.0167 | 15 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns
   ...
   * whose business demands require higher throughput may see higher rate and burst values than
  ...
  public okhttp3.Call createReportAsync(
    ...
    okhttp3.Call call =
        createReportValidateBeforeCall(body, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<CreateReportResponse>() {}.getType();
  ...
  private okhttp3.Call createReportScheduleValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling createReportSchedule(Async)");
    }
   ...
   * already exists, it will be cancelled and replaced with this one. **Usage Plan:** | Rate
   * (requests per second) | Burst | | ---- | ---- | | 0.0222 | 10 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The table above indicates the default rate
   * and burst values for this operation. Selling partners whose business demands require higher
   * throughput may see higher rate and burst values than those shown here. For more information,
  ...
  /**
   * (asynchronously) Creates a report schedule. If a report schedule with the same report type and
   * marketplace IDs already exists, it will be cancelled and replaced with this one. **Usage
   * Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 0.0222 | 10 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The table above indicates the default rate
   * and burst values for this operation. Selling partners whose business demands require higher
  ...
  public okhttp3.Call createReportScheduleAsync(
    ...
    okhttp3.Call call =
        createReportScheduleValidateBeforeCall(body, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<CreateReportScheduleResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
  ...
  private okhttp3.Call getReportValidateBeforeCall(
    ...
    if (reportId == null) {
      throw new ApiException(
          "Missing the required parameter 'reportId' when calling getReport(Async)");
    }
   ...
   * report that you specify. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- |
  ...
  /**
   * (asynchronously) Returns report details (including the &#x60;reportDocumentId&#x60;, if
   * available) for the report that you specify. **Usage Plan:** | Rate (requests per second) |
  ...
  public okhttp3.Call getReportAsync(String reportId, final ApiCallback<Report> callback)
    ...
    okhttp3.Call call =
        getReportValidateBeforeCall(reportId, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<Report>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
  ...
  public okhttp3.Call getReportDocumentCall(
    ...
    String localVarPath =
        "/reports/2021-06-30/documents/{reportDocumentId}"
            .replaceAll(
                "\\{" + "reportDocumentId" + "\\}",
                apiClient.escapeString(reportDocumentId.toString()));
  ...
  private okhttp3.Call getReportDocumentValidateBeforeCall(
    ...
    if (reportDocumentId == null) {
      throw new ApiException(
          "Missing the required parameter 'reportDocumentId' when calling"
              + " getReportDocument(Async)");
    }

    okhttp3.Call call =
        getReportDocumentCall(reportDocumentId, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Returns the information required for retrieving a report document&#x27;s contents. **Usage
  ...
  /**
   * (asynchronously) Returns the information required for retrieving a report document&#x27;s
   * contents. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 0.0167 | 15
  ...
  public okhttp3.Call getReportDocumentAsync(
      String reportDocumentId, final ApiCallback<ReportDocument> callback)
      throws ApiException, LWAException {
    ...
    okhttp3.Call call =
        getReportDocumentValidateBeforeCall(
            reportDocumentId, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<ReportDocument>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
  ...
  private okhttp3.Call getReportScheduleValidateBeforeCall(
    ...
    okhttp3.Call call =
        getReportScheduleCall(reportScheduleId, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Returns report schedule details for the report schedule that you specify. **Usage Plan:** |
   * Rate (requests per second) | Burst | | ---- | ---- | | 0.0222 | 10 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The table above indicates the default rate
   * and burst values for this operation. Selling partners whose business demands require higher
   * throughput may see higher rate and burst values than those shown here. For more information,
  ...
  /**
   * (asynchronously) Returns report schedule details for the report schedule that you specify.
  ...
  public okhttp3.Call getReportScheduleAsync(
      String reportScheduleId, final ApiCallback<ReportSchedule> callback)
      throws ApiException, LWAException {
    ...
    okhttp3.Call call =
        getReportScheduleValidateBeforeCall(
            reportScheduleId, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<ReportSchedule>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
   ...
   *
   * @param reportTypes A list of report types used to filter report schedules. Refer to [Report
   *     Type Values](https://developer-docs.amazon.com/sp-api/docs/report-type-values) for more
  ...
  public okhttp3.Call getReportSchedulesCall(
    ...
    if (reportTypes != null)
      localVarCollectionQueryParams.addAll(
          apiClient.parameterToPairs("csv", "reportTypes", reportTypes));
  ...
  private okhttp3.Call getReportSchedulesValidateBeforeCall(
    ...
    okhttp3.Call call =
        getReportSchedulesCall(reportTypes, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Returns report schedule details that match the filters that you specify. **Usage Plan:** | Rate
   * (requests per second) | Burst | | ---- | ---- | | 0.0222 | 10 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The table above indicates the default rate
   * and burst values for this operation. Selling partners whose business demands require higher
  ...
  /**
   * (asynchronously) Returns report schedule details that match the filters that you specify.
   * **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 0.0222 | 10 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The table above indicates the default rate
   * and burst values for this operation. Selling partners whose business demands require higher
  ...
  public okhttp3.Call getReportSchedulesAsync(
    ...
    okhttp3.Call call =
        getReportSchedulesValidateBeforeCall(
            reportTypes, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<ReportScheduleList>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
   ...
   *     Values](https://developer-docs.amazon.com/sp-api/docs/report-type-values) for more
   *     information. When reportTypes is provided, the other filter parameters (processingStatuses,
   *     marketplaceIds, createdSince, createdUntil) and pageSize may also be provided. Either
   *     reportTypes or nextToken is required. (optional)
   * @param processingStatuses A list of processing statuses used to filter reports. (optional)
   * @param marketplaceIds A list of marketplace identifiers used to filter reports. The reports
   *     returned will match at least one of the marketplaces that you specify. (optional)
   * @param pageSize The maximum number of reports to return in a single call. (optional, default to
   *     10)
   * @param createdSince The earliest report creation date and time for reports to include in the
   *     response, in &lt;a
   *     href&#x3D;&#x27;https://developer-docs.amazon.com/sp-api/docs/iso-8601&#x27;&gt;ISO
   *     8601&lt;/a&gt; date time format. The default is 90 days ago. Reports are retained for a
   *     maximum of 90 days. (optional)
   * @param createdUntil The latest report creation date and time for reports to include in the
   *     response, in &lt;a
   *     href&#x3D;&#x27;https://developer-docs.amazon.com/sp-api/docs/iso-8601&#x27;&gt;ISO
   *     8601&lt;/a&gt; date time format. The default is now. (optional)
   * @param nextToken A string token returned in the response to your previous request.
   *     &#x60;nextToken&#x60; is returned when the number of results exceeds the specified
   *     &#x60;pageSize&#x60; value. To get the next page of results, call the
   *     &#x60;getReports&#x60; operation and include this token as the only parameter. Specifying
  ...
  /**
   * Returns report details for the reports that match the filters that you specify. **Usage Plan:**
   * | Rate (requests per second) | Burst | | ---- | ---- | | 0.0222 | 10 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The table above indicates the default rate
   * and burst values for this operation. Selling partners whose business demands require higher
  ...
  public GetReportsResponse getReports(
      ...
      String nextToken)
      throws ApiException, LWAException {
    ApiResponse<GetReportsResponse> resp =
        getReportsWithHttpInfo(
            reportTypes,
            processingStatuses,
            marketplaceIds,
            pageSize,
  ...
  /**
   * (asynchronously) Returns report details for the reports that match the filters that you
   * specify. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 0.0222 | 10 |
