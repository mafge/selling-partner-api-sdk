...
/**
 * The container for address extended fields (such as &#x60;street name&#x60; and &#x60;street
 * number&#x60;). Currently only available with Brazil shipping addresses.
 */
@Schema(
    description =
        "The container for address extended fields (such as `street name` and `street number`)."
            + " Currently only available with Brazil shipping addresses.")
