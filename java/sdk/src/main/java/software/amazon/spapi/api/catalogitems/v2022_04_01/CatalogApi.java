...
public class CatalogApi {
   ...
   * @param marketplaceIds A comma-delimited list of Amazon marketplace identifiers. To find the ID
   ...
   * @param locale The locale for which you want to retrieve localized summaries. Defaults to the
  ...
  private okhttp3.Call getCatalogItemValidateBeforeCall(
    ...
    if (asin == null) {
      throw new ApiException(
          "Missing the required parameter 'asin' when calling getCatalogItem(Async)");
    }
  ...
  /**
   * Retrieves details for an item in the Amazon catalog. **Usage Plan:** | Rate (requests per
   * second) | Burst | | ---- | ---- | | 5 | 5 | The &#x60;x-amzn-RateLimit-Limit&#x60; response
  ...
  public ApiResponse<Item> getCatalogItemWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        getCatalogItemValidateBeforeCall(asin, marketplaceIds, includedData, locale, null, null);
    Type localVarReturnType = new TypeToken<Item>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Retrieves details for an item in the Amazon catalog. **Usage Plan:** | Rate
  ...
  public okhttp3.Call getCatalogItemAsync(
    ...
    okhttp3.Call call =
        getCatalogItemValidateBeforeCall(
            asin, marketplaceIds, includedData, locale, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<Item>() {}.getType();
   ...
   *     for your marketplace, refer to [Marketplace
   *     IDs](https://developer-docs.amazon.com/sp-api/docs/marketplace-ids). (required)
   * @param identifiers A comma-delimited list of product identifiers that you can use to search the
   *     Amazon catalog. **Note:** You cannot include &#x60;identifiers&#x60; and
   *     &#x60;keywords&#x60; in the same request. (optional)
   * @param identifiersType The type of product identifiers that you can use to search the Amazon
   *     catalog. **Note:** &#x60;identifiersType&#x60; is required when &#x60;identifiers&#x60; is
   *     in the request. (optional)
   * @param includedData A comma-delimited list of datasets to include in the response. (optional)
   * @param locale The locale for which you want to retrieve localized summaries. Defaults to the
   *     primary locale of the marketplace. (optional)
   * @param sellerId A selling partner identifier, such as a seller account or vendor code.
   *     **Note:** Required when &#x60;identifiersType&#x60; is &#x60;SKU&#x60;. (optional)
   * @param keywords A comma-delimited list of keywords that you can use to search the Amazon
   *     catalog. **Note:** You cannot include &#x60;keywords&#x60; and &#x60;identifiers&#x60; in
   *     the same request. (optional)
   * @param brandNames A comma-delimited list of brand names that you can use to limit the search in
   *     queries based on &#x60;keywords&#x60;. **Note:** Cannot be used with
   *     &#x60;identifiers&#x60;. (optional)
   * @param classificationIds A comma-delimited list of classification identifiers that you can use
   *     to limit the search in queries based on &#x60;keywords&#x60;. **Note:** Cannot be used with
   *     &#x60;identifiers&#x60;. (optional)
   ...
   * @param keywordsLocale The language of the keywords that are included in queries based on
   *     &#x60;keywords&#x60;. Defaults to the primary locale of the marketplace. **Note:** Cannot
   *     be used with &#x60;identifiers&#x60;. (optional)
   * @param progressListener Progress listener
   * @param progressRequestListener Progress request listener
   * @return Call to execute
   * @throws ApiException If fail to serialize the request body object
  ...
  public okhttp3.Call searchCatalogItemsCall(
    ...
    if (brandNames != null)
      localVarCollectionQueryParams.addAll(
          apiClient.parameterToPairs("csv", "brandNames", brandNames));
  ...
  /**
   * Search for a list of Amazon catalog items and item-related information. You can search by
   * identifier or by keywords. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ----
  ...
  public ItemSearchResults searchCatalogItems(
    ...
    ApiResponse<ItemSearchResults> resp =
        searchCatalogItemsWithHttpInfo(
            marketplaceIds,
            identifiers,
            identifiersType,
            includedData,
  ...
  public ApiResponse<ItemSearchResults> searchCatalogItemsWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        searchCatalogItemsValidateBeforeCall(
            marketplaceIds,
            identifiers,
            identifiersType,
            includedData,
  ...
  /**
   * (asynchronously) Search for a list of Amazon catalog items and item-related information. You
   * can search by identifier or by keywords. **Usage Plan:** | Rate (requests per second) | Burst |
   * | ---- | ---- | | 5 | 5 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header contains the
