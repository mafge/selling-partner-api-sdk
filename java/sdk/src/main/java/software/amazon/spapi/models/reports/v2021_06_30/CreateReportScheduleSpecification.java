...
public class CreateReportScheduleSpecification {
   ...
   * 8601&lt;/a&gt; periods that specifies how often a report should be created.
   */
  ...
  public enum PeriodEnum {
    ...
    public static class Adapter extends TypeAdapter<PeriodEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final PeriodEnum enumeration)
          throws IOException {
  ...
  public CreateReportScheduleSpecification nextReportCreationTime(
      OffsetDateTime nextReportCreationTime) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreateReportScheduleSpecification createReportScheduleSpecification =
        (CreateReportScheduleSpecification) o;
