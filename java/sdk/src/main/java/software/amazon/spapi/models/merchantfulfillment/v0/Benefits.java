 ...
 * provided by Amazon (for example, &#x60;CLAIMS_PROTECTED&#x60;) when sellers purchase shipping
 * through Amazon. Benefit details are made available for any shipment placed on or after January
 * 1st 2024 00:00 UTC.
 */
@Schema(
    description =
        "Benefits that are included and excluded for each shipping offer. Benefits represents"
            + " services provided by Amazon (for example, `CLAIMS_PROTECTED`) when sellers purchase"
            + " shipping through Amazon. Benefit details are made available for any shipment placed"
            + " on or after January 1st 2024 00:00 UTC.")
