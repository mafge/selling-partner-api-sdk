...
public class ProductAdsPaymentEvent {
  ...
  /**
   * Indicates if the transaction is for a charge or a refund. Possible values: * charge - Charge *
   * refund - Refund
   *
  ...
  public int hashCode() {
    return Objects.hash(
        postedDate, transactionType, invoiceId, baseValue, taxValue, transactionValue);
  }
