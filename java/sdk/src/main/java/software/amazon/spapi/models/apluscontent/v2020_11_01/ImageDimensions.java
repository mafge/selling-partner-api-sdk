...
/**
 * The dimensions that extend from the top left corner of the image (this applies to cropped and
 * uncropped images). &#x60;ImageDimensions&#x60; units must be in pixels.
 */
@Schema(
    description =
        "The dimensions that extend from the top left corner of the image (this applies to cropped"
            + " and uncropped images). `ImageDimensions` units must be in pixels.")
