...
/**
 * Contains the instructions about the fulfillment, such as the location from where you want the
 * order filled.
 */
@Schema(
    description =
        "Contains the instructions about the fulfillment, such as the location from where you want"
            + " the order filled.")
public class FulfillmentInstruction {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(
        this.fulfillmentSupplySourceId, fulfillmentInstruction.fulfillmentSupplySourceId);
  }
