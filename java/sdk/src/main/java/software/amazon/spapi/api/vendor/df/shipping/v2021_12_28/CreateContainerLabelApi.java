...
public class CreateContainerLabelApi {
  ...
  private okhttp3.Call createContainerLabelValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling createContainerLabel(Async)");
    }
  ...
  /**
   * createContainerLabel Creates a container (pallet) label for the associated shipment package.
  ...
  public ApiResponse<CreateContainerLabelResponse> createContainerLabelWithHttpInfo(
      CreateContainerLabelRequest body) throws ApiException, LWAException {
  ...
  /**
   * createContainerLabel (asynchronously) Creates a container (pallet) label for the associated
   * shipment package. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 10 |
  ...
  public okhttp3.Call createContainerLabelAsync(
    ...
    okhttp3.Call call =
        createContainerLabelValidateBeforeCall(body, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<CreateContainerLabelResponse>() {}.getType();
