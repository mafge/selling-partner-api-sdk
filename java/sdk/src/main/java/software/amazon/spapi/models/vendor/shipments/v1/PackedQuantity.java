...
public class PackedQuantity {
  ...
  public enum UnitOfMeasureEnum {
    ...
    public static class Adapter extends TypeAdapter<UnitOfMeasureEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final UnitOfMeasureEnum enumeration)
          throws IOException {
  ...
  /**
   * Amount of units shipped for a specific item at a shipment level. If the item is present only in
   * certain cartons or pallets within the shipment, please provide this at the appropriate carton
   * or pallet level.
   *
   * @return amount
   */
  @Schema(
      required = true,
      description =
          "Amount of units shipped for a specific item at a shipment level. If the item is present"
              + " only in certain cartons or pallets within the shipment, please provide this at"
              + " the appropriate carton or pallet level.")
