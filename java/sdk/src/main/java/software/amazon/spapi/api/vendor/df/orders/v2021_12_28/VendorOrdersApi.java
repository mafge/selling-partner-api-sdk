...
public class VendorOrdersApi {
   ...
   *
   * @param purchaseOrderNumber The order identifier for the purchase order that you want.
   *     Formatting Notes: alpha-numeric code. (required)
  ...
  private okhttp3.Call getOrderValidateBeforeCall(
    ...
    if (purchaseOrderNumber == null) {
      throw new ApiException(
          "Missing the required parameter 'purchaseOrderNumber' when calling getOrder(Async)");
    }

    okhttp3.Call call =
        getOrderCall(purchaseOrderNumber, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Returns purchase order information for the purchaseOrderNumber that you specify. **Usage
  ...
  /**
   * (asynchronously) Returns purchase order information for the purchaseOrderNumber that you
  ...
  public okhttp3.Call getOrderAsync(String purchaseOrderNumber, final ApiCallback<Order> callback)
    ...
    okhttp3.Call call =
        getOrderValidateBeforeCall(purchaseOrderNumber, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<Order>() {}.getType();
   ...
   *
   * @param createdAfter Purchase orders that became available after this date and time will be
   *     included in the result. Must be in ISO-8601 date/time format. (required)
   * @param createdBefore Purchase orders that became available before this date and time will be
   *     included in the result. Must be in ISO-8601 date/time format. (required)
   * @param shipFromPartyId The vendor warehouse identifier for the fulfillment warehouse. If not
   *     specified, the result will contain orders for all warehouses. (optional)
   * @param status Returns only the purchase orders that match the specified status. If not
   *     specified, the result will contain orders that match any status. (optional)
   * @param limit The limit to the number of purchase orders returned. (optional)
   * @param sortOrder Sort the list in ascending or descending order by order creation date.
   *     (optional)
   * @param nextToken Used for pagination when there are more orders than the specified result size
   *     limit. The token value is returned in the previous API call. (optional)
   * @param includeDetails When true, returns the complete purchase order details. Otherwise, only
   *     purchase order numbers are returned. (optional, default to true)
   * @param progressListener Progress listener
   * @param progressRequestListener Progress request listener
   * @return Call to execute
   * @throws ApiException If fail to serialize the request body object
  ...
  private okhttp3.Call getOrdersValidateBeforeCall(
    ...
    if (createdAfter == null) {
      throw new ApiException(
          "Missing the required parameter 'createdAfter' when calling getOrders(Async)");
    }
    // verify the required parameter 'createdBefore' is set
    if (createdBefore == null) {
      throw new ApiException(
          "Missing the required parameter 'createdBefore' when calling getOrders(Async)");
    }
  ...
  /**
   * Returns a list of purchase orders created during the time frame that you specify. You define
   * the time frame using the createdAfter and createdBefore parameters. You must use both
   * parameters. You can choose to get only the purchase order numbers by setting the includeDetails
   * parameter to false. In that case, the operation returns a list of purchase order numbers. You
   * can then call the getOrder operation to return the details of a specific order. **Usage Plan:**
  ...
  /**
   * (asynchronously) Returns a list of purchase orders created during the time frame that you
   * specify. You define the time frame using the createdAfter and createdBefore parameters. You
   * must use both parameters. You can choose to get only the purchase order numbers by setting the
   * includeDetails parameter to false. In that case, the operation returns a list of purchase order
   * numbers. You can then call the getOrder operation to return the details of a specific order.
