...
public class ItemDelivery {
  ...
  /**
   * The date and time of the latest Estimated Delivery Date (EDD) of all the items with an EDD. In
   * ISO 8601 format.
   *
  ...
  @Schema(
      description =
          "The date and time of the latest Estimated Delivery Date (EDD) of all the items with an"
              + " EDD. In ISO 8601 format.")
