...
/**
 * A constraint that can apply to an individual owner. If no constraint is specified, both
 * &#x60;AMAZON&#x60; and &#x60;SELLER&#x60; are acceptable.
 */
...
public enum OwnerConstraint {
  ...
  public static class Adapter extends TypeAdapter<OwnerConstraint> {
    @Override
    public void write(final JsonWriter jsonWriter, final OwnerConstraint enumeration)
        throws IOException {
