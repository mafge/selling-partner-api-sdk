...
/**
 * Information about the prescription that is used to verify a regulated product. This must be
 * provided once per order and reflect the seller’s own records. Only approved orders can have
 * prescriptions.
 */
@Schema(
    description =
        "Information about the prescription that is used to verify a regulated product. This must"
            + " be provided once per order and reflect the seller’s own records. Only approved"
            + " orders can have prescriptions.")
public class PrescriptionDetail {
  ...
  /**
   * The total number of refills written in the original prescription used to verify the regulated
   * product. If a prescription originally had no refills, this value must be 0. minimum: 0
   *
  ...
  @Schema(
      required = true,
      description =
          "The total number of refills written in the original prescription used to verify the"
              + " regulated product. If a prescription originally had no refills, this value must"
              + " be 0.")
  ...
  /**
   * The number of refills remaining for the prescription used to verify the regulated product. If a
   * prescription originally had 10 total refills, this value must be &#x60;10&#x60; for the first
   * order, &#x60;9&#x60; for the second order, and &#x60;0&#x60; for the eleventh order. If a
  ...
  @Schema(
      required = true,
      description =
          "The number of refills remaining for the prescription used to verify the regulated"
              + " product. If a prescription originally had 10 total refills, this value must be"
              + " `10` for the first order, `9` for the second order, and `0` for the eleventh"
  ...
  /**
   * The identifier for the clinic which provided the prescription used to verify the regulated
   * product.
   *
   * @return clinicId
   */
  @Schema(
      required = true,
      description =
          "The identifier for the clinic which provided the prescription used to verify the"
              + " regulated product.")
  ...
  @Schema(
      required = true,
      description =
          "The instructions for the prescription as provided by the approver of the regulated"
              + " product.")
