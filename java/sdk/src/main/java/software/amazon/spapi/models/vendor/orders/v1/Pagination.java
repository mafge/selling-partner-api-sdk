...
public class Pagination {
   ...
   * pass the value of NextToken to the next request. If NextToken is not returned, there are no
   * more purchase order items to return.
   *
   * @return nextToken
   */
  @Schema(
      description =
          "A generated string used to pass information to your next request. If NextToken is"
              + " returned, pass the value of NextToken to the next request. If NextToken is not"
              + " returned, there are no more purchase order items to return.")
