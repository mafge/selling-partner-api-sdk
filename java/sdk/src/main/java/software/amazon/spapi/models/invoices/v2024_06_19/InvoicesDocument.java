...
/**
 * An object that contains the &#x60;documentId&#x60; and an S3 pre-signed URL that you can use to
...
public class InvoicesDocument {
   ...
   */
  @Schema(description = "The identifier of the export document.")
  ...
  /**
   * A pre-signed URL that you can use to download the invoices document in zip format. This URL
  ...
  @Schema(
      description =
          "A pre-signed URL that you can use to download the invoices document in zip format. This"
              + " URL expires after 30 seconds.")
