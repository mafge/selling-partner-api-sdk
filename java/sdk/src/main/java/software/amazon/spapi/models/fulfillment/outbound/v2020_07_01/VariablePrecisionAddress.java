...
/**
 * A physical address with varying degrees of precision. A more precise address can provide more
 * accurate results than country code and postal code alone.
 */
@Schema(
    description =
        "A physical address with varying degrees of precision. A more precise address can provide"
            + " more accurate results than country code and postal code alone.")
public class VariablePrecisionAddress {
  ...
  /**
   * The city where the person, business, or institution is located. This property should not be
   * used in Japan.
   *
   * @return city
   */
  @Schema(
      description =
          "The city where the person, business, or institution is located. This property should not"
              + " be used in Japan.")
