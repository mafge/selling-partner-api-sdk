...
/**
 * The information required to create a destination resource. Applications should use one resource
 * type (sqs or eventBridge) per destination.
 */
@Schema(
    description =
        "The information required to create a destination resource. Applications should use one"
            + " resource type (sqs or eventBridge) per destination.")
public class DestinationResourceSpecification {
  ...
  public DestinationResourceSpecification eventBridge(
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DestinationResourceSpecification destinationResourceSpecification =
        (DestinationResourceSpecification) o;
