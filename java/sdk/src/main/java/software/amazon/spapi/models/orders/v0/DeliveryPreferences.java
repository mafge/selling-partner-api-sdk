...
@Schema(
    description =
        "Contains all of the delivery instructions provided by the customer for the shipping"
            + " address.")
public class DeliveryPreferences {
  ...
  public int hashCode() {
    return Objects.hash(
        dropOffLocation, preferredDeliveryTime, otherAttributes, addressInstructions);
  }
