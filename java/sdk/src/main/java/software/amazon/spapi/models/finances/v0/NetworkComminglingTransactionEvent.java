...
public class NetworkComminglingTransactionEvent {
  ...
  /**
   * The type of network item swap. Possible values: * NetCo - A Fulfillment by Amazon inventory
   * pooling transaction. Available only in the India marketplace. * ComminglingVAT - A commingling
   * VAT transaction. Available only in the UK, Spain, France, Germany, and Italy marketplaces.
   *
  ...
  @Schema(
      description =
          "The type of network item swap.  Possible values:  * NetCo - A Fulfillment by Amazon"
              + " inventory pooling transaction. Available only in the India marketplace.  *"
              + " ComminglingVAT - A commingling VAT transaction. Available only in the UK, Spain,"
              + " France, Germany, and Italy marketplaces.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    NetworkComminglingTransactionEvent networkComminglingTransactionEvent =
        (NetworkComminglingTransactionEvent) o;
    return Objects.equals(this.transactionType, networkComminglingTransactionEvent.transactionType)
        ...
        && Objects.equals(
            this.netCoTransactionID, networkComminglingTransactionEvent.netCoTransactionID)
        ...
        && Objects.equals(
            this.taxExclusiveAmount, networkComminglingTransactionEvent.taxExclusiveAmount)
