...
public class ListOfferMetricsRequestPagination {
  ...
  /**
   * The maximum number of results to return in the response. minimum: 1 maximum: 500
   *
   * @return limit
   */
  ...
  /**
   * The offset from which to retrieve the number of results specified by the &#x60;limit&#x60;
   * value. The first result is at offset 0. minimum: 0 maximum: 9000
   *
   * @return offset
   */
  @Schema(
      required = true,
      description =
          "The offset from which to retrieve the number of results specified by the `limit` value."
              + " The first result is at offset 0.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ListOfferMetricsRequestPagination listOfferMetricsRequestPagination =
        (ListOfferMetricsRequestPagination) o;
