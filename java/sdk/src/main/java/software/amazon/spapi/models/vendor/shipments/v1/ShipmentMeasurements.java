...
public class ShipmentMeasurements {
  ...
  /**
   * Number of cartons present in the shipment. Provide the cartonCount only for non-palletized
   * shipments.
   *
   * @return cartonCount
   */
  ...
  /**
   * Number of pallets present in the shipment. Provide the palletCount only for palletized
   * shipments.
   *
   * @return palletCount
   */
