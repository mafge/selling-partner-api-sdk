...
public class Export {
  ...
  /**
   * The identifier for the export documents. To get the information required to retrieve the export
   * document&#x27;s contents, pass each ID in the &#x60;getInvoicesDocument&#x60; operation. This
   * list is empty until the status is &#x60;DONE&#x60;.
   *
   * @return invoicesDocumentIds
   */
  @Schema(
      description =
          "The identifier for the export documents. To get the information required to retrieve the"
              + " export document's contents, pass each ID in the `getInvoicesDocument` operation. "
