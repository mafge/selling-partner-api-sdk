...
public class Address {
  ...
  /**
   * The state or province code. If state or province codes are used in your marketplace, it is
   * recommended that you include one with your request. This helps Amazon to select the most
  ...
  @Schema(
      required = true,
      description =
          "The state or province code.  If state or province codes are used in your marketplace, it"
              + " is recommended that you include one with your request. This helps Amazon to"
              + " select the most appropriate Amazon fulfillment center for your inbound shipment"
              + " plan.")
  ...
  /**
   * The postal code. If postal codes are used in your marketplace, we recommended that you include
   * one with your request. This helps Amazon select the most appropriate Amazon fulfillment center
   * for the inbound shipment plan.
   *
   * @return postalCode
   */
  @Schema(
      ...
      description =
          "The postal code.  If postal codes are used in your marketplace, we recommended that you"
              + " include one with your request. This helps Amazon select the most appropriate"
              + " Amazon fulfillment center for the inbound shipment plan.")
