...
/**
 * Represents the confirmation details of a shipment, including the purchase order number and other
 * shipment details.
 */
@Schema(
    description =
        "Represents the confirmation details of a shipment, including the purchase order number and"
...
public class ShipmentConfirmation {
  ...
  /**
   * Provide the details of the items in this shipment. If any of the item details field is common
   * at a package or a pallet level, then provide them at the corresponding package.
   *
   * @return items
   */
  @Schema(
      required = true,
      description =
          "Provide the details of the items in this shipment. If any of the item details field is"
              + " common at a package or a pallet level, then provide them at the corresponding"
              + " package.")
  ...
  public int hashCode() {
    return Objects.hash(
        purchaseOrderNumber, shipmentDetails, sellingParty, shipFromParty, items, containers);
  }
