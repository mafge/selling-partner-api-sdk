...
public class Recurrence {
  ...
  /**
   * Days of the week when recurrence is valid. If the schedule is valid every Monday, input will
   * only contain &#x60;MONDAY&#x60; in the list.
   *
   * @return daysOfWeek
   */
  @Schema(
      description =
          "Days of the week when recurrence is valid. If the schedule is valid every Monday, input"
              + " will only contain `MONDAY` in the list.")
