...
/**
 * Contains information pertaining to the placement of the contents of an inbound plan and the
 * related costs.
 */
@Schema(
    description =
        "Contains information pertaining to the placement of the contents of an inbound plan and"
            + " the related costs.")
