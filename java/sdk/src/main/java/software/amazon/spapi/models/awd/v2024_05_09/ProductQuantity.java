...
public class ProductQuantity {
  ...
  /**
   * Contains attributes for this instance of the product. For example, item color, or other
   * attributes that distinguish the product beyond the SKU. This is metadata for the product and
  ...
  @Schema(
      ...
      description =
          "Contains attributes for this instance of the product. For example, item color, or other"
              + " attributes that distinguish the product beyond the SKU. This is metadata for the"
              + " product and Amazon does not process this data.")
  ...
  /**
   * The expiration date for the SKU. Values are in [ISO
