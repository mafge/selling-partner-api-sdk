...
/**
 * Labeling requirements for the item. For more information about FBA labeling requirements, see the
...
public enum BarcodeInstruction {
  ...
  public static class Adapter extends TypeAdapter<BarcodeInstruction> {
    @Override
    public void write(final JsonWriter jsonWriter, final BarcodeInstruction enumeration)
        throws IOException {
