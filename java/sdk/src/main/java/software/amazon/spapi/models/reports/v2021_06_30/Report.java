...
public class Report {
  ...
  /**
   * The identifier of the report schedule that created this report (if any). This identifier is
   ...
   * operation to get the information you will need to retrieve the report document&#x27;s contents.
   *
  ...
  @Schema(
      description =
          "The identifier for the report document. Pass this into the `getReportDocument` operation"
              + " to get the information you will need to retrieve the report document's contents.")
