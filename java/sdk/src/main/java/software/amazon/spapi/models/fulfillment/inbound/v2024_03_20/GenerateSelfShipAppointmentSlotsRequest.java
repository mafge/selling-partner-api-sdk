...
public class GenerateSelfShipAppointmentSlotsRequest {
  ...
  /**
   * The desired end date. In [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601)
   * datetime format.
   *
  ...
  /**
   * The desired start date. In [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601)
   * datetime format.
   *
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(
            this.desiredEndDate, generateSelfShipAppointmentSlotsRequest.desiredEndDate)
        && Objects.equals(
            this.desiredStartDate, generateSelfShipAppointmentSlotsRequest.desiredStartDate);
  }
