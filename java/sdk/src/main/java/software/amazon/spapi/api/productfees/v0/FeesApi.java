...
public class FeesApi {
  ...
  private okhttp3.Call getMyFeesEstimateForASINValidateBeforeCall(
    ...
    okhttp3.Call call =
        getMyFeesEstimateForASINCall(body, asin, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Returns the estimated fees for the item indicated by the specified ASIN in the marketplace
   * specified in the request body. You can call &#x60;getMyFeesEstimateForASIN&#x60; for an item on
   * behalf of a selling partner before the selling partner sets the item&#x27;s price. The selling
   * partner can then take estimated fees into account. Each fees request must include an original
   * identifier. This identifier is included in the fees estimate so you can correlate a fees
   * estimate with the original request. **Note:** This identifier value is used to identify an
   * estimate. Actual costs may vary. Search \&quot;fees\&quot; in [Seller
   * Central](https://sellercentral.amazon.com/) and consult the store-specific fee schedule for the
   * most up-to-date information. **Note:** When using the &#x60;getMyFeesEstimateForASIN&#x60;
   * operation with an ASIN, the fee estimates might be different. This is because these estimates
   * use the item&#x27;s catalog size, which might not always match the actual size of the item sent
   * to Amazon. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 1 | 2 | The
  ...
  /**
   * (asynchronously) Returns the estimated fees for the item indicated by the specified ASIN in the
   * marketplace specified in the request body. You can call &#x60;getMyFeesEstimateForASIN&#x60;
   * for an item on behalf of a selling partner before the selling partner sets the item&#x27;s
   * price. The selling partner can then take estimated fees into account. Each fees request must
   * include an original identifier. This identifier is included in the fees estimate so you can
   * correlate a fees estimate with the original request. **Note:** This identifier value is used to
   * identify an estimate. Actual costs may vary. Search \&quot;fees\&quot; in [Seller
   * Central](https://sellercentral.amazon.com/) and consult the store-specific fee schedule for the
   * most up-to-date information. **Note:** When using the &#x60;getMyFeesEstimateForASIN&#x60;
   * operation with an ASIN, the fee estimates might be different. This is because these estimates
   * use the item&#x27;s catalog size, which might not always match the actual size of the item sent
  ...
  public okhttp3.Call getMyFeesEstimateForASINAsync(
    ...
    okhttp3.Call call =
        getMyFeesEstimateForASINValidateBeforeCall(
            body, asin, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetMyFeesEstimateResponse>() {}.getType();
   ...
   *
   * @param body (required)
   * @param sellerSKU Used to identify an item in the given marketplace. SellerSKU is qualified by
   *     the seller&#x27;s SellerId, which is included with every operation that you submit.
   *     (required)
   * @param progressListener Progress listener
   * @param progressRequestListener Progress request listener
   * @return Call to execute
  ...
  private okhttp3.Call getMyFeesEstimateForSKUValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling getMyFeesEstimateForSKU(Async)");
    }
    ...
    okhttp3.Call call =
        getMyFeesEstimateForSKUCall(body, sellerSKU, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Returns the estimated fees for the item indicated by the specified seller SKU in the
   * marketplace specified in the request body. **Note:** The parameters associated with this
   * operation may contain special characters that require URL encoding to call the API. To avoid
   ...
   * &#x60;getMyFeesEstimateForSKU&#x60; for an item on behalf of a selling partner before the
   * selling partner sets the item&#x27;s price. The selling partner can then take any estimated
   * fees into account. Each fees estimate request must include an original identifier. This
   * identifier is included in the fees estimate so that you can correlate a fees estimate with the
   * original request. **Note:** This identifier value is used to identify an estimate. Actual costs
   * may vary. Search \&quot;fees\&quot; in [Seller Central](https://sellercentral.amazon.com/) and
   * consult the store-specific fee schedule for the most up-to-date information. **Note:** When
   * sellers use the &#x60;getMyFeesEstimateForSKU&#x60; operation with their &#x60;SellerSKU&#x60;,
   * they get accurate fees based on real item measurements, but only after they&#x27;ve sent their
   * items to Amazon. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 1 | 2
  ...
  /**
   * (asynchronously) Returns the estimated fees for the item indicated by the specified seller SKU
   * in the marketplace specified in the request body. **Note:** The parameters associated with this
   * operation may contain special characters that require URL encoding to call the API. To avoid
   * errors with SKUs when encoding URLs, refer to [URL
   * Encoding](https://developer-docs.amazon.com/sp-api/docs/url-encoding). You can call
   * &#x60;getMyFeesEstimateForSKU&#x60; for an item on behalf of a selling partner before the
  ...
  public okhttp3.Call getMyFeesEstimateForSKUAsync(
    ...
    okhttp3.Call call =
        getMyFeesEstimateForSKUValidateBeforeCall(
            body, sellerSKU, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetMyFeesEstimateResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
  ...
  private okhttp3.Call getMyFeesEstimatesValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling getMyFeesEstimates(Async)");
    }
  ...
  /**
   * Returns the estimated fees for a list of products. **Usage Plan:** | Rate (requests per second)
   * | Burst | | ---- | ---- | | 0.5 | 1 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header
  ...
  public ApiResponse<GetMyFeesEstimatesResponse> getMyFeesEstimatesWithHttpInfo(
      List<FeesEstimateByIdRequest> body) throws ApiException, LWAException {
  ...
  /**
   * (asynchronously) Returns the estimated fees for a list of products. **Usage Plan:** | Rate
  ...
  public okhttp3.Call getMyFeesEstimatesAsync(
    ...
    okhttp3.Call call =
        getMyFeesEstimatesValidateBeforeCall(body, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetMyFeesEstimatesResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
