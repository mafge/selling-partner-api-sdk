...
public class CarrierDetails {
  ...
  /**
   * The field is also known as PRO number is a unique number assigned by the carrier. It is used to
   * identify and track the shipment that goes out for delivery. This field is mandatory for US, CA,
  ...
  @Schema(
      description =
          "The field is also known as PRO number is a unique number assigned by the carrier. It is"
              + " used to identify and track the shipment that goes out for delivery. This field is"
              + " mandatory for US, CA, MX shipment confirmations.")
