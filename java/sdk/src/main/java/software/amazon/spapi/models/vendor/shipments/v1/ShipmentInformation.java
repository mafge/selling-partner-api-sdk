...
public class ShipmentInformation {
  ...
  /**
   * The buyer reference number is a unique identifier generated by the buyer for all Collect and
   * WePay shipments.
   *
  ...
  @Schema(
      description =
          "The buyer reference number is a unique identifier generated by the buyer for all Collect"
              + " and WePay shipments.")
  ...
  @Schema(
      description =
          "Vendor Warehouse ID from where the shipment is scheduled to be picked up by buyer /"
              + " Carrier.")
