...
public class FbaInventoryApi {
   ...
   * @param xAmznIdempotencyToken A unique token/requestId provided with each call to ensure
   ...
   */
  public okhttp3.Call addInventoryCall(
    ...
    if (xAmznIdempotencyToken != null)
      localVarHeaderParams.put(
          "x-amzn-idempotency-token", apiClient.parameterToString(xAmznIdempotencyToken));
  ...
  private okhttp3.Call addInventoryValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling addInventory(Async)");
    }
    // verify the required parameter 'xAmznIdempotencyToken' is set
    if (xAmznIdempotencyToken == null) {
      throw new ApiException(
          "Missing the required parameter 'xAmznIdempotencyToken' when calling"
              + " addInventory(Async)");
    }

    okhttp3.Call call =
        addInventoryCall(body, xAmznIdempotencyToken, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Requests that Amazon add items to the Sandbox Inventory with desired amount of quantity in the
   * sandbox environment. This is a sandbox-only operation and must be directed to a sandbox
  ...
  /**
   * (asynchronously) Requests that Amazon add items to the Sandbox Inventory with desired amount of
   * quantity in the sandbox environment. This is a sandbox-only operation and must be directed to a
  ...
  public okhttp3.Call addInventoryAsync(
    ...
    okhttp3.Call call =
        addInventoryValidateBeforeCall(
            body, xAmznIdempotencyToken, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<AddInventoryResponse>() {}.getType();
   ...
   * @throws LWAException If calls to fetch LWA access token fails
   */
  public okhttp3.Call createInventoryItemCall(
  ...
  private okhttp3.Call createInventoryItemValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling createInventoryItem(Async)");
    }
  ...
  public ApiResponse<CreateInventoryItemResponse> createInventoryItemWithHttpInfo(
      CreateInventoryItemRequest body) throws ApiException, LWAException {
  ...
  /**
   * (asynchronously) Requests that Amazon create product-details in the Sandbox Inventory in the
   * sandbox environment. This is a sandbox-only operation and must be directed to a sandbox
   * endpoint. Refer to [Selling Partner API
   * sandbox](https://developer-docs.amazon.com/sp-api/docs/the-selling-partner-api-sandbox) for
   * more information.
  ...
  public okhttp3.Call createInventoryItemAsync(
    ...
    okhttp3.Call call =
        createInventoryItemValidateBeforeCall(body, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<CreateInventoryItemResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
   ...
   *
   * @param sellerSku A single seller SKU used for querying the specified seller SKU inventory
   *     summaries. (required)
   * @param marketplaceId The marketplace ID for the marketplace for which the sellerSku is to be
   *     deleted. (required)
   * @param progressListener Progress listener
   * @param progressRequestListener Progress request listener
   * @return Call to execute
   ...
   * @throws LWAException If calls to fetch LWA access token fails
   */
  public okhttp3.Call deleteInventoryItemCall(
      String sellerSku,
   ...
   * This is a sandbox-only operation and must be directed to a sandbox endpoint. Refer to [Selling
   * Partner API
   * sandbox](https://developer-docs.amazon.com/sp-api/docs/the-selling-partner-api-sandbox) for
   * more information.
   *
  ...
  /**
   * (asynchronously) Requests that Amazon Deletes an item from the Sandbox Inventory in the sandbox
   * environment. This is a sandbox-only operation and must be directed to a sandbox endpoint. Refer
   * to [Selling Partner API
   * sandbox](https://developer-docs.amazon.com/sp-api/docs/the-selling-partner-api-sandbox) for
   * more information.
  ...
  public okhttp3.Call deleteInventoryItemAsync(
    ...
    okhttp3.Call call =
        deleteInventoryItemValidateBeforeCall(
            sellerSku, marketplaceId, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<DeleteInventoryItemResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
   ...
   * @param marketplaceIds The marketplace ID for the marketplace for which to return inventory
   *     summaries. (required)
   * @param details true to return inventory summaries with additional summarized inventory details
   *     and quantities. Otherwise, returns inventory summaries only (default value). (optional,
   *     default to false)
   * @param startDateTime A start date and time in ISO8601 format. If specified, all inventory
   *     summaries that have changed since then are returned. You must specify a date and time that
   *     is no earlier than 18 months prior to the date and time when you call the API. Note:
   *     Changes in inboundWorkingQuantity, inboundShippedQuantity and inboundReceivingQuantity are
   *     not detected. (optional)
   * @param sellerSkus A list of seller SKUs for which to return inventory summaries. You may
   *     specify up to 50 SKUs. (optional)
   * @param sellerSku A single seller SKU used for querying the specified seller SKU inventory
   *     summaries. (optional)
   * @param nextToken String token returned in the response of your previous request. The string
   *     token will expire 30 seconds after being created. (optional)
   * @param progressListener Progress listener
   * @param progressRequestListener Progress request listener
   * @return Call to execute
   * @throws ApiException If fail to serialize the request body object
   * @throws LWAException If calls to fetch LWA access token fails
   */
  public okhttp3.Call getInventorySummariesCall(
    ...
    if (sellerSkus != null)
      localVarCollectionQueryParams.addAll(
          apiClient.parameterToPairs("csv", "sellerSkus", sellerSkus));
    if (sellerSku != null)
  ...
  private okhttp3.Call getInventorySummariesValidateBeforeCall(
    ...
    if (granularityType == null) {
      throw new ApiException(
          "Missing the required parameter 'granularityType' when calling"
              + " getInventorySummaries(Async)");
    }
    // verify the required parameter 'granularityId' is set
    if (granularityId == null) {
      throw new ApiException(
          "Missing the required parameter 'granularityId' when calling"
              + " getInventorySummaries(Async)");
    }
  ...
  /**
   * Returns a list of inventory summaries. The summaries returned depend on the presence or absence
   * of the startDateTime, sellerSkus and sellerSku parameters: - All inventory summaries with
   * available details are returned when the startDateTime, sellerSkus and sellerSku parameters are
   * omitted. - When startDateTime is provided, the operation returns inventory summaries that have
   * had changes after the date and time specified. The sellerSkus and sellerSku parameters are
   * ignored. Important: To avoid errors, use both startDateTime and nextToken to get the next page
   * of inventory summaries that have changed after the date and time specified. - When the
   * sellerSkus parameter is provided, the operation returns inventory summaries for only the
   * specified sellerSkus. The sellerSku parameter is ignored. - When the sellerSku parameter is
   * provided, the operation returns inventory summaries for only the specified sellerSku. Note: The
   ...
   * (requests per second) | Burst | | ---- | ---- | | 2 | 2 | The x-amzn-RateLimit-Limit response
  ...
  public GetInventorySummariesResponse getInventorySummaries(
      ...
      String nextToken)
      throws ApiException, LWAException {
    ApiResponse<GetInventorySummariesResponse> resp =
  ...
  public ApiResponse<GetInventorySummariesResponse> getInventorySummariesWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        getInventorySummariesValidateBeforeCall(
            granularityType,
            granularityId,
            marketplaceIds,
            details,
  ...
  /**
   * (asynchronously) Returns a list of inventory summaries. The summaries returned depend on the
   * presence or absence of the startDateTime, sellerSkus and sellerSku parameters: - All inventory
   * summaries with available details are returned when the startDateTime, sellerSkus and sellerSku
   * parameters are omitted. - When startDateTime is provided, the operation returns inventory
   * summaries that have had changes after the date and time specified. The sellerSkus and sellerSku
   * parameters are ignored. Important: To avoid errors, use both startDateTime and nextToken to get
   * the next page of inventory summaries that have changed after the date and time specified. -
   * When the sellerSkus parameter is provided, the operation returns inventory summaries for only
   * the specified sellerSkus. The sellerSku parameter is ignored. - When the sellerSku parameter is
   * provided, the operation returns inventory summaries for only the specified sellerSku. Note: The
   * parameters associated with this operation may contain special characters that must be encoded
   * to successfully call the API. To avoid errors with SKUs when encoding URLs, refer to [URL
   * Encoding](https://developer-docs.amazon.com/sp-api/docs/url-encoding). Usage Plan: | Rate
