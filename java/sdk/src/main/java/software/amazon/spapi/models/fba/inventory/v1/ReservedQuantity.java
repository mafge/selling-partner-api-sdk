...
public class ReservedQuantity {
  ...
  /**
   * The total number of units in Amazon&#x27;s fulfillment network that are currently being picked,
  ...
  @Schema(
      description =
          "The total number of units in Amazon's fulfillment network that are currently being"
              + " picked, packed, and shipped; or are sidelined for measurement, sampling, or other"
              + " internal processes.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.totalReservedQuantity, reservedQuantity.totalReservedQuantity)
        && Objects.equals(
            this.pendingCustomerOrderQuantity, reservedQuantity.pendingCustomerOrderQuantity)
        && Objects.equals(
            this.pendingTransshipmentQuantity, reservedQuantity.pendingTransshipmentQuantity)
