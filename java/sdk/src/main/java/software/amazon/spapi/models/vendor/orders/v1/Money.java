...
/**
 * An amount of money. Includes the currency code and an optional unit of measure for items priced
 * by weight.
 */
@Schema(
    description =
        "An amount of money. Includes the currency code and an optional unit of measure for items"
            + " priced by weight.")
public class Money {
  ...
  /**
   * The unit of measure for prices of items sold by weight. If this field is absent, the item is
   * sold by eaches.
   */
  ...
  @Schema(
      description =
          "The unit of measure for prices of items sold by weight. If this field is absent, the"
              + " item is sold by eaches.")
