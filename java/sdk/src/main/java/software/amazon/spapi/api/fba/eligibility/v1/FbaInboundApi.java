...
public class FbaInboundApi {
   ...
   * @param marketplaceIds The identifier for the marketplace in which you want to determine
   *     eligibility. Required only when program&#x3D;INBOUND. (optional)
  ...
  /**
   * This operation gets an eligibility preview for an item that you specify. You can specify the
   * type of eligibility preview that you want (INBOUND or COMMINGLING). For INBOUND previews, you
   * can specify the marketplace in which you want to determine the item&#x27;s eligibility. **Usage
  ...
  public ApiResponse<GetItemEligibilityPreviewResponse> getItemEligibilityPreviewWithHttpInfo(
      String asin, String program, List<String> marketplaceIds) throws ApiException, LWAException {
    okhttp3.Call call =
        getItemEligibilityPreviewValidateBeforeCall(asin, program, marketplaceIds, null, null);
    Type localVarReturnType = new TypeToken<GetItemEligibilityPreviewResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) This operation gets an eligibility preview for an item that you specify. You
   * can specify the type of eligibility preview that you want (INBOUND or COMMINGLING). For INBOUND
   * previews, you can specify the marketplace in which you want to determine the item&#x27;s
   * eligibility. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 1 | 1 |
  ...
  public okhttp3.Call getItemEligibilityPreviewAsync(
    ...
    okhttp3.Call call =
        getItemEligibilityPreviewValidateBeforeCall(
            asin, program, marketplaceIds, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetItemEligibilityPreviewResponse>() {}.getType();
