...
/**
 * The A+ Content standard image and text block, with a related caption. The caption might not
 * display on all devices.
 */
@Schema(
    description =
        "The A+ Content standard image and text block, with a related caption. The caption might"
