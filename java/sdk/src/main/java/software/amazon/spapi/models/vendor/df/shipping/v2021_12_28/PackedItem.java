...
public class PackedItem {
  ...
  @Schema(
      required = true,
      description =
          "The sequence number of the item. The number must be the same as the order number of the"
              + " item.")
  ...
  /**
   * The piece number of the item in this container. This is required when the item is split across
  ...
  @Schema(
      description =
          "The piece number of the item in this container. This is required when the item is split"
  ...
  /**
   * An item&#x27;s product identifier, which the vendor selects. This identifier should be the same
   * as the identifier, such as a SKU, in the purchase order.
   *
   * @return vendorProductIdentifier
   */
  @Schema(
      description =
          "An item's product identifier, which the vendor selects. This identifier should be the"
              + " same as the identifier, such as a SKU, in the purchase order.")
