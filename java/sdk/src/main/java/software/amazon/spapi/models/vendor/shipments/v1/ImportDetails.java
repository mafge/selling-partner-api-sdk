...
public class ImportDetails {
  /**
   * This is used for import purchase orders only. If the recipient requests, this field will
  ...
  @Schema(
      description =
          "Types and numbers of container(s) for import purchase orders. Can be a comma-separated"
              + " list if shipment has multiple containers.")
  ...
  /**
   * Date on which the shipment is expected to be shipped. This value should not be in the past and
  ...
  @Schema(
      description =
          "Date on which the shipment is expected to be shipped. This value should not be in the"
              + " past and not more than 60 days out in the future.")
