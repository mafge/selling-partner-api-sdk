...
public class FixedSlotCapacity {
  ...
  /**
   * The duration of each slot which is returned. This value will be a multiple of 5 and fall in the
   * following range: 5 &lt;&#x3D; &#x60;slotDuration&#x60; &lt;&#x3D; 360.
   *
   * @return slotDuration
   */
  @Schema(
      description =
          "The duration of each slot which is returned. This value will be a multiple of 5 and fall"
              + " in the following range: 5 <= `slotDuration` <= 360.")
