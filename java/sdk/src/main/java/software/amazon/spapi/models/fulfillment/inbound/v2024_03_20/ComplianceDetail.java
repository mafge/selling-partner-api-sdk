...
public class ComplianceDetail {
  ...
  /**
   * The Fulfillment Network SKU, which identifies a real fulfillable item with catalog data and
   * condition.
   *
   * @return fnsku
   */
  @Schema(
      description =
          "The Fulfillment Network SKU, which identifies a real fulfillable item with catalog data"
              + " and condition.")
