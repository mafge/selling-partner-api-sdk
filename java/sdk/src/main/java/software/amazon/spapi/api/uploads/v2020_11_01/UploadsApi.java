...
public class UploadsApi {
   ...
   *
   * @param marketplaceIds The marketplace ID is the globally unique identifier of a marketplace. To
   ...
   * @param contentMD5 An MD5 hash of the content to be submitted to the upload destination. This
   *     value is used to determine if the data has been corrupted or tampered with during transit.
   *     (required)
   * @param resource The upload destination for your resource. For example, if you create an upload
   *     destination for the &#x60;createLegalDisclosure&#x60; operation of the Messaging API, the
   *     &#x60;{resource}&#x60; would be
   *     &#x60;/messaging/v1/orders/{amazonOrderId}/messages/legalDisclosure&#x60;, and the entire
   *     path would be
   *     &#x60;/uploads/2020-11-01/uploadDestinations/messaging/v1/orders/{amazonOrderId}/messages/legalDisclosure&#x60;.
   *     If you create an upload destination for an Aplus content document, the
   *     &#x60;{resource}&#x60; would be &#x60;aplus/2020-11-01/contentDocuments&#x60; and the path
   *     would be
  ...
  private okhttp3.Call createUploadDestinationForResourceValidateBeforeCall(
    ...
    if (marketplaceIds == null) {
      throw new ApiException(
          "Missing the required parameter 'marketplaceIds' when calling"
              + " createUploadDestinationForResource(Async)");
    }
    // verify the required parameter 'contentMD5' is set
    if (contentMD5 == null) {
      throw new ApiException(
          "Missing the required parameter 'contentMD5' when calling"
              + " createUploadDestinationForResource(Async)");
    }
    ...
    okhttp3.Call call =
        createUploadDestinationForResourceCall(
            marketplaceIds,
            contentMD5,
            resource,
            contentType,
   ...
   * destination and to programmatically access the file. **Usage Plan:** | Rate (requests per
  ...
  public CreateUploadDestinationResponse createUploadDestinationForResource(
    ...
    ApiResponse<CreateUploadDestinationResponse> resp =
        createUploadDestinationForResourceWithHttpInfo(
            marketplaceIds, contentMD5, resource, contentType);
    return resp.getData();
  }
   ...
   * @throws LWAException If calls to fetch LWA access token fails
   */
  public ApiResponse<CreateUploadDestinationResponse>
      createUploadDestinationForResourceWithHttpInfo(
          List<String> marketplaceIds, String contentMD5, String resource, String contentType)
          throws ApiException, LWAException {
    okhttp3.Call call =
        createUploadDestinationForResourceValidateBeforeCall(
  ...
  /**
   * (asynchronously) Creates an upload destination, returning the information required to upload a
   * file to the destination and to programmatically access the file. **Usage Plan:** | Rate
