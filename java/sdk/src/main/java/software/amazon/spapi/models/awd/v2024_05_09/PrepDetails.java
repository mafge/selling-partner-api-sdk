...
/**
 * The preparation details for a product. This contains the prep category, prep owner, and label
 * owner. Prep instructions are generated based on the specified category.
 */
@Schema(
    description =
        "The preparation details for a product. This contains the prep category, prep owner, and"
            + " label owner. Prep instructions are generated based on the specified category.")
public class PrepDetails {
  ...
  /**
   * Contains information about the preparation of the inbound products. The system auto-generates
   * this field with the use of the &#x60;prepCategory&#x60;, and if you attempt to pass a value for
  ...
  @Schema(
      description =
          "Contains information about the preparation of the inbound products. The system"
              + " auto-generates this field with the use of the `prepCategory`, and if you attempt"
              + " to pass a value for this field, the system will ignore it.")
