...
public class CompetitivePriceType {
  ...
  /**
   * The pricing model for each price that is returned. Possible values: * 1 - New Buy Box Price. *
  ...
  @Schema(
      required = true,
      description =
          "The pricing model for each price that is returned.  Possible values:  * 1 - New Buy Box"
              + " Price. * 2 - Used Buy Box Price.")
  ...
  @Schema(
      description =
          "Indicates the condition of the item whose pricing information is returned. Possible"
              + " values are: New, Used, Collectible, Refurbished, or Club.")
  ...
  /**
   * Indicates the subcondition of the item whose pricing information is returned. Possible values
   * are: New, Mint, Very Good, Good, Acceptable, Poor, Club, OEM, Warranty, Refurbished Warranty,
  ...
  @Schema(
      description =
          "Indicates the subcondition of the item whose pricing information is returned. Possible"
              + " values are: New, Mint, Very Good, Good, Acceptable, Poor, Club, OEM, Warranty,"
  ...
  /**
   * Indicates whether or not the pricing information is for an offer listing that belongs to the
   * requester. The requester is the seller associated with the SellerId that was submitted with the
   * request. Possible values are: true and false.
   *
  ...
  @Schema(
      description =
          " Indicates whether or not the pricing information is for an offer listing that belongs"
              + " to the requester. The requester is the seller associated with the SellerId that"
              + " was submitted with the request. Possible values are: true and false.")
