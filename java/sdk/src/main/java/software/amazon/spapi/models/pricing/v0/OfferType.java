...
public class OfferType {
  ...
  public OfferType addQuantityDiscountPricesItem(
      QuantityDiscountPriceType quantityDiscountPricesItem) {
  ...
  /**
   * List of &#x60;QuantityDiscountPrice&#x60; that contains item&#x27;s pricing information when
   * buy in bulk.
   *
  ...
  @Schema(
      description =
          "List of `QuantityDiscountPrice` that contains item's pricing information when buy in"
              + " bulk.")
  ...
  /**
   * The fulfillment channel for the offer listing. Possible values: * Amazon - Fulfilled by Amazon.
  ...
  @Schema(
      required = true,
      description =
          "The fulfillment channel for the offer listing. Possible values:  * Amazon - Fulfilled by"
              + " Amazon. * Merchant - Fulfilled by the seller.")
  ...
  /**
   * The item condition for the offer listing. Possible values: New, Used, Collectible, Refurbished,
   * or Club.
   *
  ...
  /**
   * The item subcondition for the offer listing. Possible values: New, Mint, Very Good, Good,
  ...
  @Schema(
      ...
      description =
          "The item subcondition for the offer listing. Possible values: New, Mint, Very Good,"
              + " Good, Acceptable, Poor, Club, OEM, Warranty, Refurbished Warranty, Refurbished,"
              + " Open Box, or Other.")
