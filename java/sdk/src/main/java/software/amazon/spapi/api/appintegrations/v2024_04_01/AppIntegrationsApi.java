...
public class AppIntegrationsApi {
  ...
  private okhttp3.Call createNotificationValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling createNotification(Async)");
    }
  ...
  /**
   * Create a notification for sellers in Seller Central. **Usage Plan:** | Rate (requests per
   ...
   * Sellers whose business demands require higher throughput may have higher rate and burst values
  ...
  public ApiResponse<CreateNotificationResponse> createNotificationWithHttpInfo(
      CreateNotificationRequest body) throws ApiException, LWAException {
  ...
  /**
   * (asynchronously) Create a notification for sellers in Seller Central. **Usage Plan:** | Rate
   ...
   * rate and burst values for this operation. Sellers whose business demands require higher
  ...
  public okhttp3.Call createNotificationAsync(
    ...
    okhttp3.Call call =
        createNotificationValidateBeforeCall(body, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<CreateNotificationResponse>() {}.getType();
  ...
  private okhttp3.Call deleteNotificationsValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling deleteNotifications(Async)");
    }
  ...
  /**
   * (asynchronously) Remove your application&#x27;s notifications from the Appstore notifications
   * dashboard. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 1 | 5 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The preceding table indicates the default
   * rate and burst values for this operation. Sellers whose business demands require higher
   * throughput may have higher rate and burst values than those shown here. For more information,
  ...
  public okhttp3.Call deleteNotificationsAsync(
      DeleteNotificationsRequest body, final ApiCallback<Void> callback)
      throws ApiException, LWAException {
    ...
    okhttp3.Call call =
        deleteNotificationsValidateBeforeCall(body, progressListener, progressRequestListener);
  ...
  private okhttp3.Call recordActionFeedbackValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling recordActionFeedback(Async)");
    }
    // verify the required parameter 'notificationId' is set
    if (notificationId == null) {
      throw new ApiException(
          "Missing the required parameter 'notificationId' when calling"
              + " recordActionFeedback(Async)");
    }

    okhttp3.Call call =
        recordActionFeedbackCall(body, notificationId, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Records the seller&#x27;s response to a notification. **Usage Plan:** | Rate (requests per
   * second) | Burst | | ---- | ---- | | 1 | 5 | The &#x60;x-amzn-RateLimit-Limit&#x60; response
   * header returns the usage plan rate limits that were applied to the requested operation, when
   * available. The preceding table indicates the default rate and burst values for this operation.
   * Sellers whose business demands require higher throughput may have higher rate and burst values
  ...
  public ApiResponse<Void> recordActionFeedbackWithHttpInfo(
      RecordActionFeedbackRequest body, String notificationId) throws ApiException, LWAException {
    okhttp3.Call call = recordActionFeedbackValidateBeforeCall(body, notificationId, null, null);
    return apiClient.execute(call);
  }

  /**
   * (asynchronously) Records the seller&#x27;s response to a notification. **Usage Plan:** | Rate
   * (requests per second) | Burst | | ---- | ---- | | 1 | 5 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The preceding table indicates the default
   * rate and burst values for this operation. Sellers whose business demands require higher
  ...
  public okhttp3.Call recordActionFeedbackAsync(
    ...
    okhttp3.Call call =
        recordActionFeedbackValidateBeforeCall(
            body, notificationId, progressListener, progressRequestListener);
    apiClient.executeAsync(call, callback);
    return call;
  }
