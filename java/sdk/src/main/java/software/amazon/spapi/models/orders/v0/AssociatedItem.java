...
/**
 * An item that is associated with an order item. For example, a tire installation service that is
 * purchased with tires.
 */
@Schema(
    description =
        "An item that is associated with an order item. For example, a tire installation service"
            + " that is purchased with tires.")
