...
/**
 * Represents the request payload for creating a shipping label, containing the purchase order
 * number, selling party, ship from party, and a list of containers or packages in the shipment.
 */
@Schema(
    description =
        "Represents the request payload for creating a shipping label, containing the purchase"
            + " order number, selling party, ship from party, and a list of containers or packages"
            + " in the shipment.")
