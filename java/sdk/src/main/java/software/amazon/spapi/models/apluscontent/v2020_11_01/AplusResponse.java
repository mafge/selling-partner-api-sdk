...
/**
 * The base response data for all A+ Content operations when a request is successful or partially
 * successful. Individual operations can extend this with additional data.
 */
@Schema(
    description =
        "The base response data for all A+ Content operations when a request is successful or"
            + " partially successful. Individual operations can extend this with additional data.")
