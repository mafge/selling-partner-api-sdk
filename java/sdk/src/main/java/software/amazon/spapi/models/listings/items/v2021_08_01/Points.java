...
/**
 * The number of Amazon Points offered with the purchase of an item, and their monetary value. Note
 * that the &#x60;Points&#x60; element is only returned in Japan (JP).
 */
@Schema(
    description =
        "The number of Amazon Points offered with the purchase of an item, and their monetary"
            + " value. Note that the `Points` element is only returned in Japan (JP).")
public class Points {
