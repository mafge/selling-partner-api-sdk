...
public class CollectFreightPickupDetails {
  ...
  /**
   * Date on which the items can be picked up from vendor warehouse by Buyer used for WePay/Collect
   * vendors.
   *
  ...
  @Schema(
      description =
          "Date on which the items can be picked up from vendor warehouse by Buyer used for"
  ...
  /**
   * Date on which the items are scheduled to be picked from vendor warehouse by Buyer used for
   * WePay/Collect vendors.
   *
  ...
  @Schema(
      description =
          "Date on which the items are scheduled to be picked from vendor warehouse by Buyer used"
  ...
  /**
   * Date on which the carrier is being scheduled to pickup items from vendor warehouse by Byer used
   * for WePay/Collect vendors.
   *
  ...
  @Schema(
      description =
          "Date on which the carrier is being scheduled to pickup items from vendor warehouse by"
              + " Byer used for WePay/Collect vendors.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.requestedPickUp, collectFreightPickupDetails.requestedPickUp)
        ...
        && Objects.equals(
            this.carrierAssignmentDate, collectFreightPickupDetails.carrierAssignmentDate);
  }
