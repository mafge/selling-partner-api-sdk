...
/**
 * Request schema for the &#x60;getRangeSlotCapacity&#x60; operation. This schema is used to define
 * the time range and capacity types that are being queried.
 */
@Schema(
    description =
        "Request schema for the `getRangeSlotCapacity` operation. This schema is used to define the"
            + " time range and capacity types that are being queried.")
