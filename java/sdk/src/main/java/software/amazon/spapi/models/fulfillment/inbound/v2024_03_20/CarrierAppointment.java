...
/**
 * Contains details for a transportation carrier appointment. This appointment is vended out by
 * Amazon and is an indicator for when a transportation carrier is accepting shipments to be picked
 * up.
 */
@Schema(
    description =
        "Contains details for a transportation carrier appointment. This appointment is vended out"
            + " by Amazon and is an indicator for when a transportation carrier is accepting"
            + " shipments to be picked up.")
