...
public class InboundPlan {
  ...
  @Schema(
      ...
      description =
          "The time at which the inbound plan was created. In [ISO"
              + " 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) datetime with"
  ...
  @Schema(
      ...
      description =
          "The time at which the inbound plan was last updated. In [ISO"
              ...
              + " with pattern `yyyy-MM-ddTHH:mm:ssZ`.")
  ...
  /**
   * Packing options for the inbound plan. This property will be populated when it has been
   * generated via the corresponding operation. If there is a chosen placement option, only packing
   * options for that placement option will be returned. If there are confirmed shipments, only
   * packing options for those shipments will be returned. Query the packing option for more
   * details.
   *
  ...
  @Schema(
      description =
          "Packing options for the inbound plan. This property will be populated when it has been"
              + " generated via the corresponding operation. If there is a chosen placement option,"
              + " only packing options for that placement option will be returned. If there are"
              + " confirmed shipments, only packing options for those shipments will be returned."
  ...
  /**
   * Placement options for the inbound plan. This property will be populated when it has been
   * generated via the corresponding operation. If there is a chosen placement option, that will be
   * the only returned option. Query the placement option for more details.
   *
  ...
  @Schema(
      description =
          "Placement options for the inbound plan. This property will be populated when it has been"
              + " generated via the corresponding operation. If there is a chosen placement option,"
              + " that will be the only returned option. Query the placement option for more"
              + " details.")
  ...
  /**
   * A list of shipment IDs for the inbound plan. This property is populated when it has been
   * generated with the &#x60;confirmPlacementOptions&#x60; operation. Only shipments from the
   * chosen placement option are returned. Query the shipment for more details.
   *
   * @return shipments
   */
  @Schema(
