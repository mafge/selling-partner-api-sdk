...
public class OrderAcknowledgementItem {
  ...
  private List<OrderItemAcknowledgement> itemAcknowledgements =
      new ArrayList<OrderItemAcknowledgement>();
  ...
  /**
   * The vendor selected product identification of the item. Should be the same as was sent in the
   * purchase order.
   *
  ...
  @Schema(
      description =
          "The vendor selected product identification of the item. Should be the same as was sent"
  ...
  /**
   * The discount multiplier that should be applied to the price if a vendor sells books with a list
   * price. This is a multiplier factor to arrive at a final discounted price. A multiplier of .90
  ...
  @Schema(
      description =
          "The discount multiplier that should be applied to the price if a vendor sells books with"
              + " a list price. This is a multiplier factor to arrive at a final discounted price."
              + " A multiplier of .90 would be the factor if a 10% discount is given.")
  ...
  public OrderAcknowledgementItem itemAcknowledgements(
      List<OrderItemAcknowledgement> itemAcknowledgements) {
    this.itemAcknowledgements = itemAcknowledgements;
    return this;
  }

  public OrderAcknowledgementItem addItemAcknowledgementsItem(
      OrderItemAcknowledgement itemAcknowledgementsItem) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.itemSequenceNumber, orderAcknowledgementItem.itemSequenceNumber)
        && Objects.equals(
            this.amazonProductIdentifier, orderAcknowledgementItem.amazonProductIdentifier)
        && Objects.equals(
            this.vendorProductIdentifier, orderAcknowledgementItem.vendorProductIdentifier)
