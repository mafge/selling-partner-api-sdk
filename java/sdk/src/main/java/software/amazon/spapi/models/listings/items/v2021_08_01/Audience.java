...
public class Audience {
  ...
  /**
   * Name of the audience an offer is applicable to. Common values: * &#x27;ALL&#x27; - Standard
   * offer audience for buyers on Amazon retail websites. * &#x27;B2B&#x27; - Offer audience for
   * Amazon Business website buyers.
   *
   * @return value
   */
  @Schema(
      ...
      description =
          "Name of the audience an offer is applicable to.   Common values:   * 'ALL' - Standard"
              + " offer audience for buyers on Amazon retail websites.   * 'B2B' - Offer audience"
              + " for Amazon Business website buyers.")
