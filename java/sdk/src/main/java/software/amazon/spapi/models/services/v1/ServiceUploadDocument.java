...
public class ServiceUploadDocument {
  ...
  /**
   * An MD5 hash of the content to be submitted to the upload destination. This value is used to
  ...
  @Schema(
      description =
          "An MD5 hash of the content to be submitted to the upload destination. This value is used"
              + " to determine if the data has been corrupted or tampered with during transit.")
