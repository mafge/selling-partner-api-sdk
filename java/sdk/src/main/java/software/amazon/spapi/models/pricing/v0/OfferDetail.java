...
public class OfferDetail {
  ...
  public OfferDetail quantityDiscountPrices(
      List<QuantityDiscountPriceType> quantityDiscountPrices) {
    this.quantityDiscountPrices = quantityDiscountPrices;
    return this;
  }

  public OfferDetail addQuantityDiscountPricesItem(
  ...
  /**
   * When true, the offer is currently in the Buy Box. There can be up to two Buy Box winners at any
  ...
  @Schema(
      description =
          "When true, the offer is currently in the Buy Box. There can be up to two Buy Box winners"
              + " at any time per ASIN, one that is eligible for Prime and one that is not eligible"
              + " for Prime.")
