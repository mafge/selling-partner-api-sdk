...
public class PaymentMethodDetails {
  ...
  /**
   * The two-letter country code in ISO 3166-1 alpha-2 format. For payment methods in the
   * &#x60;card&#x60; category, the code is for the country where the card was issued. For payment
   * methods in the &#x60;bank account&#x60; category, the code is for the country where the account
   * is located.
   *
   * @return countryCode
   */
  @Schema(
      ...
      description =
          "The two-letter country code in ISO 3166-1 alpha-2 format. For payment methods in the"
              + " `card` category, the code is for the country where the card was issued. For"
              + " payment methods in the `bank account` category, the code is for the country where"
