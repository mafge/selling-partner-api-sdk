...
public class ExportInvoicesRequest {
  ...
  /**
   * The latest invoice creation date for invoices that you want to include in the response. Dates
   * are in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format. The
   * default is the time of the request.
   *
   * @return dateEnd
   */
  @Schema(
      description =
          "The latest invoice creation date for invoices that you want to include in the response."
              + " Dates are in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601)"
              + " date-time format. The default is the time of the request.")
  ...
  /**
   * The earliest invoice creation date for invoices that you want to include in the response. Dates
   * are in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format. The
  ...
  @Schema(
      description =
          "A list of statuses that you can use to filter invoices. Use the `getInvoicesAttributes`"
              + " operation to check invoice status options.  Min count: 1")
  ...
  /**
   * The marketplace-specific classification of the transaction type for which the invoice was
   * created. Use the &#x60;getInvoicesAttributes&#x60; operation to check
  ...
  @Schema(
      description =
          "The marketplace-specific classification of the transaction type for which the invoice"
              + " was created. Use the `getInvoicesAttributes` operation to check `transactionType`"
              + " options")
