...
/**
 * The status of the electronic invoice. Only available for Easy Ship orders and orders in the BR
 * marketplace.
 */
...
public enum ElectronicInvoiceStatus {
  ...
  public static class Adapter extends TypeAdapter<ElectronicInvoiceStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final ElectronicInvoiceStatus enumeration)
        throws IOException {
