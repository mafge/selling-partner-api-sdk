...
public class SupplySourcesApi {
  ...
  public okhttp3.Call archiveSupplySourceCall(
    ...
    String localVarPath =
        "/supplySources/2020-07-01/supplySources/{supplySourceId}"
            .replaceAll(
                "\\{" + "supplySourceId" + "\\}",
                apiClient.escapeString(supplySourceId.toString()));
  ...
  private okhttp3.Call archiveSupplySourceValidateBeforeCall(
    ...
    if (supplySourceId == null) {
      throw new ApiException(
          "Missing the required parameter 'supplySourceId' when calling"
              + " archiveSupplySource(Async)");
    }

    okhttp3.Call call =
        archiveSupplySourceCall(supplySourceId, progressListener, progressRequestListener);
    return call;
  }
  ...
  public okhttp3.Call archiveSupplySourceAsync(
      String supplySourceId, final ApiCallback<ErrorList> callback)
      throws ApiException, LWAException {
    ...
    okhttp3.Call call =
        archiveSupplySourceValidateBeforeCall(
            supplySourceId, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<ErrorList>() {}.getType();
  ...
  private okhttp3.Call createSupplySourceValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling createSupplySource(Async)");
    }
  ...
  public ApiResponse<CreateSupplySourceResponse> createSupplySourceWithHttpInfo(
      CreateSupplySourceRequest body) throws ApiException, LWAException {
  ...
  public okhttp3.Call createSupplySourceAsync(
    ...
    okhttp3.Call call =
        createSupplySourceValidateBeforeCall(body, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<CreateSupplySourceResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
  ...
  private okhttp3.Call getSupplySourceValidateBeforeCall(
    ...
    okhttp3.Call call =
        getSupplySourceCall(supplySourceId, progressListener, progressRequestListener);
    return call;
  }
  ...
  public okhttp3.Call getSupplySourceAsync(
      String supplySourceId, final ApiCallback<SupplySource> callback)
      throws ApiException, LWAException {
    ...
    okhttp3.Call call =
        getSupplySourceValidateBeforeCall(
            supplySourceId, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<SupplySource>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
   ...
   * @param pageSize The number of supply sources to return per paginated request. (optional,
   *     default to 10.0)
   * @param progressListener Progress listener
   * @param progressRequestListener Progress request listener
   * @return Call to execute
  ...
  private okhttp3.Call getSupplySourcesValidateBeforeCall(
    ...
    okhttp3.Call call =
        getSupplySourcesCall(nextPageToken, pageSize, progressListener, progressRequestListener);
    return call;
  }
  ...
  public GetSupplySourcesResponse getSupplySources(String nextPageToken, BigDecimal pageSize)
    ...
    ApiResponse<GetSupplySourcesResponse> resp =
        getSupplySourcesWithHttpInfo(nextPageToken, pageSize);
    return resp.getData();
  }
  ...
  public ApiResponse<GetSupplySourcesResponse> getSupplySourcesWithHttpInfo(
      String nextPageToken, BigDecimal pageSize) throws ApiException, LWAException {
  ...
  public okhttp3.Call getSupplySourcesAsync(
    ...
    okhttp3.Call call =
        getSupplySourcesValidateBeforeCall(
            nextPageToken, pageSize, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetSupplySourcesResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
  ...
  private okhttp3.Call updateSupplySourceValidateBeforeCall(
    ...
    okhttp3.Call call =
        updateSupplySourceCall(supplySourceId, body, progressListener, progressRequestListener);
    return call;
  }
  ...
  public ApiResponse<ErrorList> updateSupplySourceWithHttpInfo(
      String supplySourceId, UpdateSupplySourceRequest body) throws ApiException, LWAException {
  ...
  public okhttp3.Call updateSupplySourceAsync(
    ...
    okhttp3.Call call =
        updateSupplySourceValidateBeforeCall(
  ...
  private okhttp3.Call updateSupplySourceStatusValidateBeforeCall(
    ...
    if (supplySourceId == null) {
      throw new ApiException(
          "Missing the required parameter 'supplySourceId' when calling"
              + " updateSupplySourceStatus(Async)");
    }
  ...
  public ErrorList updateSupplySourceStatus(
      String supplySourceId, UpdateSupplySourceStatusRequest body)
      throws ApiException, LWAException {
  ...
  public ApiResponse<ErrorList> updateSupplySourceStatusWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        updateSupplySourceStatusValidateBeforeCall(supplySourceId, body, null, null);
    Type localVarReturnType = new TypeToken<ErrorList>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }
  ...
  public okhttp3.Call updateSupplySourceStatusAsync(
    ...
    okhttp3.Call call =
        updateSupplySourceStatusValidateBeforeCall(
            supplySourceId, body, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<ErrorList>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
