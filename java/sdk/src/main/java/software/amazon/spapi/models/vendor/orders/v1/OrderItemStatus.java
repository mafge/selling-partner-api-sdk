...
@Schema(
    description =
        "Represents the current status of an order item, including acknowledgement and receiving"
            + " details.")
public class OrderItemStatus {
  ...
  @Schema(
      required = true,
      description =
          "Numbering of the item on the purchase order. The first item will be 1, the second 2, and"
              + " so on.")
  ...
  public OrderItemStatus acknowledgementStatus(
      OrderItemStatusAcknowledgementStatus acknowledgementStatus) {
