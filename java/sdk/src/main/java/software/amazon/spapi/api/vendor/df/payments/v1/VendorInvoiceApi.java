...
public class VendorInvoiceApi {
  ...
  /**
   * Submits one or more invoices for a vendor&#x27;s direct fulfillment orders. **Usage Plan:** |
  ...
  /**
   * (asynchronously) Submits one or more invoices for a vendor&#x27;s direct fulfillment orders.
  ...
  public okhttp3.Call submitInvoiceAsync(
      SubmitInvoiceRequest body, final ApiCallback<SubmitInvoiceResponse> callback)
      throws ApiException, LWAException {
    ...
    okhttp3.Call call =
        submitInvoiceValidateBeforeCall(body, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<SubmitInvoiceResponse>() {}.getType();
