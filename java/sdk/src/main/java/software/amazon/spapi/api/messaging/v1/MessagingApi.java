...
public class MessagingApi {
   ...
   * @param amazonOrderId An Amazon order identifier. This identifies the order for which a message
   *     is sent. (required)
   * @param marketplaceIds A marketplace identifier. This identifies the marketplace in which the
   *     order was placed. You can only specify one marketplace. (required)
  ...
  public okhttp3.Call confirmCustomizationDetailsCall(
    ...
    String localVarPath =
        "/messaging/v1/orders/{amazonOrderId}/messages/confirmCustomizationDetails"
            .replaceAll(
                "\\{" + "amazonOrderId" + "\\}", apiClient.escapeString(amazonOrderId.toString()));
  ...
  private okhttp3.Call confirmCustomizationDetailsValidateBeforeCall(
    ...
    if (amazonOrderId == null) {
      throw new ApiException(
          "Missing the required parameter 'amazonOrderId' when calling"
              + " confirmCustomizationDetails(Async)");
    }
  ...
  /**
   * Sends a message asking a buyer to provide or verify customization details such as name
   * spelling, images, initials, etc. **Usage Plan:** | Rate (requests per second) | Burst | | ----
   * | ---- | | 1 | 5 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header contains the usage
   * plan rate limits for the operation, when available. The preceding table contains the default
   * rate and burst values for this operation. Selling partners whose business demands require
   * higher throughput might have higher rate and burst values than those shown here. For more
   ...
   * @throws LWAException If calls to fetch LWA access token fails
   */
  public ApiResponse<CreateConfirmCustomizationDetailsResponse>
      confirmCustomizationDetailsWithHttpInfo(
          ...
          throws ApiException, LWAException {
    okhttp3.Call call =
        confirmCustomizationDetailsValidateBeforeCall(
            body, amazonOrderId, marketplaceIds, null, null);
    Type localVarReturnType =
        new TypeToken<CreateConfirmCustomizationDetailsResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Sends a message asking a buyer to provide or verify customization details such
   * as name spelling, images, initials, etc. **Usage Plan:** | Rate (requests per second) | Burst |
   * | ---- | ---- | | 1 | 5 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header contains the
   * usage plan rate limits for the operation, when available. The preceding table contains the
   * default rate and burst values for this operation. Selling partners whose business demands
   * require higher throughput might have higher rate and burst values than those shown here. For
  ...
  private okhttp3.Call createAmazonMotorsValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling createAmazonMotors(Async)");
    }
    // verify the required parameter 'amazonOrderId' is set
    if (amazonOrderId == null) {
      throw new ApiException(
  ...
  /**
   * Sends a message to a buyer to provide details about an Amazon Motors order. This message can
   * only be sent by Amazon Motors sellers. **Usage Plan:** | Rate (requests per second) | Burst | |
   * ---- | ---- | | 1 | 5 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header contains the
   * usage plan rate limits for the operation, when available. The preceding table contains the
   * default rate and burst values for this operation. Selling partners whose business demands
   * require higher throughput might have higher rate and burst values than those shown here. For
  ...
  public ApiResponse<CreateAmazonMotorsResponse> createAmazonMotorsWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        createAmazonMotorsValidateBeforeCall(body, amazonOrderId, marketplaceIds, null, null);
    Type localVarReturnType = new TypeToken<CreateAmazonMotorsResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Sends a message to a buyer to provide details about an Amazon Motors order.
   * This message can only be sent by Amazon Motors sellers. **Usage Plan:** | Rate (requests per
   * second) | Burst | | ---- | ---- | | 1 | 5 | The &#x60;x-amzn-RateLimit-Limit&#x60; response
   * header contains the usage plan rate limits for the operation, when available. The preceding
   * table contains the default rate and burst values for this operation. Selling partners whose
   * business demands require higher throughput might have higher rate and burst values than those
  ...
  public okhttp3.Call createAmazonMotorsAsync(
    ...
    okhttp3.Call call =
        createAmazonMotorsValidateBeforeCall(
            body, amazonOrderId, marketplaceIds, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<CreateAmazonMotorsResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  ...
  private okhttp3.Call createConfirmDeliveryDetailsValidateBeforeCall(
    ...
    if (amazonOrderId == null) {
      throw new ApiException(
          "Missing the required parameter 'amazonOrderId' when calling"
              + " createConfirmDeliveryDetails(Async)");
    }
    // verify the required parameter 'marketplaceIds' is set
    if (marketplaceIds == null) {
      throw new ApiException(
  ...
  public ApiResponse<CreateConfirmDeliveryDetailsResponse> createConfirmDeliveryDetailsWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        createConfirmDeliveryDetailsValidateBeforeCall(
            body, amazonOrderId, marketplaceIds, null, null);
  ...
  /**
   * (asynchronously) Sends a message to a buyer to arrange a delivery or to confirm contact
   * information for making a delivery. **Usage Plan:** | Rate (requests per second) | Burst | |
   * ---- | ---- | | 1 | 5 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header contains the
   * usage plan rate limits for the operation, when available. The preceding table contains the
   * default rate and burst values for this operation. Selling partners whose business demands
   * require higher throughput might have higher rate and burst values than those shown here. For
  ...
  private okhttp3.Call createConfirmOrderDetailsValidateBeforeCall(
    ...
    if (amazonOrderId == null) {
      throw new ApiException(
          "Missing the required parameter 'amazonOrderId' when calling"
              + " createConfirmOrderDetails(Async)");
    }
    // verify the required parameter 'marketplaceIds' is set
    if (marketplaceIds == null) {
      throw new ApiException(
  ...
  /**
   * Sends a message to ask a buyer an order-related question prior to shipping their order. **Usage
  ...
  public ApiResponse<CreateConfirmOrderDetailsResponse> createConfirmOrderDetailsWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        createConfirmOrderDetailsValidateBeforeCall(
            body, amazonOrderId, marketplaceIds, null, null);
  ...
  /**
   * (asynchronously) Sends a message to ask a buyer an order-related question prior to shipping
   * their order. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 1 | 5 |
   * The &#x60;x-amzn-RateLimit-Limit&#x60; response header contains the usage plan rate limits for
   * the operation, when available. The preceding table contains the default rate and burst values
   * for this operation. Selling partners whose business demands require higher throughput might
   * have higher rate and burst values than those shown here. For more information, refer to [Usage
   * Plans and Rate
   * Limits](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api).
   *
   * @param body This contains the message body for a message. (required)
   ...
   * information prior to a service call. **Usage Plan:** | Rate (requests per second) | Burst | |
   * ---- | ---- | | 1 | 5 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header contains the
   * usage plan rate limits for the operation, when available. The preceding table contains the
   * default rate and burst values for this operation. Selling partners whose business demands
   * require higher throughput might have higher rate and burst values than those shown here. For
  ...
  public ApiResponse<CreateConfirmServiceDetailsResponse> createConfirmServiceDetailsWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        createConfirmServiceDetailsValidateBeforeCall(
            body, amazonOrderId, marketplaceIds, null, null);
  ...
  /**
   * (asynchronously) Sends a message to contact a Home Service customer to arrange a service call
   * or to gather information prior to a service call. **Usage Plan:** | Rate (requests per second)
   * | Burst | | ---- | ---- | | 1 | 5 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header
   * contains the usage plan rate limits for the operation, when available. The preceding table
   * contains the default rate and burst values for this operation. Selling partners whose business
   * demands require higher throughput might have higher rate and burst values than those shown
  ...
  private okhttp3.Call createDigitalAccessKeyValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling createDigitalAccessKey(Async)");
    }
    // verify the required parameter 'amazonOrderId' is set
    if (amazonOrderId == null) {
      throw new ApiException(
          "Missing the required parameter 'amazonOrderId' when calling"
              + " createDigitalAccessKey(Async)");
    }
    // verify the required parameter 'marketplaceIds' is set
    if (marketplaceIds == null) {
      throw new ApiException(
  ...
  /**
   * Sends a buyer a message to share a digital access key that is required to utilize digital
   * content in their order. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- |
   * | 1 | 5 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header contains the usage plan rate
   * limits for the operation, when available. The preceding table contains the default rate and
   * burst values for this operation. Selling partners whose business demands require higher
   * throughput might have higher rate and burst values than those shown here. For more information,
   * refer to [Usage Plans and Rate
   * Limits](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api).
   *
   * @param body This contains the message body for a message. (required)
   * @param amazonOrderId An Amazon order identifier. This identifies the order for which a message
  ...
  public ApiResponse<CreateDigitalAccessKeyResponse> createDigitalAccessKeyWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        createDigitalAccessKeyValidateBeforeCall(body, amazonOrderId, marketplaceIds, null, null);
    Type localVarReturnType = new TypeToken<CreateDigitalAccessKeyResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Sends a buyer a message to share a digital access key that is required to
   * utilize digital content in their order. **Usage Plan:** | Rate (requests per second) | Burst |
   * | ---- | ---- | | 1 | 5 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header contains the
   * usage plan rate limits for the operation, when available. The preceding table contains the
   * default rate and burst values for this operation. Selling partners whose business demands
   * require higher throughput might have higher rate and burst values than those shown here. For
  ...
  public okhttp3.Call createDigitalAccessKeyAsync(
    ...
    okhttp3.Call call =
        createDigitalAccessKeyValidateBeforeCall(
            body, amazonOrderId, marketplaceIds, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<CreateDigitalAccessKeyResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  ...
  private okhttp3.Call createLegalDisclosureValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling createLegalDisclosure(Async)");
    }
    // verify the required parameter 'amazonOrderId' is set
    if (amazonOrderId == null) {
      throw new ApiException(
          "Missing the required parameter 'amazonOrderId' when calling"
              + " createLegalDisclosure(Async)");
    }
    // verify the required parameter 'marketplaceIds' is set
    if (marketplaceIds == null) {
      throw new ApiException(
  ...
  /**
   * Sends a critical message that contains documents that a seller is legally obligated to provide
   * to the buyer. This message should only be used to deliver documents that are required by law.
  ...
  public ApiResponse<CreateLegalDisclosureResponse> createLegalDisclosureWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        createLegalDisclosureValidateBeforeCall(body, amazonOrderId, marketplaceIds, null, null);
    Type localVarReturnType = new TypeToken<CreateLegalDisclosureResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Sends a critical message that contains documents that a seller is legally
   * obligated to provide to the buyer. This message should only be used to deliver documents that
   * are required by law. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 1
   * | 5 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header contains the usage plan rate
   * limits for the operation, when available. The preceding table contains the default rate and
   * burst values for this operation. Selling partners whose business demands require higher
   * throughput might have higher rate and burst values than those shown here. For more information,
   * refer to [Usage Plans and Rate
  ...
  public okhttp3.Call createLegalDisclosureAsync(
    ...
    okhttp3.Call call =
        createLegalDisclosureValidateBeforeCall(
            body, amazonOrderId, marketplaceIds, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<CreateLegalDisclosureResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  ...
  private okhttp3.Call createNegativeFeedbackRemovalValidateBeforeCall(
    ...
    if (amazonOrderId == null) {
      throw new ApiException(
          "Missing the required parameter 'amazonOrderId' when calling"
              + " createNegativeFeedbackRemoval(Async)");
    }
    // verify the required parameter 'marketplaceIds' is set
    if (marketplaceIds == null) {
      throw new ApiException(
   ...
   * should only be sent after the seller has resolved the buyer&#x27;s problem. **Usage Plan:** |
   * Rate (requests per second) | Burst | | ---- | ---- | | 1 | 5 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header contains the usage plan rate limits for the
   * operation, when available. The preceding table contains the default rate and burst values for
   * this operation. Selling partners whose business demands require higher throughput might have
   * higher rate and burst values than those shown here. For more information, refer to [Usage Plans
   ...
   * @throws LWAException If calls to fetch LWA access token fails
   */
  public ApiResponse<CreateNegativeFeedbackRemovalResponse>
      createNegativeFeedbackRemovalWithHttpInfo(String amazonOrderId, List<String> marketplaceIds)
          throws ApiException, LWAException {
    okhttp3.Call call =
        createNegativeFeedbackRemovalValidateBeforeCall(amazonOrderId, marketplaceIds, null, null);
    Type localVarReturnType = new TypeToken<CreateNegativeFeedbackRemovalResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Sends a non-critical message that asks a buyer to remove their negative
   * feedback. This message should only be sent after the seller has resolved the buyer&#x27;s
   * problem. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 1 | 5 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header contains the usage plan rate limits for the
   * operation, when available. The preceding table contains the default rate and burst values for
   * this operation. Selling partners whose business demands require higher throughput might have
   * higher rate and burst values than those shown here. For more information, refer to [Usage Plans
  ...
  public okhttp3.Call createNegativeFeedbackRemovalAsync(
    ...
    okhttp3.Call call =
        createNegativeFeedbackRemovalValidateBeforeCall(
            amazonOrderId, marketplaceIds, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<CreateNegativeFeedbackRemovalResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  ...
  private okhttp3.Call createUnexpectedProblemValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling createUnexpectedProblem(Async)");
    }
    // verify the required parameter 'amazonOrderId' is set
    if (amazonOrderId == null) {
      throw new ApiException(
          "Missing the required parameter 'amazonOrderId' when calling"
              + " createUnexpectedProblem(Async)");
    }
    // verify the required parameter 'marketplaceIds' is set
    if (marketplaceIds == null) {
      throw new ApiException(
   ...
   * completion of the order. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- |
   * | 1 | 5 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header contains the usage plan rate
   * limits for the operation, when available. The preceding table contains the default rate and
   * burst values for this operation. Selling partners whose business demands require higher
   * throughput might have higher rate and burst values than those shown here. For more information,
  ...
  public ApiResponse<CreateUnexpectedProblemResponse> createUnexpectedProblemWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        createUnexpectedProblemValidateBeforeCall(body, amazonOrderId, marketplaceIds, null, null);
    Type localVarReturnType = new TypeToken<CreateUnexpectedProblemResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Sends a critical message to a buyer that an unexpected problem was encountered
   * affecting the completion of the order. **Usage Plan:** | Rate (requests per second) | Burst | |
   * ---- | ---- | | 1 | 5 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header contains the
   * usage plan rate limits for the operation, when available. The preceding table contains the
   * default rate and burst values for this operation. Selling partners whose business demands
   * require higher throughput might have higher rate and burst values than those shown here. For
  ...
  public okhttp3.Call createUnexpectedProblemAsync(
    ...
    okhttp3.Call call =
        createUnexpectedProblemValidateBeforeCall(
            body, amazonOrderId, marketplaceIds, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<CreateUnexpectedProblemResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  ...
  private okhttp3.Call createWarrantyValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling createWarranty(Async)");
    }
    // verify the required parameter 'amazonOrderId' is set
    if (amazonOrderId == null) {
      throw new ApiException(
          "Missing the required parameter 'amazonOrderId' when calling createWarranty(Async)");
    }
    // verify the required parameter 'marketplaceIds' is set
    if (marketplaceIds == null) {
      throw new ApiException(
  ...
  public CreateWarrantyResponse createWarranty(
    ...
    ApiResponse<CreateWarrantyResponse> resp =
        createWarrantyWithHttpInfo(body, amazonOrderId, marketplaceIds);
    return resp.getData();
  }
  ...
  public ApiResponse<CreateWarrantyResponse> createWarrantyWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        createWarrantyValidateBeforeCall(body, amazonOrderId, marketplaceIds, null, null);
    Type localVarReturnType = new TypeToken<CreateWarrantyResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Sends a message to a buyer to provide details about warranty information on a
   * purchase in their order. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- |
   * | 1 | 5 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header contains the usage plan rate
   * limits for the operation, when available. The preceding table contains the default rate and
   * burst values for this operation. Selling partners whose business demands require higher
   * throughput might have higher rate and burst values than those shown here. For more information,
  ...
  public okhttp3.Call createWarrantyAsync(
    ...
    okhttp3.Call call =
        createWarrantyValidateBeforeCall(
            body, amazonOrderId, marketplaceIds, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<CreateWarrantyResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  ...
  private okhttp3.Call getAttributesValidateBeforeCall(
    ...
    if (amazonOrderId == null) {
      throw new ApiException(
          "Missing the required parameter 'amazonOrderId' when calling getAttributes(Async)");
    }
    // verify the required parameter 'marketplaceIds' is set
    if (marketplaceIds == null) {
      throw new ApiException(
          "Missing the required parameter 'marketplaceIds' when calling getAttributes(Async)");
    }

    okhttp3.Call call =
        getAttributesCall(amazonOrderId, marketplaceIds, progressListener, progressRequestListener);
    return call;
  }
  ...
  /**
   * (asynchronously) Returns a response containing attributes related to an order. This includes
   * buyer preferences. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 1 |
   * 5 |
   *
   * @param amazonOrderId An Amazon order identifier. This identifies the order for which a message
   *     is sent. (required)
  ...
  public okhttp3.Call getAttributesAsync(
    ...
    okhttp3.Call call =
        getAttributesValidateBeforeCall(
            amazonOrderId, marketplaceIds, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetAttributesResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
   ...
   *
   * @param amazonOrderId An Amazon order identifier. This specifies the order for which you want a
   *     list of available message types. (required)
   * @param marketplaceIds A marketplace identifier. This identifies the marketplace in which the
   *     order was placed. You can only specify one marketplace. (required)
   * @param progressListener Progress listener
   * @param progressRequestListener Progress request listener
  ...
  private okhttp3.Call getMessagingActionsForOrderValidateBeforeCall(
    ...
    if (amazonOrderId == null) {
      throw new ApiException(
          "Missing the required parameter 'amazonOrderId' when calling"
              + " getMessagingActionsForOrder(Async)");
    }
    // verify the required parameter 'marketplaceIds' is set
    if (marketplaceIds == null) {
      throw new ApiException(
  ...
  /**
   * Returns a list of message types that are available for an order that you specify. A message
   * type is represented by an actions object, which contains a path and query parameter(s). You can
   * use the path and parameter(s) to call an operation that sends a message. **Usage Plan:** | Rate
   * (requests per second) | Burst | | ---- | ---- | | 1 | 5 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header contains the usage plan rate limits for the
   * operation, when available. The preceding table contains the default rate and burst values for
   * this operation. Selling partners whose business demands require higher throughput might have
   * higher rate and burst values than those shown here. For more information, refer to [Usage Plans
  ...
  public ApiResponse<GetMessagingActionsForOrderResponse> getMessagingActionsForOrderWithHttpInfo(
      String amazonOrderId, List<String> marketplaceIds) throws ApiException, LWAException {
    okhttp3.Call call =
        getMessagingActionsForOrderValidateBeforeCall(amazonOrderId, marketplaceIds, null, null);
    Type localVarReturnType = new TypeToken<GetMessagingActionsForOrderResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Returns a list of message types that are available for an order that you
   * specify. A message type is represented by an actions object, which contains a path and query
   * parameter(s). You can use the path and parameter(s) to call an operation that sends a message.
   * **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 1 | 5 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header contains the usage plan rate limits for the
   * operation, when available. The preceding table contains the default rate and burst values for
   * this operation. Selling partners whose business demands require higher throughput might have
  ...
  public okhttp3.Call getMessagingActionsForOrderAsync(
    ...
    okhttp3.Call call =
        getMessagingActionsForOrderValidateBeforeCall(
            amazonOrderId, marketplaceIds, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetMessagingActionsForOrderResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  ...
  private okhttp3.Call sendInvoiceValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling sendInvoice(Async)");
    }
    // verify the required parameter 'amazonOrderId' is set
    if (amazonOrderId == null) {
      throw new ApiException(
          "Missing the required parameter 'amazonOrderId' when calling sendInvoice(Async)");
    }
    // verify the required parameter 'marketplaceIds' is set
    if (marketplaceIds == null) {
      throw new ApiException(
          "Missing the required parameter 'marketplaceIds' when calling sendInvoice(Async)");
    }
  ...
  public InvoiceResponse sendInvoice(
      InvoiceRequest body, String amazonOrderId, List<String> marketplaceIds)
      throws ApiException, LWAException {
    ApiResponse<InvoiceResponse> resp =
        sendInvoiceWithHttpInfo(body, amazonOrderId, marketplaceIds);
    return resp.getData();
  }
  ...
  public ApiResponse<InvoiceResponse> sendInvoiceWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        sendInvoiceValidateBeforeCall(body, amazonOrderId, marketplaceIds, null, null);
