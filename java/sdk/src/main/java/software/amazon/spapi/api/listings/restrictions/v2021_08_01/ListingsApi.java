...
public class ListingsApi {
   ...
   * @param reasonLocale A locale for reason text localization. When not provided, the default
   *     language code of the first marketplace is used. Examples: \&quot;en_US\&quot;,
   *     \&quot;fr_CA\&quot;, \&quot;fr_FR\&quot;. Localized messages default to \&quot;en_US\&quot;
   *     when a localization is not available in the specified locale. (optional)
  ...
  private okhttp3.Call getListingsRestrictionsValidateBeforeCall(
    ...
    if (asin == null) {
      throw new ApiException(
          "Missing the required parameter 'asin' when calling getListingsRestrictions(Async)");
    }
  ...
  /**
   * Returns listing restrictions for an item in the Amazon Catalog. **Usage Plan:** | Rate
  ...
  public RestrictionList getListingsRestrictions(
    ...
    ApiResponse<RestrictionList> resp =
        getListingsRestrictionsWithHttpInfo(
            asin, sellerId, marketplaceIds, conditionType, reasonLocale);
    return resp.getData();
  }
  ...
  public ApiResponse<RestrictionList> getListingsRestrictionsWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        getListingsRestrictionsValidateBeforeCall(
  ...
  /**
   * (asynchronously) Returns listing restrictions for an item in the Amazon Catalog. **Usage
