...
public class DetailedShippingTimeType {
  ...
  /**
   * Indicates whether the item is available for shipping now, or on a known or an unknown date in
   * the future. If known, the availableDate property indicates the date that the item will be
   * available for shipping. Possible values: NOW, FUTURE_WITHOUT_DATE, FUTURE_WITH_DATE.
   */
  ...
  public enum AvailabilityTypeEnum {
    ...
    public static class Adapter extends TypeAdapter<AvailabilityTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final AvailabilityTypeEnum enumeration)
          throws IOException {
  ...
  @Schema(
      description =
          "The minimum time, in hours, that the item will likely be shipped after the order has"
              + " been placed.")
  ...
  @Schema(
      description =
          "The maximum time, in hours, that the item will likely be shipped after the order has"
              + " been placed.")
  ...
  /**
   * The date when the item will be available for shipping. Only displayed for items that are not
  ...
  @Schema(
      description =
          "Indicates whether the item is available for shipping now, or on a known or an unknown"
              + " date in the future. If known, the availableDate property indicates the date that"
              + " the item will be available for shipping. Possible values: NOW,"
