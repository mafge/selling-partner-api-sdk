...
/**
 * A list of delivery offers, including offer expiration, earliest and latest date and time range,
 * and the delivery offer policy.
 */
@Schema(
    description =
        "A list of delivery offers, including offer expiration, earliest and latest date and time"
            + " range, and the delivery offer policy.")
