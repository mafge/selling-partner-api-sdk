...
/**
 * Additional inventory details. This object is only displayed if the details parameter in the
 * request is set to &#x60;SHOW&#x60;.
 */
@Schema(
    description =
        "Additional inventory details. This object is only displayed if the details parameter in"
...
public class InventoryDetails {
  ...
  /**
   * Quantity that is reserved for a downstream channel replenishment order that is being prepared
   * for shipment.
   *
  ...
  @Schema(
      description =
          "Quantity that is reserved for a downstream channel replenishment order that is being"
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(
            this.availableDistributableQuantity, inventoryDetails.availableDistributableQuantity)
        && Objects.equals(this.replenishmentQuantity, inventoryDetails.replenishmentQuantity)
        && Objects.equals(
            this.reservedDistributableQuantity, inventoryDetails.reservedDistributableQuantity);
  }

  @Override
  public int hashCode() {
    return Objects.hash(
        availableDistributableQuantity, replenishmentQuantity, reservedDistributableQuantity);
  }
