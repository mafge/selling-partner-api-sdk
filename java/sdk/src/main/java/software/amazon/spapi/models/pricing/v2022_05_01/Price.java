...
/**
 * The schema for item&#x27;s price information, including listing price, shipping price, and Amazon
 * Points.
 */
@Schema(
    description =
        "The schema for item's price information, including listing price, shipping price, and"
            + " Amazon Points.")
public class Price {
