...
public class ServiceFeeEvent {
  ...
  /**
   * The seller SKU of the item. The seller SKU is qualified by the seller&#x27;s seller ID, which
   * is included with every call to the Selling Partner API.
   *
   * @return sellerSKU
   */
  @Schema(
  ...
  public int hashCode() {
    return Objects.hash(
        amazonOrderId, feeReason, feeList, sellerSKU, fnSKU, feeDescription, ASIN, storeName);
  }
