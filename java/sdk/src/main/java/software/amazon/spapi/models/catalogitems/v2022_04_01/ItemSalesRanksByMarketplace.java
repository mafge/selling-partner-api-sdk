...
public class ItemSalesRanksByMarketplace {
  ...
  @Schema(
      required = true,
      description =
          "Amazon marketplace identifier. To find the ID for your marketplace, refer to"
              + " [Marketplace"
              + " IDs](https://developer-docs.amazon.com/sp-api/docs/marketplace-ids).")
  ...
  public ItemSalesRanksByMarketplace classificationRanks(
      List<ItemClassificationSalesRank> classificationRanks) {
    this.classificationRanks = classificationRanks;
    return this;
  }

  public ItemSalesRanksByMarketplace addClassificationRanksItem(
      ItemClassificationSalesRank classificationRanksItem) {
  ...
  /**
   * Sales ranks of an Amazon catalog item for a &#x60;marketplaceId&#x60;, grouped by
   * classification.
   *
  ...
  public ItemSalesRanksByMarketplace displayGroupRanks(
      List<ItemDisplayGroupSalesRank> displayGroupRanks) {
    this.displayGroupRanks = displayGroupRanks;
    return this;
  }

  public ItemSalesRanksByMarketplace addDisplayGroupRanksItem(
      ItemDisplayGroupSalesRank displayGroupRanksItem) {
  ...
  /**
   * Sales ranks of an Amazon catalog item for a &#x60;marketplaceId&#x60;, grouped by website
   * display group.
   *
  ...
  @Schema(
      description =
          "Sales ranks of an Amazon catalog item for a `marketplaceId`, grouped by website display"
              + " group.")
