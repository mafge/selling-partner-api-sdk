...
/**
 * The auto-enrollment preference indicates whether the offer is opted-in to or opted-out of
...
public enum AutoEnrollmentPreference {
  ...
  public static class Adapter extends TypeAdapter<AutoEnrollmentPreference> {
    @Override
    public void write(final JsonWriter jsonWriter, final AutoEnrollmentPreference enumeration)
        throws IOException {
