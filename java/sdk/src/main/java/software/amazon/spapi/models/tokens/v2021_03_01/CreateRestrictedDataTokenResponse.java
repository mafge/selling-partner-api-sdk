...
public class CreateRestrictedDataTokenResponse {
  ...
  /**
   * A Restricted Data Token (RDT). This is a short-lived access token that authorizes calls to
   * restricted operations. Pass this value with the x-amz-access-token header when making
  ...
  @Schema(
      description =
          "A Restricted Data Token (RDT). This is a short-lived access token that authorizes calls"
              + " to restricted operations. Pass this value with the x-amz-access-token header when"
              + " making subsequent calls to these restricted resources.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreateRestrictedDataTokenResponse createRestrictedDataTokenResponse =
        (CreateRestrictedDataTokenResponse) o;
    return Objects.equals(
            this.restrictedDataToken, createRestrictedDataTokenResponse.restrictedDataToken)
