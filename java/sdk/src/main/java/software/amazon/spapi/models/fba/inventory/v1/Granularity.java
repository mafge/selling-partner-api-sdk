...
/**
 * Describes a granularity at which inventory data can be aggregated. For example, if you use
 * Marketplace granularity, the fulfillable quantity will reflect inventory that could be fulfilled
 * in the given marketplace.
 */
@Schema(
    description =
        "Describes a granularity at which inventory data can be aggregated. For example, if you use"
            + " Marketplace granularity, the fulfillable quantity will reflect inventory that could"
            + " be fulfilled in the given marketplace.")
