...
public class CartonReferenceDetails {
  ...
  /**
   * Pallet level carton count is mandatory for single item pallet and optional for mixed item
   * pallet.
   *
   * @return cartonCount
   */
  @Schema(
      description =
          "Pallet level carton count is mandatory for single item pallet and optional for mixed"
              + " item pallet.")
  ...
  /**
   * Array of reference numbers for the carton that are part of this pallet/shipment. Please provide
   * the cartonSequenceNumber from the &#x27;cartons&#x27; segment to refer to that carton&#x27;s
   * details here.
   *
  ...
  @Schema(
      required = true,
      description =
          "Array of reference numbers for the carton that are part of this pallet/shipment. Please"
              + " provide the cartonSequenceNumber from the 'cartons' segment to refer to that"
              + " carton's details here.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.cartonCount, cartonReferenceDetails.cartonCount)
        && Objects.equals(
            this.cartonReferenceNumbers, cartonReferenceDetails.cartonReferenceNumbers);
  }
