...
/**
 * This field provides information about the enforcement actions taken by Amazon that affect the
 * publishing or status of a listing. It also includes details about any associated exemptions.
 */
@Schema(
    description =
        "This field provides information about the enforcement actions taken by Amazon that affect"
            + " the publishing or status of a listing. It also includes details about any"
...
public class IssueEnforcements {
  ...
  @Schema(
      required = true,
      description =
          "List of enforcement actions taken by Amazon that affect the publishing or status of a"
              + " listing.")
