...
/**
 * A carrier who is temporarily unavailable, most likely due to a service outage experienced by the
 * carrier.
 */
@Schema(
    description =
        "A carrier who is temporarily unavailable, most likely due to a service outage experienced"
            + " by the carrier.")
