...
public class TotalWeight {
  /**
   * The unit of measure for the weight of items that are ordered by cases and support pricing by
   * weight.
   */
  ...
  @Schema(
      required = true,
      description =
          "The unit of measure for the weight of items that are ordered by cases and support"
              + " pricing by weight.")
