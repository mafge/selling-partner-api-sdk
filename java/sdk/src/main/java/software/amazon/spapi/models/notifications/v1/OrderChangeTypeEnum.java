...
public enum OrderChangeTypeEnum {
  ...
  public static OrderChangeTypeEnum fromValue(String input) {
  ...
  public static class Adapter extends TypeAdapter<OrderChangeTypeEnum> {
    @Override
    public void write(final JsonWriter jsonWriter, final OrderChangeTypeEnum enumeration)
        throws IOException {
    ...
    public OrderChangeTypeEnum read(final JsonReader jsonReader) throws IOException {
      ...
      return OrderChangeTypeEnum.fromValue((String) (value));
    }
  }
}
