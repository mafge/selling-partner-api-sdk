...
public class ApiClient {
  ...
  /**
   * Sets the RateLimiter A rate limiter is used to manage a high volume of traffic allowing N
   * requests per second
   *
   * @return Api client
   */
...
class RateLimitInterceptor implements Interceptor {
  ...
  public RateLimitInterceptor(
      RateLimiter rateLimiter, RateLimitConfiguration rateLimitConfiguration) {
