...
/**
 * Request schema for the &#x60;getFixedSlotCapacity&#x60; operation. This schema is used to define
 * the time range, capacity types and slot duration which are being queried.
 */
@Schema(
    description =
        "Request schema for the `getFixedSlotCapacity` operation. This schema is used to define the"
            + " time range, capacity types and slot duration which are being queried.")
public class FixedSlotCapacityQuery {
  ...
  /**
   * An array of capacity types which are being requested. Default value is
   * &#x60;[SCHEDULED_CAPACITY]&#x60;.
   *
  ...
  /**
   * Size in which slots are being requested. This value should be a multiple of 5 and fall in the
  ...
  @Schema(
      description =
          "Size in which slots are being requested. This value should be a multiple of 5 and fall"
              + " in the range: 5 <= `slotDuration` <= 360.")
