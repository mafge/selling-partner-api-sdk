...
public class Item {
  ...
  /**
   * The expiration date of the MSKU. In [ISO
   * 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) datetime format with
   * pattern&#x60;YYYY-MM-DD&#x60;. The same MSKU with different expiration dates cannot go into the
   * same box.
   *
   * @return expiration
   */
  @Schema(
      description =
          "The expiration date of the MSKU. In [ISO"
              ...
              + " with pattern`YYYY-MM-DD`. The same MSKU with different expiration dates cannot go"
              + " into the same box.")
  ...
  @Schema(
      required = true,
      description =
          "A unique identifier assigned by Amazon to products stored in and fulfilled from an"
  ...
  /**
   * Specifies who will label the items. Options include &#x60;AMAZON&#x60;, &#x60;SELLER&#x60;, and
   * &#x60;NONE&#x60;.
   *
   * @return labelOwner
   */
