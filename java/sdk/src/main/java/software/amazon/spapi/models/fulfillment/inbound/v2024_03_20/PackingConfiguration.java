...
/**
 * A way to configure this packing option. Some box content information sources might not be
 * allowed. Non-standard minimum and maximum box weights might be enforced.
 */
@Schema(
    description =
        "A way to configure this packing option. Some box content information sources might not be"
...
public class PackingConfiguration {
  ...
  public PackingConfiguration boxPackingMethods(
      List<BoxContentInformationSource> boxPackingMethods) {
    this.boxPackingMethods = boxPackingMethods;
    return this;
  }

  public PackingConfiguration addBoxPackingMethodsItem(
      BoxContentInformationSource boxPackingMethodsItem) {
  ...
  public PackingConfiguration shippingRequirements(
      List<ShippingRequirements> shippingRequirements) {
    this.shippingRequirements = shippingRequirements;
    return this;
  }

  public PackingConfiguration addShippingRequirementsItem(
      ShippingRequirements shippingRequirementsItem) {
