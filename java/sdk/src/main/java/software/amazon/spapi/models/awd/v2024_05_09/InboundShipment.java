...
public class InboundShipment {
  ...
  @Schema(
      description =
          "Timestamp when the shipment was created. The date is returned in <a"
              + " href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a>"
              + " format.")
  ...
  /**
   * Client-provided reference ID that can correlate this shipment to client resources. For example,
   * to map this shipment to an internal bookkeeping order record.
   *
  ...
  @Schema(
      ...
      description =
          "Client-provided reference ID that can correlate this shipment to client resources. For"
  ...
  public InboundShipment shipmentContainerQuantities(
      List<DistributionPackageQuantity> shipmentContainerQuantities) {
  ...
  public void setShipmentContainerQuantities(
      List<DistributionPackageQuantity> shipmentContainerQuantities) {
    this.shipmentContainerQuantities = shipmentContainerQuantities;
  }
  ...
  /**
   * Quantity details at SKU level for the shipment. This attribute will only appear if the
   * skuQuantities parameter in the request is set to SHOW.
   *
  ...
  /**
   * Assigned region where the order will be shipped. This can differ from what was passed as
   * preference. AWD currently supports following region IDs: [us-west, us-east, us-southcentral,
   * us-southeast]
   *
  ...
  @Schema(
      ...
      description =
          "Assigned region where the order will be shipped. This can differ from what was passed as"
              + " preference. AWD currently supports following region IDs: [us-west, us-east,"
  ...
  /**
   * An AWD-provided reference ID that you can use to interact with the warehouse. For example, a
  ...
  @Schema(
      ...
      description =
          "An AWD-provided reference ID that you can use to interact with the warehouse. For"
              + " example, a carrier appointment booking.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.carrierCode, inboundShipment.carrierCode)
        ...
        && Objects.equals(
            this.shipmentContainerQuantities, inboundShipment.shipmentContainerQuantities)
