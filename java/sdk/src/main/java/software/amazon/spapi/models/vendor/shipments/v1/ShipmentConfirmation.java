...
public class ShipmentConfirmation {
  ...
  /**
   * Indicates if this shipment confirmation is the initial confirmation, or intended to replace an
   * already posted shipment confirmation. If replacing an existing shipment confirmation, be sure
   * to provide the identical shipmentIdentifier and sellingParty information as in the previous
   * confirmation.
   */
  ...
  public enum ShipmentTypeEnum {
    ...
    public static class Adapter extends TypeAdapter<ShipmentTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ShipmentTypeEnum enumeration)
          throws IOException {
        jsonWriter.value(String.valueOf(enumeration.getValue()));
      }
  ...
  public enum ShipmentStructureEnum {
    ...
    public static class Adapter extends TypeAdapter<ShipmentStructureEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ShipmentStructureEnum enumeration)
          throws IOException {
        jsonWriter.value(String.valueOf(enumeration.getValue()));
      }
  ...
  public ShipmentConfirmation shipmentConfirmationType(
      ShipmentConfirmationTypeEnum shipmentConfirmationType) {
  ...
  @Schema(
      required = true,
      description =
          "Indicates if this shipment confirmation is the initial confirmation, or intended to"
              + " replace an already posted shipment confirmation. If replacing an existing"
  ...
  public void setTransportationDetails(
      TransportationDetailsForShipmentConfirmation transportationDetails) {
    this.transportationDetails = transportationDetails;
  }
  ...
  /**
   * The Amazon Reference Number is a unique identifier generated by Amazon for all Collect/WePay
  ...
  /**
   * The date and time on which the shipment is estimated to reach buyer&#x27;s warehouse. It needs
   * to be an estimate based on the average transit time between ship from location and the
   * destination. The exact appointment time will be provided by the buyer and is potentially not
  ...
  @Schema(
      description =
          "The date and time on which the shipment is estimated to reach buyer's warehouse. It"
              + " needs to be an estimate based on the average transit time between ship from"
  ...
  /**
   * A list of the items in this shipment and their associated details. If any of the item detail
   * fields are common at a carton or a pallet level, provide them at the corresponding carton or
   * pallet level.
   *
   * @return shippedItems
   */
  @Schema(
      required = true,
      description =
          "A list of the items in this shipment and their associated details. If any of the item"
              + " detail fields are common at a carton or a pallet level, provide them at the"
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.shipmentIdentifier, shipmentConfirmation.shipmentIdentifier)
        && Objects.equals(
            this.shipmentConfirmationType, shipmentConfirmation.shipmentConfirmationType)
        ...
        && Objects.equals(
            this.shipmentConfirmationDate, shipmentConfirmation.shipmentConfirmationDate)
