...
public class ShipmentSchedule {
  ...
  /**
   * Date on which the shipment is expected to reach the customer delivery location. Values are in
   * [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format, with UTC
   * time zone or UTC offset. For example, 2020-07-16T23:00:00Z or 2020-07-16T23:00:00+01:00.
   *
   * @return estimatedDeliveryDateTime
   */
  @Schema(
      description =
          "Date on which the shipment is expected to reach the customer delivery location. Values"
              + " are in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601)"
              + " date-time format, with UTC time zone or UTC offset. For example,"
              + " 2020-07-16T23:00:00Z or 2020-07-16T23:00:00+01:00.")
  ...
  /**
   * The date and time at the start of the appointment window when the shipment is expected to be
   * delivered. Values are in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601)
  ...
  @Schema(
      description =
          "The date and time at the start of the appointment window when the shipment is expected"
              + " to be delivered. Values are in [ISO"
              + " 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format,"
              + " with UTC time zone or UTC offset. For example, 2020-07-16T23:00:00Z or"
              + " 2020-07-16T23:00:00+01:00.")
  ...
  /**
   * The date and time at the end of the appointment window when the shipment is expected to be
   * delivered. Values are in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601)
   * date-time format, with UTC time zone or UTC offset. For example, 2020-07-16T23:00:00Z or
   * 2020-07-16T23:00:00+01:00.
   *
  ...
  @Schema(
      description =
          "The date and time at the end of the appointment window when the shipment is expected to"
              + " be delivered. Values are in [ISO"
              + " 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format,"
              + " with UTC time zone or UTC offset. For example, 2020-07-16T23:00:00Z or"
              + " 2020-07-16T23:00:00+01:00.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(
            this.estimatedDeliveryDateTime, shipmentSchedule.estimatedDeliveryDateTime)
