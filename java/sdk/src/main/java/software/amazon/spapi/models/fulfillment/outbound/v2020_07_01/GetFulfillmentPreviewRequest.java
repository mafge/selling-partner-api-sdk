...
public class GetFulfillmentPreviewRequest {
  ...
  public GetFulfillmentPreviewRequest shippingSpeedCategories(
  ...
  public GetFulfillmentPreviewRequest includeCODFulfillmentPreview(
      Boolean includeCODFulfillmentPreview) {
    this.includeCODFulfillmentPreview = includeCODFulfillmentPreview;
    return this;
  }

  /**
   * When true, returns all fulfillment order previews both for COD and not for COD. Otherwise,
  ...
  @Schema(
      description =
          "When true, returns all fulfillment order previews both for COD and not for COD."
              + " Otherwise, returns only fulfillment order previews that are not for COD.")
  ...
  /**
   * When true, returns the &#x60;ScheduledDeliveryInfo&#x60; response object, which contains the
   * available delivery windows for a Scheduled Delivery. The &#x60;ScheduledDeliveryInfo&#x60;
   * response object can only be returned for fulfillment order previews with
  ...
  public GetFulfillmentPreviewRequest addFeatureConstraintsItem(
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.marketplaceId, getFulfillmentPreviewRequest.marketplaceId)
        ...
        && Objects.equals(
            this.shippingSpeedCategories, getFulfillmentPreviewRequest.shippingSpeedCategories)
        && Objects.equals(
            this.includeCODFulfillmentPreview,
            getFulfillmentPreviewRequest.includeCODFulfillmentPreview)
        && Objects.equals(
            this.includeDeliveryWindows, getFulfillmentPreviewRequest.includeDeliveryWindows)
