...
public class ItemInput {
   ...
   * &#x60;YYYY-MM-DD&#x60;. Items with the same MSKU but different expiration dates cannot go into
   * the same box.
   *
   * @return expiration
   */
  @Schema(
      description =
          "The expiration date of the MSKU. In [ISO"
              ...
              + " with pattern `YYYY-MM-DD`. Items with the same MSKU but different expiration"
              + " dates cannot go into the same box.")
