...
public class JobListing {
  ...
  /**
   * A generated string used to pass information to your next request. If &#x60;nextPageToken&#x60;
   * is returned, pass the value of &#x60;nextPageToken&#x60; to the &#x60;pageToken&#x60; to get
   * next results.
   *
  ...
  @Schema(
      description =
          "A generated string used to pass information to your next request. If `nextPageToken` is"
              + " returned, pass the value of `nextPageToken` to the `pageToken` to get next"
              + " results.")
   ...
   * &#x60;previousPageToken&#x60; is returned, pass the value of &#x60;previousPageToken&#x60; to
   * the &#x60;pageToken&#x60; to get previous page results.
   *
  ...
  @Schema(
      description =
          "A generated string used to pass information to your next request. If `previousPageToken`"
              + " is returned, pass the value of `previousPageToken` to the `pageToken` to get"
