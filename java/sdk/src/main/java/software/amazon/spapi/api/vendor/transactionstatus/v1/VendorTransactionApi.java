...
public class VendorTransactionApi {
   ...
   *
   * @param transactionId The GUID provided by Amazon in the &#x27;transactionId&#x27; field in
   *     response to the post request of a specific transaction. (required)
  ...
  public okhttp3.Call getTransactionCall(
    ...
    String localVarPath =
        "/vendor/transactions/v1/transactions/{transactionId}"
            .replaceAll(
                "\\{" + "transactionId" + "\\}", apiClient.escapeString(transactionId.toString()));
  ...
  private okhttp3.Call getTransactionValidateBeforeCall(
    ...
    okhttp3.Call call =
        getTransactionCall(transactionId, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Returns the status of the transaction that you specify. **Usage Plan:** | Rate (requests per
   * second) | Burst | | ---- | ---- | | 10 | 20 | The &#x60;x-amzn-RateLimit-Limit&#x60; response
  ...
  /**
   * (asynchronously) Returns the status of the transaction that you specify. **Usage Plan:** | Rate
   * (requests per second) | Burst | | ---- | ---- | | 10 | 20 | The
  ...
  public okhttp3.Call getTransactionAsync(
      String transactionId, final ApiCallback<GetTransactionResponse> callback)
      throws ApiException, LWAException {
    ...
    okhttp3.Call call =
        getTransactionValidateBeforeCall(transactionId, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetTransactionResponse>() {}.getType();
