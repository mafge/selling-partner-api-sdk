...
/**
 * Represents an order placed by Amazon, including the purchase order number, current state, and
 * order details.
 */
@Schema(
    description =
        "Represents an order placed by Amazon, including the purchase order number, current state,"
            + " and order details.")
public class Order {
  ...
  @Schema(
      required = true,
      description =
          "The purchase order number for this order. Formatting Notes: 8-character alpha-numeric"
              + " code.")
