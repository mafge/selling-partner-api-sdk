...
public enum FulfillmentChannelType {
  ...
  public static FulfillmentChannelType fromValue(String input) {
  ...
  public static class Adapter extends TypeAdapter<FulfillmentChannelType> {
    @Override
    public void write(final JsonWriter jsonWriter, final FulfillmentChannelType enumeration)
        throws IOException {
    ...
    public FulfillmentChannelType read(final JsonReader jsonReader) throws IOException {
      ...
      return FulfillmentChannelType.fromValue((String) (value));
    }
  }
}
