...
/**
 * Information about an Amazon marketplace where a seller can list items and customers can view and
 * purchase items.
 */
@Schema(
    description =
        "Information about an Amazon marketplace where a seller can list items and customers can"
