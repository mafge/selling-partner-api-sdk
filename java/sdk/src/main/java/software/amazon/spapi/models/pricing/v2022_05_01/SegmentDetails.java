...
/**
 * The details about the segment. The FeaturedOfferExpectedPrice API uses only the sampleLocation
 * portion as input.
 */
@Schema(
    description =
...
public class SegmentDetails {
  ...
  /**
   * The glance view weighted percentage for this segment, which is the glance views for this
   * segment as a percentage of total glance views across all segments for the ASIN. A higher
   * percentage indicates that more Amazon customers receive this offer as the Featured Offer.
   *
  ...
  @Schema(
      description =
          "The glance view weighted percentage for this segment, which is the glance views for this"
              + " segment as a percentage of total glance views across all segments for the ASIN. A"
              + " higher percentage indicates that more Amazon customers receive this offer as the"
              + " Featured Offer.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(
            this.glanceViewWeightPercentage, segmentDetails.glanceViewWeightPercentage)
