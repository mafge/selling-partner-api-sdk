...
public class CreateFulfillmentOrderItem {
  ...
  public CreateFulfillmentOrderItem sellerFulfillmentOrderItemId(
  ...
  /**
   * A fulfillment order item identifier that the seller creates to track fulfillment order items.
   * Used to disambiguate multiple fulfillment items that have the same &#x60;SellerSKU&#x60;. For
   * example, the seller might assign different &#x60;SellerFulfillmentOrderItemId&#x60; values to
   * two items in a fulfillment order that share the same &#x60;SellerSKU&#x60; but have different
   * &#x60;GiftMessage&#x60; values.
   *
  ...
  @Schema(
      required = true,
      description =
          "A fulfillment order item identifier that the seller creates to track fulfillment order"
              + " items. Used to disambiguate multiple fulfillment items that have the same"
  ...
  /**
   * Item-specific text that displays in recipient-facing materials such as the outbound shipment
   * packing slip.
   *
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.sellerSku, createFulfillmentOrderItem.sellerSku)
        && Objects.equals(
            ...
            createFulfillmentOrderItem.sellerFulfillmentOrderItemId)
        ...
        && Objects.equals(
            this.fulfillmentNetworkSku, createFulfillmentOrderItem.fulfillmentNetworkSku)
        && Objects.equals(
            this.perUnitDeclaredValue, createFulfillmentOrderItem.perUnitDeclaredValue)
