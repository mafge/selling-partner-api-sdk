...
/**
 * Warning returned when the request is successful, but there are important callouts based on which
 * API clients should take defined actions.
 */
@Schema(
    description =
        "Warning returned when the request is successful, but there are important callouts based on"
            + " which API clients should take defined actions.")
