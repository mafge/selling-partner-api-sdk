...
@Schema(description = "The response schema for the `updateFulfillmentOrder` operation.")
public class UpdateFulfillmentOrderResponse {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UpdateFulfillmentOrderResponse updateFulfillmentOrderResponse =
        (UpdateFulfillmentOrderResponse) o;
