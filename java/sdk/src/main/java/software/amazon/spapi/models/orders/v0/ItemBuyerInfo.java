...
public class ItemBuyerInfo {
   ...
   * (fulfilled by seller) orders.
   *
   * @return giftMessageText
   */
  @Schema(
      description =
          "A gift message provided by the buyer.  **Note**: This attribute is only available for"
              + " MFN (fulfilled by seller) orders.")
  ...
  public int hashCode() {
    return Objects.hash(
        buyerCustomizedInfo, giftWrapPrice, giftWrapTax, giftMessageText, giftWrapLevel);
  }
