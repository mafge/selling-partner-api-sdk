...
public class Address {
  ...
  /**
   * The company name of the recipient. **Note**: This attribute is only available for shipping
   * address.
   *
   * @return companyName
   */
  @Schema(
      description =
          "The company name of the recipient.  **Note**: This attribute is only available for"
              + " shipping address.")
  ...
  /**
   * The phone number of the buyer. **Note**: 1. This attribute is only available for shipping
   * address. 2. In some cases, the buyer phone number is suppressed: a. Phone is suppressed for all
   * &#x60;AFN&#x60; (fulfilled by Amazon) orders. b. Phone is suppressed for the shipped
   * &#x60;MFN&#x60; (fulfilled by seller) order when the current date is past the Latest Delivery
   * Date.
   *
   * @return phone
   */
  @Schema(
      description =
          "The phone number of the buyer.  **Note**:  1. This attribute is only available for"
              + " shipping address. 2. In some cases, the buyer phone number is suppressed:  a."
              + " Phone is suppressed for all `AFN` (fulfilled by Amazon) orders. b. Phone is"
              + " suppressed for the shipped `MFN` (fulfilled by seller) order when the current"
              + " date is past the Latest Delivery Date.")
