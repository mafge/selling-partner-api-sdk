...
public class CreateFeedSpecification {
  ...
  /**
   * The document identifier returned by the createFeedDocument operation. Upload the feed document
  ...
  @Schema(
      required = true,
      description =
          "The document identifier returned by the createFeedDocument operation. Upload the feed"
