...
/**
 * A filter used to select the aggregation time period at which to send notifications (for example:
 * limit to one notification every five minutes for high frequency notifications).
 */
@Schema(
    description =
        "A filter used to select the aggregation time period at which to send notifications (for"
            + " example: limit to one notification every five minutes for high frequency"
            + " notifications).")
