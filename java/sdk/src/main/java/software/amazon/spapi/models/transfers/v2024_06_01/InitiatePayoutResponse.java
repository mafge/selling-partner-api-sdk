...
public class InitiatePayoutResponse {
  ...
  /**
   * The financial event group ID for a successfully initiated payout. You can use this ID to track
   * payout information.
   *
  ...
  @Schema(
      required = true,
      description =
          "The financial event group ID for a successfully initiated payout. You can use this ID to"
