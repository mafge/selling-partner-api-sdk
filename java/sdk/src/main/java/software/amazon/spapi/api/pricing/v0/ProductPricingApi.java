...
public class ProductPricingApi {
    ...
    private final Bucket getCompetitivePricingBucket = Bucket.builder()
            .addLimit(config.getLimit("ProductPricingApi-getCompetitivePricing"))
            .build();

    private final Bucket getItemOffersBucket = Bucket.builder()
            .addLimit(config.getLimit("ProductPricingApi-getItemOffers"))
            .build();

    private final Bucket getItemOffersBatchBucket = Bucket.builder()
            .addLimit(config.getLimit("ProductPricingApi-getItemOffersBatch"))
            .build();

    private final Bucket getListingOffersBucket = Bucket.builder()
            .addLimit(config.getLimit("ProductPricingApi-getListingOffers"))
            .build();

    private final Bucket getListingOffersBatchBucket = Bucket.builder()
            .addLimit(config.getLimit("ProductPricingApi-getListingOffersBatch"))
            .build();

    private final Bucket getPricingBucket = Bucket.builder()
    ...
    public ApiResponse<GetPricingResponse> getCompetitivePricingWithHttpInfo(
        ...
        if (getCompetitivePricingBucket.tryConsume(1)) {
    ...
    public ApiResponse<GetOffersResponse> getItemOffersWithHttpInfo(
        ...
        if (getItemOffersBucket.tryConsume(1)) {
    ...
    public ApiResponse<GetItemOffersBatchResponse> getItemOffersBatchWithHttpInfo(GetItemOffersBatchRequest body)
        ...
        if (getItemOffersBatchBucket.tryConsume(1)) {
    ...
    public ApiResponse<GetOffersResponse> getListingOffersWithHttpInfo(
        ...
        if (getListingOffersBucket.tryConsume(1)) {
            Type localVarReturnType = new TypeToken<GetOffersResponse>() {}.getType();
            return apiClient.execute(call, localVarReturnType);
    ...
    public ApiResponse<GetListingOffersBatchResponse> getListingOffersBatchWithHttpInfo(
        ...
        if (getListingOffersBatchBucket.tryConsume(1)) {
    ...
    public ApiResponse<GetPricingResponse> getPricingWithHttpInfo(
        ...
        if (getPricingBucket.tryConsume(1)) {
            Type localVarReturnType = new TypeToken<GetPricingResponse>() {}.getType();
            return apiClient.execute(call, localVarReturnType);
