...
public class ProductPricingApi {
   ...
   *
   * @param marketplaceId A marketplace identifier. Specifies the marketplace for which prices are
   *     returned. (required)
   * @param itemType Indicates whether ASIN values or seller SKU values are used to identify items.
   *     If you specify Asin, the information in the response will be dependent on the list of Asins
   *     you provide in the Asins parameter. If you specify Sku, the information in the response
   *     will be dependent on the list of Skus you provide in the Skus parameter. Possible values:
   *     Asin, Sku. (required)
   * @param asins A list of up to twenty Amazon Standard Identification Number (ASIN) values used to
   *     identify items in the given marketplace. (optional)
   * @param skus A list of up to twenty seller SKU values used to identify items in the given
   *     marketplace. (optional)
   * @param customerType Indicates whether to request pricing information from the point of view of
   *     Consumer or Business buyers. Default is Consumer. (optional)
   ...
   * or ASIN. **Note:** The parameters associated with this operation may contain special characters
   * that require URL encoding to call the API. To avoid errors with SKUs when encoding URLs, refer
   * to [URL Encoding](https://developer-docs.amazon.com/sp-api/docs/url-encoding). **Usage Plan:**
   * | Rate (requests per second) | Burst | | ---- | ---- | | 0.5 | 1 | The
  ...
  public ApiResponse<GetPricingResponse> getCompetitivePricingWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        getCompetitivePricingValidateBeforeCall(
            marketplaceId, itemType, asins, skus, customerType, null, null);
    Type localVarReturnType = new TypeToken<GetPricingResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Returns competitive pricing information for a seller&#x27;s offer listings
   * based on seller SKU or ASIN. **Note:** The parameters associated with this operation may
   * contain special characters that require URL encoding to call the API. To avoid errors with SKUs
   * when encoding URLs, refer to [URL
   * Encoding](https://developer-docs.amazon.com/sp-api/docs/url-encoding). **Usage Plan:** | Rate
   * (requests per second) | Burst | | ---- | ---- | | 0.5 | 1 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The table above indicates the default rate
   * and burst values for this operation. Selling partners whose business demands require higher
   * throughput may see higher rate and burst values than those shown here. For more information,
   ...
   *     Possible values: New, Used, Collectible, Refurbished, Club. (required)
   * @param asin The Amazon Standard Identification Number (ASIN) of the item. (required)
   * @param customerType Indicates whether to request Consumer or Business offers. Default is
   *     Consumer. (optional)
   * @param progressListener Progress listener
   * @param progressRequestListener Progress request listener
   * @return Call to execute
  ...
  private okhttp3.Call getItemOffersValidateBeforeCall(
    ...
    if (marketplaceId == null) {
      throw new ApiException(
          "Missing the required parameter 'marketplaceId' when calling getItemOffers(Async)");
    }
    // verify the required parameter 'itemCondition' is set
    if (itemCondition == null) {
      throw new ApiException(
          "Missing the required parameter 'itemCondition' when calling getItemOffers(Async)");
    }
    // verify the required parameter 'asin' is set
    if (asin == null) {
      throw new ApiException(
          "Missing the required parameter 'asin' when calling getItemOffers(Async)");
    }
  ...
  /**
   * Returns the lowest priced offers for a single item based on ASIN. **Usage Plan:** | Rate
   * (requests per second) | Burst | | ---- | ---- | | 0.5 | 1 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The table above indicates the default rate
   * and burst values for this operation. Selling partners whose business demands require higher
  ...
  public ApiResponse<GetOffersResponse> getItemOffersWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        getItemOffersValidateBeforeCall(
            marketplaceId, itemCondition, asin, customerType, null, null);
    Type localVarReturnType = new TypeToken<GetOffersResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Returns the lowest priced offers for a single item based on ASIN. **Usage
   * Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 0.5 | 1 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The table above indicates the default rate
   * and burst values for this operation. Selling partners whose business demands require higher
   * throughput may see higher rate and burst values than those shown here. For more information,
  ...
  private okhttp3.Call getItemOffersBatchValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling getItemOffersBatch(Async)");
    }

    okhttp3.Call call = getItemOffersBatchCall(body, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Returns the lowest priced offers for a batch of items based on ASIN. **Usage Plan:** | Rate
   * (requests per second) | Burst | | ---- | ---- | | 0.1 | 1 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The table above indicates the default rate
   * and burst values for this operation. Selling partners whose business demands require higher
   * throughput may see higher rate and burst values than those shown here. For more information,
  ...
  public ApiResponse<GetItemOffersBatchResponse> getItemOffersBatchWithHttpInfo(
      GetItemOffersBatchRequest body) throws ApiException, LWAException {
  ...
  /**
   * (asynchronously) Returns the lowest priced offers for a batch of items based on ASIN. **Usage
   * Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 0.1 | 1 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The table above indicates the default rate
   * and burst values for this operation. Selling partners whose business demands require higher
   * throughput may see higher rate and burst values than those shown here. For more information,
  ...
  public okhttp3.Call getItemOffersBatchAsync(
    ...
    okhttp3.Call call =
        getItemOffersBatchValidateBeforeCall(body, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetItemOffersBatchResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
   ...
   * @param marketplaceId A marketplace identifier. Specifies the marketplace for which prices are
   *     returned. (required)
   * @param itemCondition Filters the offer listings based on item condition. Possible values: New,
   *     Used, Collectible, Refurbished, Club. (required)
   * @param sellerSKU Identifies an item in the given marketplace. SellerSKU is qualified by the
  ...
  private okhttp3.Call getListingOffersValidateBeforeCall(
    ...
    if (sellerSKU == null) {
      throw new ApiException(
          "Missing the required parameter 'sellerSKU' when calling getListingOffers(Async)");
    }
  ...
  /**
   * Returns the lowest priced offers for a single SKU listing. **Note:** The parameters associated
   * with this operation may contain special characters that require URL encoding to call the API.
   * To avoid errors with SKUs when encoding URLs, refer to [URL
   * Encoding](https://developer-docs.amazon.com/sp-api/docs/url-encoding). **Usage Plan:** | Rate
   * (requests per second) | Burst | | ---- | ---- | | 1 | 2 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The table above indicates the default rate
   * and burst values for this operation. Selling partners whose business demands require higher
   * throughput may see higher rate and burst values than those shown here. For more information,
  ...
  public ApiResponse<GetOffersResponse> getListingOffersWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        getListingOffersValidateBeforeCall(
            marketplaceId, itemCondition, sellerSKU, customerType, null, null);
    Type localVarReturnType = new TypeToken<GetOffersResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Returns the lowest priced offers for a single SKU listing. **Note:** The
   * parameters associated with this operation may contain special characters that require URL
  ...
  private okhttp3.Call getListingOffersBatchValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling getListingOffersBatch(Async)");
    }

    okhttp3.Call call = getListingOffersBatchCall(body, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Returns the lowest priced offers for a batch of listings by SKU. **Usage Plan:** | Rate
   * (requests per second) | Burst | | ---- | ---- | | 0.5 | 1 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The table above indicates the default rate
   * and burst values for this operation. Selling partners whose business demands require higher
  ...
  /**
   * (asynchronously) Returns the lowest priced offers for a batch of listings by SKU. **Usage
   * Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 0.5 | 1 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The table above indicates the default rate
   * and burst values for this operation. Selling partners whose business demands require higher
  ...
  public okhttp3.Call getListingOffersBatchAsync(
    ...
    okhttp3.Call call =
        getListingOffersBatchValidateBeforeCall(body, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<GetListingOffersBatchResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
   ...
   *     If you specify Asin, the information in the response will be dependent on the list of Asins
   *     you provide in the Asins parameter. If you specify Sku, the information in the response
   *     will be dependent on the list of Skus you provide in the Skus parameter. (required)
   * @param asins A list of up to twenty Amazon Standard Identification Number (ASIN) values used to
   *     identify items in the given marketplace. (optional)
   * @param skus A list of up to twenty seller SKU values used to identify items in the given
   *     marketplace. (optional)
   * @param itemCondition Filters the offer listings based on item condition. Possible values: New,
   *     Used, Collectible, Refurbished, Club. (optional)
   * @param offerType Indicates whether to request pricing information for the seller&#x27;s B2C or
   *     B2B offers. Default is B2C. (optional)
   * @param progressListener Progress listener
   * @param progressRequestListener Progress request listener
   * @return Call to execute
   * @throws ApiException If fail to serialize the request body object
  ...
  private okhttp3.Call getPricingValidateBeforeCall(
    ...
    if (marketplaceId == null) {
      throw new ApiException(
          "Missing the required parameter 'marketplaceId' when calling getPricing(Async)");
    }
    // verify the required parameter 'itemType' is set
    if (itemType == null) {
      throw new ApiException(
          "Missing the required parameter 'itemType' when calling getPricing(Async)");
    }
   ...
   * require URL encoding to call the API. To avoid errors with SKUs when encoding URLs, refer to
  ...
  /**
   * (asynchronously) Returns pricing information for a seller&#x27;s offer listings based on seller
   * SKU or ASIN. **Note:** The parameters associated with this operation may contain special
   * characters that require URL encoding to call the API. To avoid errors with SKUs when encoding
   * URLs, refer to [URL Encoding](https://developer-docs.amazon.com/sp-api/docs/url-encoding).
   * **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 0.5 | 1 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The table above indicates the default rate
   * and burst values for this operation. Selling partners whose business demands require higher
   * throughput may see higher rate and burst values than those shown here. For more information,
