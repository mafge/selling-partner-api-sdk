...
/**
 * Represents an invoice or credit note document with details about the transaction, parties
 * involved, and line items.
 */
@Schema(
    description =
        "Represents an invoice or credit note document with details about the transaction, parties"
...
public class Invoice {
  ...
  public enum InvoiceTypeEnum {
    ...
    public static class Adapter extends TypeAdapter<InvoiceTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final InvoiceTypeEnum enumeration)
          throws IOException {
  ...
  /**
   * Unique number relating to the charges defined in this document. This will be invoice number if
   * the document type is Invoice or CreditNote number if the document type is Credit Note. Failure
   * to provide this reference will result in a rejection.
   *
   * @return id
   */
  @Schema(
      required = true,
      description =
          "Unique number relating to the charges defined in this document. This will be invoice"
              + " number if the document type is Invoice or CreditNote number if the document type"
              + " is Credit Note. Failure to provide this reference will result in a rejection.")
  public String getId() {
    return id;
  }
