...
@Schema(
    description =
        "Encryption details for required client-side encryption and decryption of document"
            + " contents.")
public class EncryptionDetails {
  ...
  public enum StandardEnum {
    ...
    public static class Adapter extends TypeAdapter<StandardEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final StandardEnum enumeration)
          throws IOException {
