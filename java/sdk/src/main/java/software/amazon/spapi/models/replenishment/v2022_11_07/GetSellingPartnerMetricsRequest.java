...
public class GetSellingPartnerMetricsRequest {
  ...
  /**
   * The list of metrics requested. If no metric value is provided, data for all of the metrics will
   * be returned.
   *
   * @return metrics
   */
  @Schema(
      description =
          "The list of metrics requested. If no metric value is provided, data for all of the"
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GetSellingPartnerMetricsRequest getSellingPartnerMetricsRequest =
        (GetSellingPartnerMetricsRequest) o;
    return Objects.equals(
            this.aggregationFrequency, getSellingPartnerMetricsRequest.aggregationFrequency)
  ...
  public int hashCode() {
    return Objects.hash(
        aggregationFrequency, timeInterval, metrics, timePeriodType, marketplaceId, programTypes);
  }
