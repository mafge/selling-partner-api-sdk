...
/**
 * In this slot format each slot only has the requested capacity types. This slot size is as
 * specified by slot duration.
 */
@Schema(
    description =
        "In this slot format each slot only has the requested capacity types. This slot size is as"
...
public class FixedSlot {
  ...
  /**
   * Scheduled capacity corresponding to the slot. This capacity represents the originally allocated
   * capacity as per resource schedule.
   *
   * @return scheduledCapacity
   */
  @Schema(
      description =
          "Scheduled capacity corresponding to the slot. This capacity represents the originally"
  ...
  /**
   * Available capacity corresponding to the slot. This capacity represents the capacity available
   * for allocation to reservations.
   *
   * @return availableCapacity
   */
  @Schema(
      description =
          "Available capacity corresponding to the slot. This capacity represents the capacity"
  ...
  /**
   * Encumbered capacity corresponding to the slot. This capacity represents the capacity allocated
   * for Amazon Jobs/Appointments/Orders.
   *
   * @return encumberedCapacity
   */
  @Schema(
      description =
          "Encumbered capacity corresponding to the slot. This capacity represents the capacity"
  ...
  /**
   * Reserved capacity corresponding to the slot. This capacity represents the capacity made
  ...
  public int hashCode() {
    return Objects.hash(
        startDateTime, scheduledCapacity, availableCapacity, encumberedCapacity, reservedCapacity);
  }
