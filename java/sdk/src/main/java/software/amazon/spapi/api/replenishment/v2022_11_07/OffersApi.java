...
public class OffersApi {
  ...
  private okhttp3.Call listOfferMetricsValidateBeforeCall(
    ...
    okhttp3.Call call = listOfferMetricsCall(body, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Returns aggregated replenishment program metrics for a selling partner&#x27;s offers. **Usage
   ...
   * @throws LWAException If calls to fetch LWA access token fails
   */
  public ListOfferMetricsResponse listOfferMetrics(ListOfferMetricsRequest body)
      throws ApiException, LWAException {
  ...
  public ApiResponse<ListOfferMetricsResponse> listOfferMetricsWithHttpInfo(
      ListOfferMetricsRequest body) throws ApiException, LWAException {
  ...
  /**
   * (asynchronously) Returns aggregated replenishment program metrics for a selling partner&#x27;s
   * offers. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 1 | 1 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that were
   * applied to the requested operation, when available. The table above indicates the default rate
   * and burst values for this operation. Selling partners whose business demands require higher
   * throughput may see higher rate and burst values than those shown here. For more information,
  ...
  public okhttp3.Call listOfferMetricsAsync(
    ...
    okhttp3.Call call =
        listOfferMetricsValidateBeforeCall(body, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<ListOfferMetricsResponse>() {}.getType();
  ...
  private okhttp3.Call listOffersValidateBeforeCall(
    ...
    okhttp3.Call call = listOffersCall(body, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Returns the details of a selling partner&#x27;s replenishment program offers. **Usage Plan:** |
  ...
  /**
   * (asynchronously) Returns the details of a selling partner&#x27;s replenishment program offers.
  ...
  public okhttp3.Call listOffersAsync(
      ListOffersRequest body, final ApiCallback<ListOffersResponse> callback)
      throws ApiException, LWAException {
    ...
    okhttp3.Call call =
        listOffersValidateBeforeCall(body, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<ListOffersResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
