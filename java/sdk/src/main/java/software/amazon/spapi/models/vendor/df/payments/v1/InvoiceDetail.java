...
/**
 * Represents the details of an invoice, including invoice number, date, parties involved, payment
 * terms, totals, taxes, charges, and line items.
 */
@Schema(
    description =
        "Represents the details of an invoice, including invoice number, date, parties involved,"
            + " payment terms, totals, taxes, charges, and line items.")
