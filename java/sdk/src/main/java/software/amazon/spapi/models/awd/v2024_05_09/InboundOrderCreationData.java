...
public class InboundOrderCreationData {
  ...
  private List<DistributionPackageQuantity> packagesToInbound =
  ...
  public InboundOrderCreationData packagesToInbound(
      List<DistributionPackageQuantity> packagesToInbound) {
    this.packagesToInbound = packagesToInbound;
    return this;
  }

  public InboundOrderCreationData addPackagesToInboundItem(
      DistributionPackageQuantity packagesToInboundItem) {
