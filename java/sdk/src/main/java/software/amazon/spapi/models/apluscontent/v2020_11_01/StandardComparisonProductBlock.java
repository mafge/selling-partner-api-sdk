...
public class StandardComparisonProductBlock {
  ...
  /**
   * The rank or index of this comparison product block within the module. Different blocks cannot
   * occupy the same position within a single module. minimum: 1 maximum: 6
   *
   * @return position
   */
  @Schema(
      required = true,
      description =
          "The rank or index of this comparison product block within the module. Different blocks"
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StandardComparisonProductBlock standardComparisonProductBlock =
        (StandardComparisonProductBlock) o;
