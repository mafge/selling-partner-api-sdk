...
public class ItemSummaryByMarketplace {
  ...
  /**
   * The fulfillment network stock keeping unit is an identifier used by Amazon fulfillment centers
   * to identify each unique item.
   *
   * @return fnSku
   */
  @Schema(
      description =
          "The fulfillment network stock keeping unit is an identifier used by Amazon fulfillment"
