...
public class Shipment {
  ...
  /**
   * The identifier of a placement option. A placement option represents the shipment splits and
  ...
  @Schema(
      required = true,
      description =
          "The identifier of a placement option. A placement option represents the shipment splits"
              + " and destinations of SKUs.")
  ...
  /**
   * Identifier of a transportation option. A transportation option represent one option for how to
   * send a shipment.
   *
  ...
  @Schema(
      description =
          "Identifier of a transportation option. A transportation option represent one option for"
  ...
  public Shipment selfShipAppointmentDetails(
      List<SelfShipAppointmentDetails> selfShipAppointmentDetails) {
    this.selfShipAppointmentDetails = selfShipAppointmentDetails;
    return this;
  }

  public Shipment addSelfShipAppointmentDetailsItem(
      SelfShipAppointmentDetails selfShipAppointmentDetailsItem) {
  ...
  public void setSelfShipAppointmentDetails(
      List<SelfShipAppointmentDetails> selfShipAppointmentDetails) {
    this.selfShipAppointmentDetails = selfShipAppointmentDetails;
  }
  ...
  /**
   * The status of a shipment. The state of the shipment will typically start as
   * &#x60;UNCONFIRMED&#x60;, then transition to &#x60;WORKING&#x60; after a placement option has
   * been confirmed, and then to &#x60;READY_TO_SHIP&#x60; once labels are generated. Possible
   * values: &#x60;ABANDONED&#x60;, &#x60;CANCELLED&#x60;, &#x60;CHECKED_IN&#x60;,
   * &#x60;CLOSED&#x60;, &#x60;DELETED&#x60;, &#x60;DELIVERED&#x60;, &#x60;IN_TRANSIT&#x60;,
   * &#x60;MIXED&#x60;, &#x60;READY_TO_SHIP&#x60;, &#x60;RECEIVING&#x60;, &#x60;SHIPPED&#x60;,
   * &#x60;UNCONFIRMED&#x60;, &#x60;WORKING&#x60;
   *
   * @return status
   */
  @Schema(
      description =
          "The status of a shipment. The state of the shipment will typically start as"
              + " `UNCONFIRMED`, then transition to `WORKING` after a placement option has been"
              + " confirmed, and then to `READY_TO_SHIP` once labels are generated.  Possible"
              + " values: `ABANDONED`, `CANCELLED`, `CHECKED_IN`, `CLOSED`, `DELETED`, `DELIVERED`,"
              + " `IN_TRANSIT`, `MIXED`, `READY_TO_SHIP`, `RECEIVING`, `SHIPPED`, `UNCONFIRMED`,"
              + " `WORKING`")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.amazonReferenceId, shipment.amazonReferenceId)
        ...
        && Objects.equals(
            this.selectedTransportationOptionId, shipment.selectedTransportationOptionId)
