...
public class HttpResponseHeaders extends HashMap<String, String> {
  ...
  /**
   * The timestamp that the API request was received. For more information, consult [RFC 2616
  ...
  @Schema(
      description =
          "The timestamp that the API request was received.  For more information, consult [RFC"
