...
public class OrderItem {
  ...
  /**
   * The category of deemed reseller. This applies to selling partners that are not based in the EU
   * and is used to help them meet the VAT Deemed Reseller tax laws in the EU and UK.
   */
  ...
  /**
   * A list of associated items that a customer has purchased with a product. For example, a tire
   * installation service purchased with tires.
   *
   * @return associatedItems
   */
  @Schema(
      description =
          "A list of associated items that a customer has purchased with a product. For example, a"
              + " tire installation service purchased with tires.")
  ...
  /**
   * Indicates whether the item is a gift. **Possible values**: &#x60;true&#x60; and
   * &#x60;false&#x60;.
   *
   * @return isGift
   */
  ...
  /**
   * The condition of the item. **Possible values**: &#x60;New&#x60;, &#x60;Used&#x60;,
   * &#x60;Collectible&#x60;, &#x60;Refurbished&#x60;, &#x60;Preorder&#x60;, and &#x60;Club&#x60;.
   *
   * @return conditionId
   */
  @Schema(
  ...
  /**
   * The subcondition of the item. **Possible values**: &#x60;New&#x60;, &#x60;Mint&#x60;,
   * &#x60;Very Good&#x60;, &#x60;Good&#x60;, &#x60;Acceptable&#x60;, &#x60;Poor&#x60;,
   * &#x60;Club&#x60;, &#x60;OEM&#x60;, &#x60;Warranty&#x60;, &#x60;Refurbished Warranty&#x60;,
   * &#x60;Refurbished&#x60;, &#x60;Open Box&#x60;, &#x60;Any&#x60;, and &#x60;Other&#x60;.
   *
  ...
  @Schema(
      description =
          "The subcondition of the item.  **Possible values**: `New`, `Mint`, `Very Good`, `Good`,"
              + " `Acceptable`, `Poor`, `Club`, `OEM`, `Warranty`, `Refurbished Warranty`,"
              + " `Refurbished`, `Open Box`, `Any`, and `Other`.")
  ...
  /**
   * The start date of the scheduled delivery window in the time zone for the order destination. In
  ...
  @Schema(
      description =
          "The start date of the scheduled delivery window in the time zone for the order"
              + " destination. In [ISO"
  ...
  /**
   * The end date of the scheduled delivery window in the time zone for the order destination. In
   * [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date time format.
   *
  ...
  @Schema(
      description =
          "The end date of the scheduled delivery window in the time zone for the order"
              + " destination. In [ISO"
              + " 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date time format.")
   ...
   * orders. For more information about the Amazon Business Seller Program, refer to the [Amazon
   * Business website](https://www.amazon.com/b2b/info/amazon-business). **Possible values**:
   * &#x60;BusinessPrice&#x60;
   *
  ...
  @Schema(
      description =
          "Indicates that the selling price is a special price that is only available for Amazon"
              + " Business orders. For more information about the Amazon Business Seller Program,"
              + " refer to the [Amazon Business"
              + " website](https://www.amazon.com/b2b/info/amazon-business).   **Possible values**:"
              + " `BusinessPrice`")
  ...
  /**
   * When true, the product type for this item has a serial number. Only returned for Amazon Easy
   * Ship orders.
   *
  ...
  @Schema(
      description =
          "When true, the product type for this item has a serial number.   Only returned for"
  ...
  /**
   * When true, the ASIN is enrolled in Transparency. The Transparency serial number that you must
   * submit is determined by: **1D or 2D Barcode:** This has a **T** logo. Submit either the
   * 29-character alpha-numeric identifier beginning with **AZ** or **ZA**, or the 38-character
   * Serialized Global Trade Item Number (SGTIN). **2D Barcode SN:** Submit the 7- to 20-character
   * serial number barcode, which likely has the prefix **SN**. The serial number is applied to the
   * same side of the packaging as the GTIN (UPC/EAN/ISBN) barcode. **QR code SN:** Submit the URL
   * that the QR code generates.
   *
   * @return isTransparency
   */
  @Schema(
      description =
          "When true, the ASIN is enrolled in Transparency. The Transparency serial number that you"
              + " must submit is determined by:  **1D or 2D Barcode:** This has a **T** logo."
              + " Submit either the 29-character alpha-numeric identifier beginning with **AZ** or"
              + " **ZA**, or the 38-character Serialized Global Trade Item Number (SGTIN). **2D"
              + " Barcode SN:** Submit the 7- to 20-character serial number barcode, which likely"
              + " has the prefix **SN**. The serial number is applied to the same side of the"
              + " packaging as the GTIN (UPC/EAN/ISBN) barcode. **QR code SN:** Submit the URL that"
              + " the QR code generates.")
  ...
  /**
   * The IOSS number of the marketplace. Sellers shipping to the EU from outside the EU must provide
  ...
  @Schema(
      description =
          "The IOSS number of the marketplace. Sellers shipping to the EU from outside the EU must"
              + " provide this IOSS number to their carrier when Amazon has collected the VAT on"
              + " the sale.")
  ...
  @Schema(
      description =
          "The category of deemed reseller. This applies to selling partners that are not based in"
              + " the EU and is used to help them meet the VAT Deemed Reseller tax laws in the EU"
              + " and UK.")
  ...
  /**
   * A list of serial numbers for electronic products that are shipped to customers. Returned for
   * FBA orders only.
   *
