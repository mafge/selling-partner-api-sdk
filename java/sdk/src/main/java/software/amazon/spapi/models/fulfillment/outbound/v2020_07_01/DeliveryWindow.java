...
/**
 * The time range within which a Scheduled Delivery fulfillment order should be delivered. This is
 * only available in the JP marketplace.
 */
@Schema(
    description =
        "The time range within which a Scheduled Delivery fulfillment order should be delivered."
            + " This is only available in the JP marketplace.")
