...
/**
 * This field represents weight unit of measure of items that are ordered by cases and supporting
 * priced by weight.
 */
...
public enum NetCostUnitOfMeasure {
  ...
  public static class Adapter extends TypeAdapter<NetCostUnitOfMeasure> {
    @Override
    public void write(final JsonWriter jsonWriter, final NetCostUnitOfMeasure enumeration)
        throws IOException {
