...
public enum AggregationFrequency {
  ...
  public static AggregationFrequency fromValue(String input) {
  ...
  public static class Adapter extends TypeAdapter<AggregationFrequency> {
    @Override
    public void write(final JsonWriter jsonWriter, final AggregationFrequency enumeration)
        throws IOException {
    ...
    public AggregationFrequency read(final JsonReader jsonReader) throws IOException {
      ...
      return AggregationFrequency.fromValue((String) (value));
    }
  }
}
