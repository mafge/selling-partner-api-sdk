...
/**
 * Summarized inventory details. This object will not appear if the details parameter in the request
 * is false.
 */
@Schema(
    description =
        "Summarized inventory details. This object will not appear if the details parameter in the"
            + " request is false.")
public class InventoryDetails {
  ...
  /**
   * The number of units in an inbound shipment that you have notified Amazon about and have
  ...
  /**
   * The number of units that have not yet been received at an Amazon fulfillment center for
   * processing, but are part of an inbound shipment with some units that have already been received
   * and processed.
   *
  ...
  @Schema(
      description =
          "The number of units that have not yet been received at an Amazon fulfillment center for"
              + " processing, but are part of an inbound shipment with some units that have already"
