...
public class ItemQuantity {
  ...
  /**
   * Quantity of units shipped for a specific item at a shipment level. If the item is present only
   * in certain packages or pallets within the shipment, please provide this at the appropriate
   * package or pallet level.
   *
   * @return amount
   */
  @Schema(
      required = true,
      description =
          "Quantity of units shipped for a specific item at a shipment level. If the item is"
              + " present only in certain packages or pallets within the shipment, please provide"
              + " this at the appropriate package or pallet level.")
