...
public class SelectedDeliveryWindow {
  ...
  /**
   * Identifies type of Delivery Window Availability. Values: &#x60;AVAILABLE&#x60;,
   * &#x60;CONGESTED&#x60;
   *
  ...
  /**
   * Identifier of a delivery window option. A delivery window option represent one option for when
   * a shipment is expected to be delivered.
   *
  ...
  @Schema(
      required = true,
      description =
          "Identifier of a delivery window option. A delivery window option represent one option"
              + " for when a shipment is expected to be delivered.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.availabilityType, selectedDeliveryWindow.availabilityType)
        && Objects.equals(
            this.deliveryWindowOptionId, selectedDeliveryWindow.deliveryWindowOptionId)
  ...
  public int hashCode() {
    return Objects.hash(
        availabilityType, deliveryWindowOptionId, editableUntil, endDate, startDate);
  }
