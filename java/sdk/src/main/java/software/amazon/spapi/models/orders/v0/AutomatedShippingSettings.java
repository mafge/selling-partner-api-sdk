...
/**
 * Contains information regarding the Shipping Settings Automation program, such as whether the
 * order&#x27;s shipping settings were generated automatically, and what those settings are.
 */
@Schema(
    description =
        "Contains information regarding the Shipping Settings Automation program, such as whether"
            + " the order's shipping settings were generated automatically, and what those settings"
            + " are.")
public class AutomatedShippingSettings {
  ...
  public AutomatedShippingSettings hasAutomatedShippingSettings(
      Boolean hasAutomatedShippingSettings) {
    this.hasAutomatedShippingSettings = hasAutomatedShippingSettings;
    return this;
  }

  /**
   * When true, this order has automated shipping settings generated by Amazon. This order could be
   * identified as an SSA order.
   *
   * @return hasAutomatedShippingSettings
   */
  @Schema(
      description =
          "When true, this order has automated shipping settings generated by Amazon. This order"
              + " could be identified as an SSA order.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(
            this.hasAutomatedShippingSettings,
