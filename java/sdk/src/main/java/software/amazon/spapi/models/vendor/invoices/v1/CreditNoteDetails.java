...
/**
 * References required in order to process a credit note. This information is required only if
 * InvoiceType is CreditNote.
 */
@Schema(
    description =
        "References required in order to process a credit note. This information is required only"
            + " if InvoiceType is CreditNote.")
public class CreditNoteDetails {
  ...
  /**
   * Original Invoice Number when sending a credit note relating to an existing invoice. One Invoice
   * only to be processed per Credit Note. This is mandatory for AP Credit Notes.
   *
   * @return referenceInvoiceNumber
   */
  @Schema(
      description =
          "Original Invoice Number when sending a credit note relating to an existing invoice. One"
              + " Invoice only to be processed per Credit Note. This is mandatory for AP Credit"
              + " Notes.")
  ...
  @Schema(
      description =
          "Debit Note Number as generated by Amazon. Recommended for Returns and COOP Credit"
              + " Notes.")
  ...
  /**
   * Identifies the COOP reference used for COOP agreement. Failure to provide the COOP reference
  ...
  @Schema(
      description =
          "Identifies the COOP reference used for COOP agreement. Failure to provide the COOP"
              + " reference number or the Debit Note number may lead to a rejection of the Credit"
              + " Note.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.referenceInvoiceNumber, creditNoteDetails.referenceInvoiceNumber)
        ...
        && Objects.equals(
            this.consignorsReferenceNumber, creditNoteDetails.consignorsReferenceNumber);
  }
