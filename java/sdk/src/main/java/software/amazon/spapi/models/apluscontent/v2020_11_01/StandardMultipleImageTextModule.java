...
/**
 * Standard images with text, presented one at a time. The user clicks on thumbnails to view each
 * block.
 */
@Schema(
    description =
        "Standard images with text, presented one at a time. The user clicks on thumbnails to view"
            + " each block.")
public class StandardMultipleImageTextModule {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StandardMultipleImageTextModule standardMultipleImageTextModule =
        (StandardMultipleImageTextModule) o;
