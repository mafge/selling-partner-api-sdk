...
/**
 * A listing restriction, optionally qualified by a condition, with a list of reasons for the
 * restriction.
 */
@Schema(
    description =
...
public class Restriction {
  ...
  @Schema(
      required = true,
      description =
          "A marketplace identifier. Identifies the Amazon marketplace where the restriction is"
              + " enforced.")
