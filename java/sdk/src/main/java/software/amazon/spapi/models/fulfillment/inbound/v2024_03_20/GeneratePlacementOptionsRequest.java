...
public class GeneratePlacementOptionsRequest {
  ...
  public GeneratePlacementOptionsRequest customPlacement(
      List<CustomPlacementInput> customPlacement) {
    this.customPlacement = customPlacement;
    return this;
  }

  public GeneratePlacementOptionsRequest addCustomPlacementItem(
      CustomPlacementInput customPlacementItem) {
  ...
  /**
   * Custom placement options you want to add to the plan. This is only used for the India (IN -
  ...
  @Schema(
      description =
          "Custom placement options you want to add to the plan. This is only used for the India"
              + " (IN - A21TJRUUN4KGV) marketplace.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GeneratePlacementOptionsRequest generatePlacementOptionsRequest =
        (GeneratePlacementOptionsRequest) o;
