...
public class CreateConfirmCustomizationDetailsRequest {
  ...
  /**
   * The text to be sent to the buyer. Only links related to customization details are allowed. Do
   * not include HTML or email addresses. The text must be written in the buyer&#x27;s language of
  ...
  @Schema(
      description =
          "The text to be sent to the buyer. Only links related to customization details are"
