...
public class Query {
  ...
  public enum ProcessingStatusEnum {
    ...
    public static class Adapter extends TypeAdapter<ProcessingStatusEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ProcessingStatusEnum enumeration)
          throws IOException {
  ...
  /**
   * The query identifier. This identifier is unique only in combination with a selling partner
   * account ID.
   *
   * @return queryId
   */
  @Schema(
      required = true,
      description =
          "The query identifier. This identifier is unique only in combination with a selling"
              + " partner account ID.")
  ...
  /**
   * The data document identifier. This identifier is only present when there is data available as a
   * result of the query. This identifier is unique only in combination with a selling partner
   * account ID. Pass this identifier into the &#x60;getDocument&#x60; operation to get the
  ...
  @Schema(
      description =
          "The data document identifier. This identifier is only present when there is data"
              + " available as a result of the query. This identifier is unique only in combination"
              + " with a selling partner account ID. Pass this identifier into the `getDocument`"
              + " operation to get the information required to retrieve the data document's"
              + " contents.")
  ...
  /**
   * The error document identifier. This identifier is only present when an error occurs during
   * query processing. This identifier is unique only in combination with a selling partner account
   * ID. Pass this identifier into the &#x60;getDocument&#x60; operation to get the information
  ...
  @Schema(
      description =
          "The error document identifier. This identifier is only present when an error occurs"
              + " during query processing. This identifier is unique only in combination with a"
              + " selling partner account ID. Pass this identifier into the `getDocument` operation"
