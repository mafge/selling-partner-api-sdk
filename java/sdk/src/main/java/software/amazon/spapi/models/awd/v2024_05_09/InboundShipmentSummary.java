...
/**
 * Summary for an AWD inbound shipment containing the shipment ID, which can be used to retrieve the
 * actual shipment.
 */
@Schema(
    description =
        "Summary for an AWD inbound shipment containing the shipment ID, which can be used to"
...
public class InboundShipmentSummary {
  ...
  /**
   * Optional client-provided reference ID that can be used to correlate this shipment with client
  ...
  @Schema(
      ...
      description =
          "Optional client-provided reference ID that can be used to correlate this shipment with"
              + " client resources. For example, to map this shipment to an internal bookkeeping"
              + " order record.")
  ...
  public int hashCode() {
    return Objects.hash(
        createdAt, externalReferenceId, orderId, shipmentId, shipmentStatus, updatedAt);
  }
