...
public class InvoiceItem {
  ...
  /**
   * The vendor selected product identifier of the item. Should be the same as was provided in the
   * purchase order.
   *
  ...
  @Schema(
      description =
          "The vendor selected product identifier of the item. Should be the same as was provided"
  ...
  /**
   * The Amazon purchase order number for this invoiced line item. Formatting Notes: 8-character
   * alpha-numeric code. This value is mandatory only when invoiceType is Invoice, and is not
   * required when invoiceType is CreditNote.
   *
