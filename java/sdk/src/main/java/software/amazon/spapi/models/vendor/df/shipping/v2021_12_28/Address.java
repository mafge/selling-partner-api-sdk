...
public class Address {
   ...
   * @return addressLine1
   */
  @Schema(required = true, description = "First line of the address.")
  ...
  /**
   * The postal code of that address. It contains a series of letters or digits or both, sometimes
  ...
  @Schema(
      required = true,
      description =
          "The two-letter country code in [ISO 3166-1 alpha-2](https://www.iban.com/country-codes)"
              + " format.")
