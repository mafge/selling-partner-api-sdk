...
public class AplusContentApi {
   ...
   * @param marketplaceId The marketplace ID is the globally unique identifier of a marketplace. To
  ...
  private okhttp3.Call createContentDocumentValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling createContentDocument(Async)");
    }
    // verify the required parameter 'marketplaceId' is set
    if (marketplaceId == null) {
      throw new ApiException(
          "Missing the required parameter 'marketplaceId' when calling"
              + " createContentDocument(Async)");
    }

    okhttp3.Call call =
        createContentDocumentCall(body, marketplaceId, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Creates a new A+ Content document. **Usage Plan:** | Rate (requests per second) | Burst | |
   * ---- | ---- | | 10 | 10 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header contains the
  ...
  public PostContentDocumentResponse createContentDocument(
    ...
    ApiResponse<PostContentDocumentResponse> resp =
        createContentDocumentWithHttpInfo(body, marketplaceId);
    return resp.getData();
  }
  ...
  /**
   * (asynchronously) Creates a new A+ Content document. **Usage Plan:** | Rate (requests per
   * second) | Burst | | ---- | ---- | | 10 | 10 | The &#x60;x-amzn-RateLimit-Limit&#x60; response
  ...
  public okhttp3.Call createContentDocumentAsync(
    ...
    okhttp3.Call call =
        createContentDocumentValidateBeforeCall(
   ...
   *
   * @param contentReferenceKey The unique reference key for the A+ Content document. A content
   *     reference key cannot form a permalink and might change in the future. A content reference
   *     key is not guaranteed to match any A+ Content identifier. (required)
   * @param marketplaceId The marketplace ID is the globally unique identifier of a marketplace. To
   *     find the ID for your marketplace, refer to [Marketplace
   *     IDs](https://developer-docs.amazon.com/sp-api/docs/marketplace-ids). (required)
  ...
  public okhttp3.Call getContentDocumentCall(
    ...
    if (includedDataSet != null)
      localVarCollectionQueryParams.addAll(
          apiClient.parameterToPairs("csv", "includedDataSet", includedDataSet));
  ...
  private okhttp3.Call getContentDocumentValidateBeforeCall(
    ...
    if (contentReferenceKey == null) {
      throw new ApiException(
          "Missing the required parameter 'contentReferenceKey' when calling"
    ...
    if (includedDataSet == null) {
      throw new ApiException(
          "Missing the required parameter 'includedDataSet' when calling"
              + " getContentDocument(Async)");
    }
  ...
  /**
   * Returns an A+ Content document, if available. **Usage Plan:** | Rate (requests per second) |
   * Burst | | ---- | ---- | | 10 | 10 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header
  ...
  public ApiResponse<GetContentDocumentResponse> getContentDocumentWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        getContentDocumentValidateBeforeCall(
            contentReferenceKey, marketplaceId, includedDataSet, null, null);
    Type localVarReturnType = new TypeToken<GetContentDocumentResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Returns an A+ Content document, if available. **Usage Plan:** | Rate (requests
   * per second) | Burst | | ---- | ---- | | 10 | 10 | The &#x60;x-amzn-RateLimit-Limit&#x60;
   * response header contains the usage plan rate limits for the operation, when available. The
   * preceding table contains the default rate and burst values for this operation. Selling partners
   * whose business demands require higher throughput might have higher rate and burst values than
   ...
   *     find the ID for your marketplace, refer to [Marketplace
   *     IDs](https://developer-docs.amazon.com/sp-api/docs/marketplace-ids). (required)
   * @param includedDataSet The set of A+ Content data types to include in the response. If you
   *     don&#x27;t include this parameter, the operation returns the related ASINs without
   *     metadata. (optional)
   * @param asinSet The set of ASINs. (optional)
   * @param pageToken A token that you use to fetch a specific page when there are multiple pages of
   *     results. (optional)
   * @param progressListener Progress listener
   * @param progressRequestListener Progress request listener
   * @return Call to execute
  ...
  private okhttp3.Call listContentDocumentAsinRelationsValidateBeforeCall(
    ...
    if (contentReferenceKey == null) {
      throw new ApiException(
          "Missing the required parameter 'contentReferenceKey' when calling"
              + " listContentDocumentAsinRelations(Async)");
    }
    // verify the required parameter 'marketplaceId' is set
    if (marketplaceId == null) {
      throw new ApiException(
  ...
  /**
   * Returns a list of ASINs that are related to the specified A+ Content document, if available. If
   * you don&#x27;t include the &#x60;asinSet&#x60; parameter, this operation returns all ASINs
   * related to the content document. **Usage Plan:** | Rate (requests per second) | Burst | | ----
   * | ---- | | 10 | 10 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header contains the usage
  ...
  public ListContentDocumentAsinRelationsResponse listContentDocumentAsinRelations(
      ...
      String pageToken)
      throws ApiException, LWAException {
    ApiResponse<ListContentDocumentAsinRelationsResponse> resp =
   ...
   * @throws LWAException If calls to fetch LWA access token fails
   */
  public ApiResponse<ListContentDocumentAsinRelationsResponse>
      listContentDocumentAsinRelationsWithHttpInfo(
          String contentReferenceKey,
          String marketplaceId,
          List<String> includedDataSet,
          ...
          throws ApiException, LWAException {
    okhttp3.Call call =
        listContentDocumentAsinRelationsValidateBeforeCall(
            contentReferenceKey, marketplaceId, includedDataSet, asinSet, pageToken, null, null);
    Type localVarReturnType =
        new TypeToken<ListContentDocumentAsinRelationsResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Returns a list of ASINs that are related to the specified A+ Content document,
   * if available. If you don&#x27;t include the &#x60;asinSet&#x60; parameter, this operation
   * returns all ASINs related to the content document. **Usage Plan:** | Rate (requests per second)
   * | Burst | | ---- | ---- | | 10 | 10 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header
   * contains the usage plan rate limits for the operation, when available. The preceding table
   * contains the default rate and burst values for this operation. Selling partners whose business
   * demands require higher throughput might have higher rate and burst values than those shown
  ...
  private okhttp3.Call postContentDocumentApprovalSubmissionValidateBeforeCall(
    ...
    if (contentReferenceKey == null) {
      throw new ApiException(
          "Missing the required parameter 'contentReferenceKey' when calling"
              + " postContentDocumentApprovalSubmission(Async)");
    }
    // verify the required parameter 'marketplaceId' is set
    if (marketplaceId == null) {
      throw new ApiException(
  ...
  /**
   * Submits an A+ Content document for review, approval, and publishing. **Usage Plan:** | Rate
   ...
   * @throws LWAException If calls to fetch LWA access token fails
   */
  public ApiResponse<PostContentDocumentApprovalSubmissionResponse>
      postContentDocumentApprovalSubmissionWithHttpInfo(
          String contentReferenceKey, String marketplaceId) throws ApiException, LWAException {
    okhttp3.Call call =
        postContentDocumentApprovalSubmissionValidateBeforeCall(
            contentReferenceKey, marketplaceId, null, null);
    Type localVarReturnType =
        new TypeToken<PostContentDocumentApprovalSubmissionResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Submits an A+ Content document for review, approval, and publishing. **Usage
   * Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 10 | 10 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header contains the usage plan rate limits for the
   * operation, when available. The preceding table contains the default rate and burst values for
   * this operation. Selling partners whose business demands require higher throughput might have
   * higher rate and burst values than those shown here. For more information, refer to [Usage Plans
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling"
              + " postContentDocumentAsinRelations(Async)");
    }
    // verify the required parameter 'contentReferenceKey' is set
    if (contentReferenceKey == null) {
      throw new ApiException(
  ...
  /**
   * Replaces all ASINs related to the specified A+ Content document, if available. This operation
   * can add or remove ASINs, depending on the current set of related ASINs. Removing an ASIN will
   * suspend the content document from that ASIN. **Usage Plan:** | Rate (requests per second) |
   * Burst | | ---- | ---- | | 10 | 10 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header
   * contains the usage plan rate limits for the operation, when available. The preceding table
   * contains the default rate and burst values for this operation. Selling partners whose business
   * demands require higher throughput might have higher rate and burst values than those shown
   ...
   * @throws LWAException If calls to fetch LWA access token fails
   */
  public ApiResponse<PostContentDocumentAsinRelationsResponse>
      postContentDocumentAsinRelationsWithHttpInfo(
          ...
          throws ApiException, LWAException {
    okhttp3.Call call =
        postContentDocumentAsinRelationsValidateBeforeCall(
            body, contentReferenceKey, marketplaceId, null, null);
    Type localVarReturnType =
        new TypeToken<PostContentDocumentAsinRelationsResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Replaces all ASINs related to the specified A+ Content document, if available.
   * This operation can add or remove ASINs, depending on the current set of related ASINs. Removing
   * an ASIN will suspend the content document from that ASIN. **Usage Plan:** | Rate (requests per
   * second) | Burst | | ---- | ---- | | 10 | 10 | The &#x60;x-amzn-RateLimit-Limit&#x60; response
   * header contains the usage plan rate limits for the operation, when available. The preceding
   * table contains the default rate and burst values for this operation. Selling partners whose
   * business demands require higher throughput might have higher rate and burst values than those
  ...
  private okhttp3.Call postContentDocumentSuspendSubmissionValidateBeforeCall(
    ...
    if (contentReferenceKey == null) {
      throw new ApiException(
          "Missing the required parameter 'contentReferenceKey' when calling"
              + " postContentDocumentSuspendSubmission(Async)");
    }
    // verify the required parameter 'marketplaceId' is set
    if (marketplaceId == null) {
      throw new ApiException(
  ...
  /**
   * Submits a request to suspend visible A+ Content. This doesn&#x27;t delete the content document
   * or the ASIN relations. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | |
   ...
   * @throws LWAException If calls to fetch LWA access token fails
   */
  public ApiResponse<PostContentDocumentSuspendSubmissionResponse>
      postContentDocumentSuspendSubmissionWithHttpInfo(
          String contentReferenceKey, String marketplaceId) throws ApiException, LWAException {
    okhttp3.Call call =
        postContentDocumentSuspendSubmissionValidateBeforeCall(
            contentReferenceKey, marketplaceId, null, null);
    Type localVarReturnType =
        new TypeToken<PostContentDocumentSuspendSubmissionResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Submits a request to suspend visible A+ Content. This doesn&#x27;t delete the
   * content document or the ASIN relations. **Usage Plan:** | Rate (requests per second) | Burst |
   * | ---- | ---- | | 10 | 10 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header contains the
   * usage plan rate limits for the operation, when available. The preceding table contains the
   * default rate and burst values for this operation. Selling partners whose business demands
   * require higher throughput might have higher rate and burst values than those shown here. For
  ...
  /**
   * Returns a list of all A+ Content documents, including metadata, that are assigned to a selling
   * partner. To get the actual contents of the A+ Content documents, call the
   * &#x60;getContentDocument&#x60; operation. **Usage Plan:** | Rate (requests per second) | Burst
   * | | ---- | ---- | | 10 | 10 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header contains
   * the usage plan rate limits for the operation, when available. The preceding table contains the
   * default rate and burst values for this operation. Selling partners whose business demands
   * require higher throughput might have higher rate and burst values than those shown here. For
   * more information, refer to [Usage Plans and Rate
   * Limits](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits-in-the-sp-api).
  ...
  public SearchContentDocumentsResponse searchContentDocuments(
    ...
    ApiResponse<SearchContentDocumentsResponse> resp =
        searchContentDocumentsWithHttpInfo(marketplaceId, pageToken);
    return resp.getData();
  }
  ...
  public ApiResponse<SearchContentDocumentsResponse> searchContentDocumentsWithHttpInfo(
      String marketplaceId, String pageToken) throws ApiException, LWAException {
    okhttp3.Call call =
        searchContentDocumentsValidateBeforeCall(marketplaceId, pageToken, null, null);
    Type localVarReturnType = new TypeToken<SearchContentDocumentsResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Returns a list of all A+ Content documents, including metadata, that are
   * assigned to a selling partner. To get the actual contents of the A+ Content documents, call the
   * &#x60;getContentDocument&#x60; operation. **Usage Plan:** | Rate (requests per second) | Burst
   * | | ---- | ---- | | 10 | 10 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header contains
   * the usage plan rate limits for the operation, when available. The preceding table contains the
   * default rate and burst values for this operation. Selling partners whose business demands
  ...
  public okhttp3.Call searchContentDocumentsAsync(
    ...
    okhttp3.Call call =
        searchContentDocumentsValidateBeforeCall(
            marketplaceId, pageToken, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<SearchContentDocumentsResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
   ...
   *     find the ID for your marketplace, refer to [Marketplace
   *     IDs](https://developer-docs.amazon.com/sp-api/docs/marketplace-ids). (required)
   * @param asin The Amazon Standard Identification Number (ASIN) is the unique identifier of a
   *     product within a marketplace. (required)
   * @param pageToken A token that you use to fetch a specific page when there are multiple pages of
   *     results. (optional)
   * @param progressListener Progress listener
   * @param progressRequestListener Progress request listener
  ...
  private okhttp3.Call searchContentPublishRecordsValidateBeforeCall(
    ...
    if (marketplaceId == null) {
      throw new ApiException(
          "Missing the required parameter 'marketplaceId' when calling"
              + " searchContentPublishRecords(Async)");
    }
  ...
  /**
   * Searches for A+ Content publishing records, if available. **Usage Plan:** | Rate (requests per
   * second) | Burst | | ---- | ---- | | 10 | 10 | The &#x60;x-amzn-RateLimit-Limit&#x60; response
   * header contains the usage plan rate limits for the operation, when available. The preceding
   * table contains the default rate and burst values for this operation. Selling partners whose
   * business demands require higher throughput might have higher rate and burst values than those
  ...
  public ApiResponse<SearchContentPublishRecordsResponse> searchContentPublishRecordsWithHttpInfo(
      String marketplaceId, String asin, String pageToken) throws ApiException, LWAException {
    okhttp3.Call call =
        searchContentPublishRecordsValidateBeforeCall(marketplaceId, asin, pageToken, null, null);
    Type localVarReturnType = new TypeToken<SearchContentPublishRecordsResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Searches for A+ Content publishing records, if available. **Usage Plan:** |
  ...
  public okhttp3.Call searchContentPublishRecordsAsync(
    ...
    okhttp3.Call call =
        searchContentPublishRecordsValidateBeforeCall(
            marketplaceId, asin, pageToken, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<SearchContentPublishRecordsResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  ...
  private okhttp3.Call updateContentDocumentValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling updateContentDocument(Async)");
    }
    // verify the required parameter 'contentReferenceKey' is set
    if (contentReferenceKey == null) {
      throw new ApiException(
          "Missing the required parameter 'contentReferenceKey' when calling"
              + " updateContentDocument(Async)");
    }
    // verify the required parameter 'marketplaceId' is set
    if (marketplaceId == null) {
      throw new ApiException(
  ...
  public ApiResponse<PostContentDocumentResponse> updateContentDocumentWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        updateContentDocumentValidateBeforeCall(
            body, contentReferenceKey, marketplaceId, null, null);
    Type localVarReturnType = new TypeToken<PostContentDocumentResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }
  ...
  /**
   * (asynchronously) Updates an existing A+ Content document. **Usage Plan:** | Rate (requests per
   * second) | Burst | | ---- | ---- | | 10 | 10 | The &#x60;x-amzn-RateLimit-Limit&#x60; response
   * header contains the usage plan rate limits for the operation, when available. The preceding
   * table contains the default rate and burst values for this operation. Selling partners whose
   * business demands require higher throughput might have higher rate and burst values than those
  ...
  private okhttp3.Call validateContentDocumentAsinRelationsValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling"
              + " validateContentDocumentAsinRelations(Async)");
    }
    // verify the required parameter 'marketplaceId' is set
    if (marketplaceId == null) {
      throw new ApiException(
  ...
  /**
   * Checks if the A+ Content document is valid for use on a set of ASINs. **Usage Plan:** | Rate
   * (requests per second) | Burst | | ---- | ---- | | 10 | 10 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header contains the usage plan rate limits for the
   * operation, when available. The preceding table contains the default rate and burst values for
   * this operation. Selling partners whose business demands require higher throughput might have
   ...
   * @throws LWAException If calls to fetch LWA access token fails
   */
  public ApiResponse<ValidateContentDocumentAsinRelationsResponse>
      validateContentDocumentAsinRelationsWithHttpInfo(
          PostContentDocumentRequest body, String marketplaceId, List<String> asinSet)
          throws ApiException, LWAException {
    okhttp3.Call call =
        validateContentDocumentAsinRelationsValidateBeforeCall(
            body, marketplaceId, asinSet, null, null);
    Type localVarReturnType =
        new TypeToken<ValidateContentDocumentAsinRelationsResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Checks if the A+ Content document is valid for use on a set of ASINs. **Usage
   * Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 10 | 10 | The
   * &#x60;x-amzn-RateLimit-Limit&#x60; response header contains the usage plan rate limits for the
   * operation, when available. The preceding table contains the default rate and burst values for
   * this operation. Selling partners whose business demands require higher throughput might have
