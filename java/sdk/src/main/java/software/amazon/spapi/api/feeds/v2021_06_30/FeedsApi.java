...
public class FeedsApi {
   ...
   *
   * @param feedId The identifier for the feed. This identifier is unique only in combination with a
   *     seller ID. (required)
  ...
  private okhttp3.Call cancelFeedValidateBeforeCall(
    ...
    if (feedId == null) {
      throw new ApiException(
          "Missing the required parameter 'feedId' when calling cancelFeed(Async)");
    }
   ...
   * [&#x60;getFeed&#x60;](https://developer-docs.amazon.com/sp-api/docs/feeds-api-v2021-06-30-reference#getfeed)
   * and
   * [&#x60;getFeeds&#x60;](https://developer-docs.amazon.com/sp-api/docs/feeds-api-v2021-06-30-reference#getfeeds)
   * operations. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 2 | 15 |
  ...
  /**
   * (asynchronously) Cancels the feed that you specify. Only feeds with
  ...
  public okhttp3.Call cancelFeedAsync(String feedId, final ApiCallback<Void> callback)
    ...
    okhttp3.Call call =
        cancelFeedValidateBeforeCall(feedId, progressListener, progressRequestListener);
  ...
  private okhttp3.Call createFeedValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling createFeed(Async)");
    }
  ...
  /**
   * Creates a feed. Upload the contents of the feed document before calling this operation. **Usage
  ...
  /**
   * (asynchronously) Creates a feed. Upload the contents of the feed document before calling this
   * operation. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 0.0083 | 15
  ...
  public okhttp3.Call createFeedAsync(
      CreateFeedSpecification body, final ApiCallback<CreateFeedResponse> callback)
      throws ApiException, LWAException {
    ...
    okhttp3.Call call =
        createFeedValidateBeforeCall(body, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<CreateFeedResponse>() {}.getType();
  ...
  private okhttp3.Call createFeedDocumentValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling createFeedDocument(Async)");
    }
  ...
  /**
   * Creates a feed document for the feed type that you specify. This operation returns a presigned
   * URL for uploading the feed document contents. It also returns a &#x60;feedDocumentId&#x60;
   * value that you can pass in with a subsequent call to the
   * [&#x60;createFeed&#x60;](https://developer-docs.amazon.com/sp-api/docs/feeds-api-v2021-06-30-reference#createfeed)
   * operation. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 0.5 | 15 |
   * The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that
   * were applied to the requested operation, when available. The preceding table indicates the
   * default rate and burst values for this operation. Selling partners whose business demands
   * require higher throughput may have higher rate and burst values than those shown here. For more
  ...
  public ApiResponse<CreateFeedDocumentResponse> createFeedDocumentWithHttpInfo(
      CreateFeedDocumentSpecification body) throws ApiException, LWAException {
  ...
  /**
   * (asynchronously) Creates a feed document for the feed type that you specify. This operation
   * returns a presigned URL for uploading the feed document contents. It also returns a
   * &#x60;feedDocumentId&#x60; value that you can pass in with a subsequent call to the
   * [&#x60;createFeed&#x60;](https://developer-docs.amazon.com/sp-api/docs/feeds-api-v2021-06-30-reference#createfeed)
   * operation. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 0.5 | 15 |
   * The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that
   * were applied to the requested operation, when available. The preceding table indicates the
  ...
  public okhttp3.Call createFeedDocumentAsync(
    ...
    okhttp3.Call call =
        createFeedDocumentValidateBeforeCall(body, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<CreateFeedDocumentResponse>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
   ...
   * that you specify. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 2 |
   * 15 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits
   * that were applied to the requested operation, when available. The preceding table indicates the
   * default rate and burst values for this operation. Selling partners whose business demands
   * require higher throughput may have higher rate and burst values than those shown here. For more
   * information, refer to [Usage Plans and Rate Limits in the Selling Partner
  ...
  /**
   * (asynchronously) Returns feed details (including the &#x60;resultDocumentId&#x60;, if
   * available) for the feed that you specify. **Usage Plan:** | Rate (requests per second) | Burst
   * | | ---- | ---- | | 2 | 15 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the
  ...
  public okhttp3.Call getFeedAsync(String feedId, final ApiCallback<Feed> callback)
    ...
    okhttp3.Call call =
        getFeedValidateBeforeCall(feedId, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<Feed>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
  ...
  public okhttp3.Call getFeedDocumentCall(
    ...
    String localVarPath =
        "/feeds/2021-06-30/documents/{feedDocumentId}"
            .replaceAll(
                "\\{" + "feedDocumentId" + "\\}",
                apiClient.escapeString(feedDocumentId.toString()));
  ...
  private okhttp3.Call getFeedDocumentValidateBeforeCall(
    ...
    okhttp3.Call call =
        getFeedDocumentCall(feedDocumentId, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Returns the information required for retrieving a feed document&#x27;s contents. **Usage
  ...
  /**
   * (asynchronously) Returns the information required for retrieving a feed document&#x27;s
   * contents. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 0.0222 | 10
   * | The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits
   * that were applied to the requested operation, when available. The preceding table indicates the
   * default rate and burst values for this operation. Selling partners whose business demands
   * require higher throughput may have higher rate and burst values than those shown here. For more
  ...
  public okhttp3.Call getFeedDocumentAsync(
      String feedDocumentId, final ApiCallback<FeedDocument> callback)
      throws ApiException, LWAException {
    ...
    okhttp3.Call call =
        getFeedDocumentValidateBeforeCall(
            feedDocumentId, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<FeedDocument>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
   ...
   *
   * @param feedTypes A list of feed types used to filter feeds. When feedTypes is provided, the
   *     other filter parameters (processingStatuses, marketplaceIds, createdSince, createdUntil)
   *     and pageSize may also be provided. Either feedTypes or nextToken is required. (optional)
   * @param marketplaceIds A list of marketplace identifiers used to filter feeds. The feeds
   *     returned will match at least one of the marketplaces that you specify. (optional)
   * @param pageSize The maximum number of feeds to return in a single call. (optional, default to
   *     10)
   * @param processingStatuses A list of processing statuses used to filter feeds. (optional)
   * @param createdSince The earliest feed creation date and time for feeds included in the
   *     response, in ISO 8601 format. The default is 90 days ago. Feeds are retained for a maximum
   *     of 90 days. (optional)
   * @param createdUntil The latest feed creation date and time for feeds included in the response,
   *     in ISO 8601 format. The default is now. (optional)
   * @param nextToken A string token returned in the response to your previous request. nextToken is
   *     returned when the number of results exceeds the specified pageSize value. To get the next
   *     page of results, call the getFeeds operation and include this token as the only parameter.
   *     Specifying nextToken with any other parameters will cause the request to fail. (optional)
   * @param progressListener Progress listener
   * @param progressRequestListener Progress request listener
   * @return Call to execute
   * @throws ApiException If fail to serialize the request body object
  ...
  public okhttp3.Call getFeedsCall(
    ...
    if (feedTypes != null)
      localVarCollectionQueryParams.addAll(
          apiClient.parameterToPairs("csv", "feedTypes", feedTypes));
  ...
  /**
   * Returns feed details for the feeds that match the filters that you specify. **Usage Plan:** |
  ...
  public GetFeedsResponse getFeeds(
      ...
      String nextToken)
      throws ApiException, LWAException {
    ApiResponse<GetFeedsResponse> resp =
  ...
  /**
   * (asynchronously) Returns feed details for the feeds that match the filters that you specify.
