...
public class UpdateInventoryApi {
  ...
  public okhttp3.Call submitInventoryUpdateCall(
    ...
    String localVarPath =
        "/vendor/directFulfillment/inventory/v1/warehouses/{warehouseId}/items"
            .replaceAll(
                "\\{" + "warehouseId" + "\\}", apiClient.escapeString(warehouseId.toString()));
  ...
  private okhttp3.Call submitInventoryUpdateValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling submitInventoryUpdate(Async)");
    }
    ...
    okhttp3.Call call =
        submitInventoryUpdateCall(body, warehouseId, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Submits inventory updates for the specified warehouse for either a partial or full feed of
   * inventory items. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 10 |
  ...
  /**
   * (asynchronously) Submits inventory updates for the specified warehouse for either a partial or
   * full feed of inventory items. **Usage Plan:** | Rate (requests per second) | Burst | | ---- |
  ...
  public okhttp3.Call submitInventoryUpdateAsync(
    ...
    okhttp3.Call call =
        submitInventoryUpdateValidateBeforeCall(
            body, warehouseId, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<SubmitInventoryUpdateResponse>() {}.getType();
