...
public class ProductTypeVersion {
  ...
  /**
   * When true, the version indicated by the version identifier is the latest available for the
   * Amazon product type.
   *
   * @return latest
   */
  @Schema(
      required = true,
      description =
          "When true, the version indicated by the version identifier is the latest available for"
  ...
  /**
   * When true, the version indicated by the version identifier is the prerelease (release
