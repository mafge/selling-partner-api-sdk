...
@Schema(
    description =
        "Delivery information for a scheduled delivery. This is only available in the JP"
            + " marketplace.")
public class ScheduledDeliveryInfo {
  ...
  /**
   * The time zone of the destination address for the fulfillment order preview. Must be an IANA
