...
/**
 * The self ship appointment time slots availability and an expiration date for which the slots can
 * be scheduled.
 */
@Schema(
    description =
        "The self ship appointment time slots availability and an expiration date for which the"
