...
@Schema(
    description =
        "Destination details of an inbound order based on the assigned region and DC for the"
            + " order.")
public class DestinationDetails {
  ...
  /**
   * Unique ID of the confirmed shipment being shipped to the assigned destination. This will be
  ...
  @Schema(
      description =
          "Unique ID of the confirmed shipment being shipped to the assigned destination. This will"
              + " be available only after an inbound order is confirmed and can be used to track"
              + " the shipment.")
