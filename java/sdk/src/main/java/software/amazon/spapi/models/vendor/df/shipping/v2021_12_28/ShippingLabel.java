...
/**
 * Shipping label information for an order, including the purchase order number, selling party, ship
 * from party, label format, and package details.
 */
@Schema(
    description =
        "Shipping label information for an order, including the purchase order number, selling"
            + " party, ship from party, label format, and package details.")
public class ShippingLabel {
  ...
  public enum LabelFormatEnum {
    ...
    public static class Adapter extends TypeAdapter<LabelFormatEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final LabelFormatEnum enumeration)
          throws IOException {
