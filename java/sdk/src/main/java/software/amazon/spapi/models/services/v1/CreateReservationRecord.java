...
/**
 * &#x60;CreateReservationRecord&#x60; entity contains the &#x60;Reservation&#x60; if there is an
 * error/warning while performing the requested operation on it, otherwise it will contain the new
 * &#x60;reservationId&#x60;.
 */
@Schema(
    description =
        "`CreateReservationRecord` entity contains the `Reservation` if there is an error/warning"
            + " while performing the requested operation on it, otherwise it will contain the new"
            + " `reservationId`.")
