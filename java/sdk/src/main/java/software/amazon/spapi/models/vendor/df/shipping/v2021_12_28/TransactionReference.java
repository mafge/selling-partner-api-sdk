...
public class TransactionReference {
  ...
  /**
   * GUID to identify this transaction. This value can be used with the Transaction Status API to
  ...
  @Schema(
      description =
          "GUID to identify this transaction. This value can be used with the Transaction Status"
              + " API to return the status of this transaction.")
