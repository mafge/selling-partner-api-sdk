...
public class VendorShippingLabelsApi {
   ...
   *     (required)
   * @param purchaseOrderNumber The purchase order number for which you want to return the shipping
  ...
  private okhttp3.Call createShippingLabelsValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling createShippingLabels(Async)");
    }
    ...
    if (purchaseOrderNumber == null) {
      throw new ApiException(
          "Missing the required parameter 'purchaseOrderNumber' when calling"
              + " createShippingLabels(Async)");
    }

    okhttp3.Call call =
        createShippingLabelsCall(
   ...
   * higher throughput may have higher rate and burst values then those shown here. For more
  ...
  public ShippingLabel createShippingLabels(
      CreateShippingLabelsRequest body, String purchaseOrderNumber)
      throws ApiException, LWAException {
  ...
  public ApiResponse<ShippingLabel> createShippingLabelsWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        createShippingLabelsValidateBeforeCall(body, purchaseOrderNumber, null, null);
    Type localVarReturnType = new TypeToken<ShippingLabel>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * createShippingLabels (asynchronously) Creates shipping labels for a purchase order and returns
   * the labels. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 10 | 10 |
   ...
   * require higher throughput may have higher rate and burst values then those shown here. For more
   * information, refer to [Usage Plans and Rate Limits in the Selling Partner
   * API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits).
   *
   * @param body The request payload that contains the parameters for creating shipping labels.
  ...
  public okhttp3.Call createShippingLabelsAsync(
    ...
    okhttp3.Call call =
        createShippingLabelsValidateBeforeCall(
            body, purchaseOrderNumber, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<ShippingLabel>() {}.getType();
   ...
   *
   * @param purchaseOrderNumber The purchase order number for which you want to return the shipping
   *     label. It should be the same &#x60;purchaseOrderNumber&#x60; that you received in the
   *     order. (required)
   * @param progressListener Progress listener
   * @param progressRequestListener Progress request listener
   * @return Call to execute
  ...
  private okhttp3.Call getShippingLabelValidateBeforeCall(
    ...
    if (purchaseOrderNumber == null) {
      throw new ApiException(
          "Missing the required parameter 'purchaseOrderNumber' when calling"
              + " getShippingLabel(Async)");
    }

    okhttp3.Call call =
        getShippingLabelCall(purchaseOrderNumber, progressListener, progressRequestListener);
    return call;
  }

  /**
   * getShippingLabel Returns a shipping label for the &#x60;purchaseOrderNumber&#x60; that you
  ...
  /**
   * getShippingLabel (asynchronously) Returns a shipping label for the
   * &#x60;purchaseOrderNumber&#x60; that you specify. **Usage Plan:** | Rate (requests per second)
  ...
  public okhttp3.Call getShippingLabelAsync(
      String purchaseOrderNumber, final ApiCallback<ShippingLabel> callback)
      throws ApiException, LWAException {
    ...
    okhttp3.Call call =
        getShippingLabelValidateBeforeCall(
   ...
   *
   * @param createdAfter Shipping labels that became available after this date and time will be
   *     included in the result. Values are in [ISO
   *     8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format. (required)
   * @param createdBefore Shipping labels that became available before this date and time will be
   *     included in the result. Values are in [ISO
   *     8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format. (required)
   * @param shipFromPartyId The vendor &#x60;warehouseId&#x60; for order fulfillment. If not
   *     specified, the result contains orders for all warehouses. (optional)
   * @param limit The limit to the number of records returned. (optional)
   * @param sortOrder The sort order creation date. You can choose between ascending
   *     (&#x60;ASC&#x60;) or descending (&#x60;DESC&#x60;) sort order. (optional, default to ASC)
   * @param nextToken Used for pagination when there are more ship labels than the specified result
   *     size limit. The token value is returned in the previous API call. (optional)
   * @param progressListener Progress listener
   * @param progressRequestListener Progress request listener
   * @return Call to execute
   * @throws ApiException If fail to serialize the request body object
  ...
  /**
   * getShippingLabels Returns a list of shipping labels created during the time frame that you
   * specify. Use the &#x60;createdAfter&#x60; and &#x60;createdBefore&#x60; parameters to define
   * the time frame. You must use both of these parameters. The date range to search must not be
   * more than seven days. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | |
   ...
   * demands require higher throughput may have higher rate and burst values then those shown here.
  ...
  public ShippingLabelList getShippingLabels(
      ...
      String nextToken)
      throws ApiException, LWAException {
    ApiResponse<ShippingLabelList> resp =
  ...
  public ApiResponse<ShippingLabelList> getShippingLabelsWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        getShippingLabelsValidateBeforeCall(
  ...
  /**
   * getShippingLabels (asynchronously) Returns a list of shipping labels created during the time
   * frame that you specify. Use the &#x60;createdAfter&#x60; and &#x60;createdBefore&#x60;
   * parameters to define the time frame. You must use both of these parameters. The date range to
   * search must not be more than seven days. **Usage Plan:** | Rate (requests per second) | Burst |
   ...
   * then those shown here. For more information, refer to [Usage Plans and Rate Limits in the
   * Selling Partner
   * API](https://developer-docs.amazon.com/sp-api/docs/usage-plans-and-rate-limits).
   *
   * @param createdAfter Shipping labels that became available after this date and time will be
  ...
  private okhttp3.Call submitShippingLabelRequestValidateBeforeCall(
    ...
    okhttp3.Call call =
        submitShippingLabelRequestCall(body, progressListener, progressRequestListener);
    return call;
  }

  /**
   * submitShippingLabelRequest Creates a shipping label for a purchase order and returns a
  ...
  public ApiResponse<TransactionReference> submitShippingLabelRequestWithHttpInfo(
      SubmitShippingLabelsRequest body) throws ApiException, LWAException {
  ...
  /**
   * submitShippingLabelRequest (asynchronously) Creates a shipping label for a purchase order and
   * returns a &#x60;transactionId&#x60; for reference. **Usage Plan:** | Rate (requests per second)
   * | Burst | | ---- | ---- | | 10 | 10 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header
   * returns the usage plan rate limits that were applied to the requested operation, when
   * available. The preceding table indicates the default rate and burst values for this operation.
   * Selling partners whose business demands require higher throughput may have higher rate and
  ...
  public okhttp3.Call submitShippingLabelRequestAsync(
    ...
    okhttp3.Call call =
        submitShippingLabelRequestValidateBeforeCall(
