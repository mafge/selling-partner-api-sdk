...
/**
 * Use these parameters to filter results. Any result must match all of the provided parameters. For
 * any parameter that is an array, the result must match at least one element in the provided array.
 */
@Schema(
    description =
        "Use these parameters to filter results. Any result must match all of the provided"
            + " parameters. For any parameter that is an array, the result must match at least one"
...
public class ListOffersRequestFilters {
  ...
  @Schema(
      description =
          "A list of SKUs to filter. This filter is only supported for sellers and not for"
              + " vendors.")
  ...
  public int hashCode() {
    return Objects.hash(
        marketplaceId, skus, asins, eligibilities, preferences, promotions, programTypes);
  }
