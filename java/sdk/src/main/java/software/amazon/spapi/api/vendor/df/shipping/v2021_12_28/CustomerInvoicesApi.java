...
public class CustomerInvoicesApi {
   ...
   *
   * @param purchaseOrderNumber Purchase order number of the shipment for which to return the
   *     invoice. (required)
  ...
  private okhttp3.Call getCustomerInvoiceValidateBeforeCall(
    ...
    okhttp3.Call call =
        getCustomerInvoiceCall(purchaseOrderNumber, progressListener, progressRequestListener);
    return call;
  }

  /**
   * getCustomerInvoice Returns a customer invoice based on the purchaseOrderNumber that you
  ...
  /**
   * getCustomerInvoice (asynchronously) Returns a customer invoice based on the purchaseOrderNumber
  ...
  public okhttp3.Call getCustomerInvoiceAsync(
      String purchaseOrderNumber, final ApiCallback<CustomerInvoice> callback)
      throws ApiException, LWAException {
    ...
    okhttp3.Call call =
        getCustomerInvoiceValidateBeforeCall(
   ...
   *
   * @param createdAfter Orders that became available after this date and time will be included in
   *     the result. Values are in [ISO
   *     8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format. (required)
   * @param createdBefore Orders that became available before this date and time will be included in
   *     the result. Values are in [ISO
   *     8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format. (required)
   * @param shipFromPartyId The vendor warehouseId for order fulfillment. If not specified, the
  ...
  /**
   * getCustomerInvoices Returns a list of customer invoices created during a time frame that you
   * specify. You define the time frame using the createdAfter and createdBefore parameters. You
   * must use both of these parameters. The date range to search must be no more than 7 days.
  ...
  public CustomerInvoiceList getCustomerInvoices(
      ...
      String nextToken)
      throws ApiException, LWAException {
    ApiResponse<CustomerInvoiceList> resp =
  ...
  public ApiResponse<CustomerInvoiceList> getCustomerInvoicesWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        getCustomerInvoicesValidateBeforeCall(
  ...
  /**
   * getCustomerInvoices (asynchronously) Returns a list of customer invoices created during a time
   * frame that you specify. You define the time frame using the createdAfter and createdBefore
   * parameters. You must use both of these parameters. The date range to search must be no more
   * than 7 days. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 10 | 10 |
