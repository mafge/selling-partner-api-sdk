...
public class CustomerInvoicesApi {
    ...
    private final Bucket getCustomerInvoiceBucket = Bucket.builder()
            .addLimit(config.getLimit("CustomerInvoicesApi-getCustomerInvoice"))
            .build();

    private final Bucket getCustomerInvoicesBucket = Bucket.builder()
    ...
    private okhttp3.Call getCustomerInvoiceValidateBeforeCall(
        ...
        return getCustomerInvoiceCall(purchaseOrderNumber, progressListener, progressRequestListener);
    }
    ...
    public ApiResponse<CustomerInvoice> getCustomerInvoiceWithHttpInfo(String purchaseOrderNumber)
        ...
        if (getCustomerInvoiceBucket.tryConsume(1)) {
    ...
    public ApiResponse<CustomerInvoiceList> getCustomerInvoicesWithHttpInfo(
        ...
        if (getCustomerInvoicesBucket.tryConsume(1)) {
