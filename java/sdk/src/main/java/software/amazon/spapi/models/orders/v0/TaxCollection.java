...
public class TaxCollection {
  ...
  public enum ModelEnum {
    ...
    public static class Adapter extends TypeAdapter<ModelEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ModelEnum enumeration)
          throws IOException {
  ...
  public enum ResponsiblePartyEnum {
    ...
    public static class Adapter extends TypeAdapter<ResponsiblePartyEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ResponsiblePartyEnum enumeration)
          throws IOException {
        jsonWriter.value(String.valueOf(enumeration.getValue()));
      }
