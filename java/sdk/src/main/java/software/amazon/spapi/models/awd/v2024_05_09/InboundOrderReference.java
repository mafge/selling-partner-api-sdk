...
/**
 * A response that contains the reference identifiers for the newly created or updated inbound
 * order. Consists of an order ID and version.
 */
@Schema(
    description =
        "A response that contains the reference identifiers for the newly created or updated"
            + " inbound order. Consists of an order ID and version.")
