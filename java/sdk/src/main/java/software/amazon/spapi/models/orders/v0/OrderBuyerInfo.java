...
public class OrderBuyerInfo {
  ...
  @Schema(
      description =
          "The county of the buyer.  **Note**: This attribute is only available in the Brazil"
              + " marketplace.")
  ...
  /**
   * The purchase order (PO) number entered by the buyer at checkout. Only returned for orders where
  ...
  @Schema(
      description =
          "The purchase order (PO) number entered by the buyer at checkout. Only returned for"
  ...
  public int hashCode() {
    return Objects.hash(
        amazonOrderId, buyerEmail, buyerName, buyerCounty, buyerTaxInfo, purchaseOrderNumber);
  }
