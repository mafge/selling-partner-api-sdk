...
/**
 * Contains information about a pallet that is used in the inbound plan. The pallet is a container
 * that holds multiple items or boxes.
 */
@Schema(
    description =
        "Contains information about a pallet that is used in the inbound plan. The pallet is a"
            + " container that holds multiple items or boxes.")
public class Pallet {
