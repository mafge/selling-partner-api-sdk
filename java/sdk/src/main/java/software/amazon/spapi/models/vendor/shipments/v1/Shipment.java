...
public class Shipment {
  ...
  /**
   * Indicates the type of transportation request such as (New,Cancel,Confirm and
   * PackageLabelRequest). Each transactiontype has a unique set of operation and there are
   * corresponding details to be populated for each operation.
   */
  ...
  public enum TransactionTypeEnum {
    ...
    public static class Adapter extends TypeAdapter<TransactionTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final TransactionTypeEnum enumeration)
          throws IOException {
  ...
  /**
   * Indicates if this transportation request is WePay/Collect or TheyPay/Prepaid. This is a
  ...
  @Schema(
      ...
      description =
          "Indicates the type of  transportation request such as (New,Cancel,Confirm and"
              + " PackageLabelRequest). Each transactiontype has a unique set of operation and"
              + " there are corresponding details to be populated for each operation.")
  ...
  /**
   * The buyer Reference Number is a unique identifier generated by buyer for all Collect/WePay
  ...
  @Schema(
      description =
          "The buyer Reference Number is a unique identifier generated by buyer for all"
              + " Collect/WePay shipments when you submit a transportation request. This field is"
  ...
  /**
   * Indicates the list of current shipment status details and when the last update was received
   * from carrier this is available on shipment Details response.
   *
   * @return shipmentStatusDetails
   */
  @Schema(
      description =
          "Indicates the list of current shipment status details and when the last update was"
              + " received from carrier this is available on shipment Details response.")
  ...
  /**
   * The date and time of the departure of the shipment from the vendor&#x27;s location. Vendors are
   * requested to send ASNs within 30 minutes of departure from their warehouse/distribution center
   * or at least 6 hours prior to the appointment time at the Buyer destination warehouse, whichever
   * is sooner. Shipped date mentioned in the shipment confirmation should not be in the future.
   *
   * @return shipmentConfirmDate
   */
  @Schema(
      description =
          "The date and time of the departure of the shipment from the vendor's location. Vendors"
              + " are requested to send ASNs within 30 minutes of departure from their"
              + " warehouse/distribution center or at least 6 hours prior to the appointment time"
              + " at the Buyer destination warehouse, whichever is sooner. Shipped date mentioned"
  ...
  public Shipment collectFreightPickupDetails(
  ...
  public void setCollectFreightPickupDetails(
      CollectFreightPickupDetails collectFreightPickupDetails) {
    this.collectFreightPickupDetails = collectFreightPickupDetails;
  }
  ...
  /**
   * Indicates the purchase orders involved for the transportation request. This group is an array
   * create 1 for each PO and list their corresponding items. This information is used for deciding
   * the route,truck allocation and storage efficiently. This is a mandatory information for Buyer
  ...
  @Schema(
      description =
          "Indicates the purchase orders involved for the transportation request. This group is an"
              + " array create 1 for each PO and list their corresponding items. This information"
              + " is used for deciding the route,truck allocation and storage efficiently. This is"
              + " a mandatory information for Buyer performing transportation from vendor warehouse"
              + " (WePay/Collect)")
  ...
  /**
   * A list of the items in this transportation and their associated inner container details. If any
   * of the item detail fields are common at a carton or a pallet level, provide them at the
  ...
  @Schema(
      description =
          "A list of the items in this transportation and their associated inner container details."
              + " If any of the item detail fields are common at a carton or a pallet level,"
