...
/**
 * Represents the acknowledgement details for an individual order item, including the
 * acknowledgement code, acknowledged quantity, scheduled ship and delivery dates, and rejection
 * reason (if applicable).
 */
@Schema(
    description =
        "Represents the acknowledgement details for an individual order item, including the"
            + " acknowledgement code, acknowledged quantity, scheduled ship and delivery dates, and"
...
public class OrderItemAcknowledgement {
  ...
  public enum RejectionReasonEnum {
    ...
    public static class Adapter extends TypeAdapter<RejectionReasonEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final RejectionReasonEnum enumeration)
          throws IOException {
        jsonWriter.value(String.valueOf(enumeration.getValue()));
      }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.acknowledgementCode, orderItemAcknowledgement.acknowledgementCode)
        ...
        && Objects.equals(
            this.scheduledDeliveryDate, orderItemAcknowledgement.scheduledDeliveryDate)
