...
/**
 * A payment event for Fulfillment by Amazon (FBA) inventory liquidation. This event is used only in
 * the US marketplace.
 */
@Schema(
    description =
        "A payment event for Fulfillment by Amazon (FBA) inventory liquidation. This event is used"
            + " only in the US marketplace.")
public class FBALiquidationEvent {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.postedDate, fbALiquidationEvent.postedDate)
        ...
        && Objects.equals(
            this.liquidationProceedsAmount, fbALiquidationEvent.liquidationProceedsAmount)
  ...
  public int hashCode() {
    return Objects.hash(
        postedDate, originalRemovalOrderId, liquidationProceedsAmount, liquidationFeeAmount);
  }
