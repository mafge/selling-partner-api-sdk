...
public class CreateMarketplaceItemLabelsRequest {
  ...
  /**
   * The locale code constructed from ISO 639 language code and ISO 3166-1 alpha-2 standard of
  ...
  @Schema(
      description =
          "The locale code constructed from ISO 639 language code and ISO 3166-1 alpha-2 standard"
              + " of country codes separated by an underscore character.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreateMarketplaceItemLabelsRequest createMarketplaceItemLabelsRequest =
        (CreateMarketplaceItemLabelsRequest) o;
  ...
  public int hashCode() {
    return Objects.hash(
        height, labelType, localeCode, marketplaceId, mskuQuantities, pageType, width);
  }
