...
public class Carton {
  ...
  /**
   * Carton sequence number for the carton. The first carton will be 001, the second 002, and so on.
   * This number is used as a reference to refer to this carton from the pallet level.
   *
  ...
  @Schema(
      required = true,
      description =
          "Carton sequence number for the carton. The first carton will be 001, the second 002, and"
              + " so on. This number is used as a reference to refer to this carton from the pallet"
              + " level.")
  ...
  public int hashCode() {
    return Objects.hash(
        cartonIdentifiers, cartonSequenceNumber, dimensions, weight, trackingNumber, items);
  }
