...
public class ShipmentDetails {
   ...
   * shipping carrier and shipment service level. To see the full list of ship methods in use,
   * including both the code and the friendly name, search the &#x27;Help&#x27; section on Vendor
   * Central for &#x27;ship methods&#x27;.
   *
   * @return shipMethod
   */
  @Schema(
      ...
      description =
          "Ship method to be used for shipping the order. Amazon defines ship method codes"
              ...
              + " of ship methods in use, including both the code and the friendly name, search the"
              + " 'Help' section on Vendor Central for 'ship methods'.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.isPriorityShipment, shipmentDetails.isPriorityShipment)
        && Objects.equals(
            this.isScheduledDeliveryShipment, shipmentDetails.isScheduledDeliveryShipment)
