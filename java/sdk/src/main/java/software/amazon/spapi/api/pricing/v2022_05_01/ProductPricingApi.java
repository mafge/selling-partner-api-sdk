...
public class ProductPricingApi {
  ...
  private okhttp3.Call getCompetitiveSummaryValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling getCompetitiveSummary(Async)");
    }
   ...
   * ---- | ---- | | 0.033 | 1 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the
   ...
   * whose business demands require higher throughput may receive higher rate and burst values than
  ...
  /**
   * (asynchronously) Returns the competitive summary response, including featured buying options
   * for the ASIN and &#x60;marketplaceId&#x60; combination. **Usage Plan:** | Rate (requests per
   * second) | Burst | | ---- | ---- | | 0.033 | 1 | The &#x60;x-amzn-RateLimit-Limit&#x60; response
  ...
  public okhttp3.Call getCompetitiveSummaryAsync(
    ...
    okhttp3.Call call =
        getCompetitiveSummaryValidateBeforeCall(body, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<CompetitiveSummaryBatchResponse>() {}.getType();
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling"
              + " getFeaturedOfferExpectedPriceBatch(Async)");
    }

    okhttp3.Call call =
        getFeaturedOfferExpectedPriceBatchCall(body, progressListener, progressRequestListener);
    return call;
  }

  /**
   * Returns the set of responses that correspond to the batched list of up to 40 requests defined
   * in the request body. The response for each successful (HTTP status code 200) request in the set
   * includes the computed listing price at or below which a seller can expect to become the
   * featured offer (before applicable promotions). This is called the featured offer expected price
   * (FOEP). Featured offer is not guaranteed because competing offers might change. Other offers
   * might be featured based on factors such as fulfillment capabilities to a specific customer. The
   * response to an unsuccessful request includes the available error text. **Usage Plan:** | Rate
   * (requests per second) | Burst | | ---- | ---- | | 0.033 | 1 | The
   ...
   * higher throughput may receive higher rate and burst values than those shown here. For more
   ...
   * @throws LWAException If calls to fetch LWA access token fails
   */
  public ApiResponse<GetFeaturedOfferExpectedPriceBatchResponse>
      getFeaturedOfferExpectedPriceBatchWithHttpInfo(GetFeaturedOfferExpectedPriceBatchRequest body)
          throws ApiException, LWAException {
    okhttp3.Call call = getFeaturedOfferExpectedPriceBatchValidateBeforeCall(body, null, null);
    Type localVarReturnType =
        new TypeToken<GetFeaturedOfferExpectedPriceBatchResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * (asynchronously) Returns the set of responses that correspond to the batched list of up to 40
   * requests defined in the request body. The response for each successful (HTTP status code 200)
   * request in the set includes the computed listing price at or below which a seller can expect to
   * become the featured offer (before applicable promotions). This is called the featured offer
   * expected price (FOEP). Featured offer is not guaranteed because competing offers might change.
   * Other offers might be featured based on factors such as fulfillment capabilities to a specific
   * customer. The response to an unsuccessful request includes the available error text. **Usage
  ...
  public okhttp3.Call getFeaturedOfferExpectedPriceBatchAsync(
    ...
    okhttp3.Call call =
        getFeaturedOfferExpectedPriceBatchValidateBeforeCall(
