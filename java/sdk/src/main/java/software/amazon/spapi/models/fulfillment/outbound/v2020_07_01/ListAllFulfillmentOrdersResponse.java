...
@Schema(description = "The response schema for the `listAllFulfillmentOrders` operation.")
public class ListAllFulfillmentOrdersResponse {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ListAllFulfillmentOrdersResponse listAllFulfillmentOrdersResponse =
        (ListAllFulfillmentOrdersResponse) o;
