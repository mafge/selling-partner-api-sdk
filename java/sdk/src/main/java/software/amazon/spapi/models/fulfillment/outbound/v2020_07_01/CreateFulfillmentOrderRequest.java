...
public class CreateFulfillmentOrderRequest {
   ...
   * &#x60;SellerFulfillmentOrderId&#x60; must be unique for each fulfillment order that a seller
   * creates. If the seller&#x27;s system already creates unique order identifiers, then these might
   * be good values for them to use.
   *
  ...
  @Schema(
      ...
      description =
          "A fulfillment order identifier that the seller creates to track their fulfillment order."
              + " The `SellerFulfillmentOrderId` must be unique for each fulfillment order that a"
              + " seller creates. If the seller's system already creates unique order identifiers,"
              + " then these might be good values for them to use.")
  ...
  /**
   * A fulfillment order identifier that the seller creates. This value displays as the order
   * identifier in recipient-facing materials such as the outbound shipment packing slip. The value
   * of &#x60;DisplayableOrderId&#x60; should match the order identifier that the seller provides to
   * the recipient. The seller can use the &#x60;SellerFulfillmentOrderId&#x60; for this value or
   * they can specify an alternate value if they want the recipient to reference an alternate order
   * identifier. The value must be an alpha-numeric or ISO 8859-1 compliant string from one to 40
   * characters in length. Cannot contain two spaces in a row. Leading and trailing white space is
   * removed.
   *
  ...
  @Schema(
      ...
      description =
          "A fulfillment order identifier that the seller creates. This value displays as the order"
              + " identifier in recipient-facing materials such as the outbound shipment packing"
              + " slip. The value of `DisplayableOrderId` should match the order identifier that"
              + " the seller provides to the recipient. The seller can use the"
              + " `SellerFulfillmentOrderId` for this value or they can specify an alternate value"
              + " if they want the recipient to reference an alternate order identifier.  The value"
              + " must be an alpha-numeric or ISO 8859-1 compliant string from one to 40 characters"
              + " in length. Cannot contain two spaces in a row. Leading and trailing white space"
              + " is removed.")
  ...
  /**
   * Order-specific text that appears in recipient-facing materials such as the outbound shipment
   * packing slip.
   *
  ...
  @Schema(
      required = true,
      description =
          "Order-specific text that appears in recipient-facing materials such as the outbound"
  ...
  public CreateFulfillmentOrderRequest shippingSpeedCategory(
  ...
  public CreateFulfillmentOrderRequest deliveryPreferences(
  ...
  /**
   * The two-character country code for the country from which the fulfillment order ships. Must be
  ...
  @Schema(
      description =
          "The two-character country code for the country from which the fulfillment order ships."
              + " Must be in ISO 3166-1 alpha-2 format.")
  ...
  public CreateFulfillmentOrderRequest notificationEmails(
  ...
  public CreateFulfillmentOrderRequest featureConstraints(
      List<FeatureSettings> featureConstraints) {
    this.featureConstraints = featureConstraints;
    return this;
  }

  public CreateFulfillmentOrderRequest addFeatureConstraintsItem(
      FeatureSettings featureConstraintsItem) {
  ...
  public CreateFulfillmentOrderRequest paymentInformation(
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.marketplaceId, createFulfillmentOrderRequest.marketplaceId)
        && Objects.equals(
            this.sellerFulfillmentOrderId, createFulfillmentOrderRequest.sellerFulfillmentOrderId)
        && Objects.equals(this.displayableOrderId, createFulfillmentOrderRequest.displayableOrderId)
        && Objects.equals(
            this.displayableOrderDate, createFulfillmentOrderRequest.displayableOrderDate)
        && Objects.equals(
            this.displayableOrderComment, createFulfillmentOrderRequest.displayableOrderComment)
        && Objects.equals(
            this.shippingSpeedCategory, createFulfillmentOrderRequest.shippingSpeedCategory)
        ...
        && Objects.equals(
            this.deliveryPreferences, createFulfillmentOrderRequest.deliveryPreferences)
        ...
        && Objects.equals(
            this.shipFromCountryCode, createFulfillmentOrderRequest.shipFromCountryCode)
        ...
        && Objects.equals(
            this.paymentInformation, createFulfillmentOrderRequest.paymentInformation);
  }
