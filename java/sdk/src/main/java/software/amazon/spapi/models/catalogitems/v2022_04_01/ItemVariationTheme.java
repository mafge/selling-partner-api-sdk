...
@Schema(
    description =
        "The variation theme is a list of Amazon catalog item attributes that define the variation"
            + " family.")
public class ItemVariationTheme {
  ...
  @Schema(
      description =
          "Names of the Amazon catalog item attributes that are associated with the variation"
              + " theme.")
  ...
  /**
   * Variation theme that indicates the combination of Amazon catalog item attributes that define
  ...
  @Schema(
      ...
      description =
          "Variation theme that indicates the combination of Amazon catalog item attributes that"
