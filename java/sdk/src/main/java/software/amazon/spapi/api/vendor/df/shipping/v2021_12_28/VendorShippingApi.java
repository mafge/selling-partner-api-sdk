...
public class VendorShippingApi {
   ...
   *
   * @param purchaseOrderNumber The &#x60;purchaseOrderNumber&#x60; for the packing slip that you
   *     want. (required)
   ...
   */
  public okhttp3.Call getPackingSlipCall(
    ...
    if (purchaseOrderNumber == null) {
      throw new ApiException(
          "Missing the required parameter 'purchaseOrderNumber' when calling"
              + " getPackingSlip(Async)");
    }

    okhttp3.Call call =
        getPackingSlipCall(purchaseOrderNumber, progressListener, progressRequestListener);
    return call;
  }
  ...
  /**
   * getPackingSlip (asynchronously) Returns a packing slip based on the purchaseOrderNumber that
   * you specify. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 10 | 10 |
  ...
  public okhttp3.Call getPackingSlipAsync(
      String purchaseOrderNumber, final ApiCallback<PackingSlip> callback)
      throws ApiException, LWAException {
    ...
    okhttp3.Call call =
        getPackingSlipValidateBeforeCall(
   ...
   *
   * @param createdAfter Packing slips that become available after this date and time will be
   ...
   * @param createdBefore Packing slips that became available before this date and time will be
   *     included in the result. Values are in [ISO
   *     8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format. (required)
   ...
   * @param sortOrder The packing slip creation dates, which are sorted by ascending or descending
   *     order. (optional, default to ASC)
   * @param nextToken Used for pagination when there are more packing slips than the specified
   ...
   * @throws LWAException If calls to fetch LWA access token fails
   */
  public okhttp3.Call getPackingSlipsCall(
  ...
  private okhttp3.Call getPackingSlipsValidateBeforeCall(
    ...
    if (createdAfter == null) {
      throw new ApiException(
          "Missing the required parameter 'createdAfter' when calling getPackingSlips(Async)");
    }
  ...
  /**
   * getPackingSlips Returns a list of packing slips for the purchase orders that match the criteria
   * specified. Date range to search must not be more than 7 days. **Usage Plan:** | Rate (requests
  ...
  public ApiResponse<PackingSlipList> getPackingSlipsWithHttpInfo(
      ...
      throws ApiException, LWAException {
    okhttp3.Call call =
        getPackingSlipsValidateBeforeCall(
  ...
  /**
   * getPackingSlips (asynchronously) Returns a list of packing slips for the purchase orders that
   * match the criteria specified. Date range to search must not be more than 7 days. **Usage
   ...
   * @throws LWAException If calls to fetch LWA access token fails
   */
  public okhttp3.Call submitShipmentStatusUpdatesCall(
  ...
  private okhttp3.Call submitShipmentStatusUpdatesValidateBeforeCall(
    ...
    okhttp3.Call call =
        submitShipmentStatusUpdatesCall(body, progressListener, progressRequestListener);
    return call;
  }

  /**
   * submitShipmentStatusUpdates This operation is only to be used by Vendor-Own-Carrier (VOC)
   * vendors. Calling this API submits a shipment status update for the package that a vendor has
   * shipped. It will provide the Amazon customer visibility on their order, when the package is
   * outside of Amazon Network visibility. **Usage Plan:** | Rate (requests per second) | Burst | |
  ...
  /**
   * submitShipmentStatusUpdates (asynchronously) This operation is only to be used by
   * Vendor-Own-Carrier (VOC) vendors. Calling this API submits a shipment status update for the
   * package that a vendor has shipped. It will provide the Amazon customer visibility on their
   * order, when the package is outside of Amazon Network visibility. **Usage Plan:** | Rate
  ...
  public okhttp3.Call submitShipmentStatusUpdatesAsync(
    ...
    okhttp3.Call call =
        submitShipmentStatusUpdatesValidateBeforeCall(
            body, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<TransactionReference>() {}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
