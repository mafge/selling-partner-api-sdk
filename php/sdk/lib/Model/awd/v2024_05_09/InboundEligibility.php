...
class InboundEligibility implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     *
     * @return null|OrderIneligibilityReason[]
     */
     ...
     *
     * @param null|OrderIneligibilityReason[] $ineligibility_reasons if there are order level eligibility issues, then this list will contain those error codes and descriptions
     *
     * @return self
     */
     ...
     *
     * @param SkuEligibility[] $packages_to_inbound details on SKU eligibility for each inbound package
     *
     * @return self
     */
