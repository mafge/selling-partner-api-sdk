 ...
 */
class ContainerLabel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $container_tracking_number The container (pallet) tracking identifier from the shipping carrier.
     *
     * @return self
     */
