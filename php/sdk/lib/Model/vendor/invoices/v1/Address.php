...
class Address implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('postal_or_zip_code', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($postal_or_zip_code)) {
            throw new \InvalidArgumentException('non-nullable postal_or_zip_code cannot be null');
        }
