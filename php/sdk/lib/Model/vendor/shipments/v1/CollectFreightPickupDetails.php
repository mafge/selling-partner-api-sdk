...
class CollectFreightPickupDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('carrier_assignment_date', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param \DateTime|null $requested_pick_up Date on which the items can be picked up from vendor warehouse by Buyer used for WePay/Collect vendors.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $scheduled_pick_up Date on which the items are scheduled to be picked from vendor warehouse by Buyer used for WePay/Collect vendors.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $carrier_assignment_date Date on which the carrier is being scheduled to pickup items from vendor warehouse by Byer used for WePay/Collect vendors.
     *
     * @return self
     */
