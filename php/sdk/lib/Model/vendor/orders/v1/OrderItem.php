...
class OrderItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_back_order_allowed', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($is_back_order_allowed)) {
            throw new \InvalidArgumentException('non-nullable is_back_order_allowed cannot be null');
        }
