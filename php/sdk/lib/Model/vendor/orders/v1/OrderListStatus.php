...
class OrderListStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets orders_status
     *
     * @return \SpApi\Model\vendor\orders\v1\OrderStatus[]|null
     */
     ...
     * Sets orders_status
     *
     * @param \SpApi\Model\vendor\orders\v1\OrderStatus[]|null $orders_status Represents an order status within the OrderListStatus.
     *
     * @return self
     */
    public function setOrdersStatus($orders_status)
    {
        if (is_null($orders_status)) {
            throw new \InvalidArgumentException('non-nullable orders_status cannot be null');
        }
